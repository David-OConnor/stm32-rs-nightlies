...
impl IC1PSC_R {
    ...
    pub fn variant(&self) -> IC1PSC_A {
        match self.bits {
            ...
            1 => IC1PSC_A::TwoEvents,
            2 => IC1PSC_A::FourEvents,
            3 => IC1PSC_A::EightEvents,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `TwoEvents`"]
    #[inline(always)]
    pub fn is_two_events(&self) -> bool {
        *self == IC1PSC_A::TwoEvents
    }
    #[doc = "Checks if the value of the field is `FourEvents`"]
    #[inline(always)]
    pub fn is_four_events(&self) -> bool {
        *self == IC1PSC_A::FourEvents
    }
    #[doc = "Checks if the value of the field is `EightEvents`"]
    #[inline(always)]
    pub fn is_eight_events(&self) -> bool {
        *self == IC1PSC_A::EightEvents
    }
}
...
pub type IC2PSC_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CCMR1_INPUT_SPEC, u8, u8, 2, O>;
