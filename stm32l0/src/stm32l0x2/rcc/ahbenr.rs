...
impl R {
    ...
    pub fn touchen(&self) -> TOUCHEN_R {
        TOUCHEN_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 20 - Random Number Generator clock enable bit"]
    #[inline(always)]
    pub fn rngen(&self) -> RNGEN_R {
        RNGEN_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn touchen(&mut self) -> TOUCHEN_W<16> {
        TOUCHEN_W::new(self)
    }
    #[doc = "Bit 20 - Random Number Generator clock enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rngen(&mut self) -> RNGEN_W<20> {
        RNGEN_W::new(self)
    }
    #[doc = "Bit 24 - Crypto clock enable bit"]
    #[inline(always)]
