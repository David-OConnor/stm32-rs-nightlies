...
pub type EA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, EP6R_SPEC, u8, u8, 4, O>;
...
pub type STAT_TX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EP6R_SPEC, u8, STAT_TXR_A, 2, O>;
...
pub type DTOG_TX_W<'a, const O: u8> = crate::BitWriter1T<'a, u32, EP6R_SPEC, bool, O>;
#[doc = "Field `CTR_TX` reader - CTR_TX"]
pub type CTR_TX_R = crate::BitReader<bool>;
#[doc = "Field `CTR_TX` writer - CTR_TX"]
pub type CTR_TX_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, EP6R_SPEC, bool, O>;
...
pub type EP_TYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EP6R_SPEC, u8, EP_TYPE_A, 2, O>;
...
pub type STAT_RX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EP6R_SPEC, u8, STAT_RXR_A, 2, O>;
...
pub type DTOG_RX_W<'a, const O: u8> = crate::BitWriter1T<'a, u32, EP6R_SPEC, bool, O>;
#[doc = "Field `CTR_RX` reader - CTR_RX"]
pub type CTR_RX_R = crate::BitReader<bool>;
#[doc = "Field `CTR_RX` writer - CTR_RX"]
pub type CTR_RX_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, EP6R_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:3 - EA"]
    #[inline(always)]
    pub fn ea(&self) -> EA_R {
