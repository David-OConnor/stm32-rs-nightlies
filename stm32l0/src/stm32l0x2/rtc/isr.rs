...
pub type RECALPF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISR_SPEC, RECALPFR_A, O>;
impl<'a, const O: u8> RECALPF_W<'a, O> {
    ...
    pub fn pending(self) -> &'a mut W {
        self.variant(RECALPFR_A::Pending)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn recalpf(&mut self) -> RECALPF_W<16> {
        RECALPF_W::new(self)
    }
