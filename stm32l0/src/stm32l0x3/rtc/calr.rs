...
#[doc = "Field `CALW8` reader - Use a 8-second calibration cycle period"]
pub type CALW8_R = crate::BitReader<CALW8_A>;
#[doc = "Use a 8-second calibration cycle period\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CALW8_A {
...
#[doc = "Field `CALW8` writer - Use a 8-second calibration cycle period"]
...
impl R {
    ...
    #[doc = "Bit 14 - Use a 8-second calibration cycle period"]
    #[inline(always)]
