...
pub type EP_ID_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, ISTR_SPEC, u8, u8, 4, O>;
...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISTR_SPEC, DIR_A, O>;
...
pub type CTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ISTR_SPEC, CTR_A, O>;
impl<'a, const O: u8> CTR_W<'a, O> {
