...
#[doc = "Field `VLCDEN` reader - VLCD reading circuitry enable"]
pub type VLCDEN_R = crate::BitReader<VLCDEN_A>;
#[doc = "VLCD reading circuitry enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum VLCDEN_A {
...
#[doc = "Field `VLCDEN` writer - VLCD reading circuitry enable"]
...
impl R {
    ...
    #[doc = "Bit 24 - VLCD reading circuitry enable"]
    #[inline(always)]
