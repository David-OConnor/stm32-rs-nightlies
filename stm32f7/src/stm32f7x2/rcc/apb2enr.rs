...
#[doc = "Field `USBPHYCEN` reader - USB OTG HS PHY controller clock enable"]
...
#[doc = "Field `USBPHYCEN` writer - USB OTG HS PHY controller clock enable"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2en(&mut self) -> SDMMC2EN_W<7> {
        SDMMC2EN_W::new(self)
    }
    #[doc = "Bit 8 - ADC1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbphycen(&mut self) -> USBPHYCEN_W<31> {
        USBPHYCEN_W::new(self)
    }
