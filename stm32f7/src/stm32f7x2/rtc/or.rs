...
pub type TSINSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tsinsel(&mut self) -> TSINSEL_W<1> {
        TSINSEL_W::new(self)
    }
    #[doc = "Bit 3 - RTC_ALARM on PC13 output type"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_alarm_type(&mut self) -> RTC_ALARM_TYPE_W<3> {
