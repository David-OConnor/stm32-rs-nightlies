...
pub type TXFIFOUDRN_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SPEC, bool, O>;
...
pub type BNA_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SPEC, bool, O>;
...
pub type PKTDRPSTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SPEC, bool, O>;
...
pub type BERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_SPEC, bool, O>;
