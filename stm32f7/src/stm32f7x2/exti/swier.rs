...
#[doc = "Field `SWIER23` reader - Software Interrupt on line 22"]
pub use SWIER0_R as SWIER23_R;
...
#[doc = "Field `SWIER23` writer - Software Interrupt on line 22"]
pub use SWIER0_W as SWIER23_W;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swier23(&mut self) -> SWIER23_W<23> {
        SWIER23_W::new(self)
    }
