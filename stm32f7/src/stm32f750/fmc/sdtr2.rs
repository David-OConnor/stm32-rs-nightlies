...
pub type TMRD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, SDTR2_SPEC, u8, u8, 4, O>;
...
pub type TRCD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, SDTR2_SPEC, u8, u8, 4, O>;
impl R {
