...
pub type ADDSET_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, BTR4_SPEC, u8, u8, 4, O>;
...
pub type BUSTURN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, BTR4_SPEC, u8, u8, 4, O>;
...
pub type DATLAT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, BTR4_SPEC, u8, u8, 4, O>;
...
pub type ACCMOD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, BTR4_SPEC, u8, ACCMOD_A, 2, O>;
