...
pub struct R(crate::R<S1FCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<S1FCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<S1FCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<S1FCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `S1FCR` writer"]
pub struct W(crate::W<S1FCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<S1FCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<S1FCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<S1FCR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FTH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, S1FCR_SPEC, u8, FTH_A, 2, O>;
...
pub type DMDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1FCR_SPEC, DMDIS_A, O>;
...
pub type FEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1FCR_SPEC, FEIE_A, O>;
