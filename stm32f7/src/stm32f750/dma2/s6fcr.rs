...
pub type FTH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, S6FCR_SPEC, u8, FTH_A, 2, O>;
...
pub type DMDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, S6FCR_SPEC, DMDIS_A, O>;
...
pub type FEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S6FCR_SPEC, FEIE_A, O>;
