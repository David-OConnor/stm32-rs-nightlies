...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, EN_A, O>;
...
pub type DMEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, DMEIE_A, O>;
...
pub type TEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, TEIE_A, O>;
...
pub type HTIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, HTIE_A, O>;
...
pub type TCIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, TCIE_A, O>;
...
pub type PFCTRL_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, PFCTRL_A, O>;
...
pub type DIR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, S1CR_SPEC, u8, DIR_A, 2, O>;
...
pub type CIRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, CIRC_A, O>;
...
pub type PINC_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, PINC_A, O>;
...
pub type PSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, S1CR_SPEC, u8, PSIZE_A, 2, O>;
...
pub type PINCOS_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, PINCOS_A, O>;
...
pub type PL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, S1CR_SPEC, u8, PL_A, 2, O>;
...
pub type DBM_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, DBM_A, O>;
...
pub type CT_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, CT_A, O>;
...
pub type ACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, S1CR_SPEC, bool, O>;
...
pub type PBURST_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, S1CR_SPEC, u8, PBURST_A, 2, O>;
...
pub type CHSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, S1CR_SPEC, u8, u8, 3, O>;
impl R {
