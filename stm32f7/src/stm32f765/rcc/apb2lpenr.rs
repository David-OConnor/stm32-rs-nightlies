...
#[doc = "Field `SDMMC2LPEN` reader - SDMMC2 clock enable during Sleep mode"]
pub type SDMMC2LPEN_R = crate::BitReader<bool>;
#[doc = "Field `SDMMC2LPEN` writer - SDMMC2 clock enable during Sleep mode"]
pub type SDMMC2LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2LPENR_SPEC, bool, O>;
...
#[doc = "Field `DSILPEN` reader - DSI clock enable during Sleep mode"]
pub type DSILPEN_R = crate::BitReader<bool>;
#[doc = "Field `DSILPEN` writer - DSI clock enable during Sleep mode"]
pub type DSILPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2LPENR_SPEC, bool, O>;
#[doc = "Field `DFSDM1LPEN` reader - DFSDM1 clock enable during Sleep mode"]
pub type DFSDM1LPEN_R = crate::BitReader<bool>;
#[doc = "Field `DFSDM1LPEN` writer - DFSDM1 clock enable during Sleep mode"]
pub type DFSDM1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2LPENR_SPEC, bool, O>;
#[doc = "Field `MDIOLPEN` reader - MDIO clock enable during Sleep mode"]
pub type MDIOLPEN_R = crate::BitReader<bool>;
#[doc = "Field `MDIOLPEN` writer - MDIO clock enable during Sleep mode"]
pub type MDIOLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2LPENR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 27 - DSI clock enable during Sleep mode"]
    #[inline(always)]
    pub fn dsilpen(&self) -> DSILPEN_R {
        DSILPEN_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 29 - DFSDM1 clock enable during Sleep mode"]
    #[inline(always)]
    pub fn dfsdm1lpen(&self) -> DFSDM1LPEN_R {
        DFSDM1LPEN_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - MDIO clock enable during Sleep mode"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<7> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfsdm1lpen(&mut self) -> DFSDM1LPEN_W<29> {
        DFSDM1LPEN_W::new(self)
    }
    #[doc = "Bit 30 - MDIO clock enable during Sleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn mdiolpen(&mut self) -> MDIOLPEN_W<30> {
        MDIOLPEN_W::new(self)
    }
