#[doc = "Register `DFSDM0_CR2` reader"]
pub struct R(crate::R<DFSDM0_CR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM0_CR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM0_CR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM0_CR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM0_CR2` writer"]
pub struct W(crate::W<DFSDM0_CR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM0_CR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM0_CR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM0_CR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type JEOCIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type REOCIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type JOVRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type ROVRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type AWDIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type SCDIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type CKABIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM0_CR2_SPEC, bool, O>;
...
pub type EXCH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM0_CR2_SPEC, u8, u8, 8, O>;
...
pub type AWDCH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM0_CR2_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "DFSDM control register 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm0_cr2](index.html) module"]
pub struct DFSDM0_CR2_SPEC;
impl crate::RegisterSpec for DFSDM0_CR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm0_cr2::R](R) reader structure"]
impl crate::Readable for DFSDM0_CR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm0_cr2::W](W) writer structure"]
impl crate::Writable for DFSDM0_CR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM0_CR2 to value 0"]
impl crate::Resettable for DFSDM0_CR2_SPEC {
