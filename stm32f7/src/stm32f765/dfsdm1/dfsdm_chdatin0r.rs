#[doc = "Register `DFSDM_CHDATIN0R` reader"]
...
#[doc = "Register `DFSDM_CHDATIN0R` writer"]
...
#[doc = "`read()` method returns [dfsdm_chdatin0r::R](R) reader structure"]
impl crate::Readable for DFSDM_CHDATIN0R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_chdatin0r::W](W) writer structure"]
impl crate::Writable for DFSDM_CHDATIN0R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_CHDATIN0R to value 0"]
