...
pub struct R(crate::R<DFSDM_CHCFG1R1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM_CHCFG1R1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM_CHCFG1R1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM_CHCFG1R1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM_CHCFG1R1` writer"]
pub struct W(crate::W<DFSDM_CHCFG1R1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM_CHCFG1R1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM_CHCFG1R1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM_CHCFG1R1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SITP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, u8, u8, 2, O>;
...
pub type SPICKSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, u8, u8, 2, O>;
...
pub type SCDEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, bool, O>;
...
pub type CKABEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, bool, O>;
#[doc = "Field `CHEN` reader - Channel 1 enable"]
pub type CHEN_R = crate::BitReader<bool>;
#[doc = "Field `CHEN` writer - Channel 1 enable"]
pub type CHEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, bool, O>;
...
pub type CHINSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, bool, O>;
...
pub type DATMPX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, u8, u8, 2, O>;
...
pub type CKOUTDIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, u8, u8, 8, O>;
...
pub type CKOUTSRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, bool, O>;
...
pub type DFSDMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_CHCFG1R1_SPEC, bool, O>;
impl R {
...
#[doc = "DFSDM channel configuration 1 register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm_chcfg1r1](index.html) module"]
pub struct DFSDM_CHCFG1R1_SPEC;
impl crate::RegisterSpec for DFSDM_CHCFG1R1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm_chcfg1r1::R](R) reader structure"]
impl crate::Readable for DFSDM_CHCFG1R1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_chcfg1r1::W](W) writer structure"]
impl crate::Writable for DFSDM_CHCFG1R1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_CHCFG1R1 to value 0"]
impl crate::Resettable for DFSDM_CHCFG1R1_SPEC {
