...
pub struct R(crate::R<DFSDM0_AWLTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM0_AWLTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM0_AWLTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM0_AWLTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM0_AWLTR` writer"]
pub struct W(crate::W<DFSDM0_AWLTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM0_AWLTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM0_AWLTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM0_AWLTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BKAWL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM0_AWLTR_SPEC, u8, u8, 4, O>;
...
pub type AWLT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM0_AWLTR_SPEC, u32, u32, 24, O>;
impl R {
