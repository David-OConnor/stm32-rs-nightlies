...
pub struct R(crate::R<DFSDM_CHDATIN5R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM_CHDATIN5R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM_CHDATIN5R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM_CHDATIN5R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM_CHDATIN5R` writer"]
pub struct W(crate::W<DFSDM_CHDATIN5R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM_CHDATIN5R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM_CHDATIN5R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM_CHDATIN5R_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INDAT0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_CHDATIN5R_SPEC, u16, u16, 16, O>;
...
#[doc = "DFSDM channel data input register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm_chdatin5r](index.html) module"]
pub struct DFSDM_CHDATIN5R_SPEC;
impl crate::RegisterSpec for DFSDM_CHDATIN5R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm_chdatin5r::R](R) reader structure"]
impl crate::Readable for DFSDM_CHDATIN5R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_chdatin5r::W](W) writer structure"]
impl crate::Writable for DFSDM_CHDATIN5R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_CHDATIN5R to value 0"]
impl crate::Resettable for DFSDM_CHDATIN5R_SPEC {
