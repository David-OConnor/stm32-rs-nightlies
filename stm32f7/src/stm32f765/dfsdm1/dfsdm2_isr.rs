#[doc = "Register `DFSDM2_ISR` reader"]
pub struct R(crate::R<DFSDM2_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM2_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM2_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM2_ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DFSDM interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm2_isr](index.html) module"]
pub struct DFSDM2_ISR_SPEC;
impl crate::RegisterSpec for DFSDM2_ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm2_isr::R](R) reader structure"]
impl crate::Readable for DFSDM2_ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM2_ISR to value 0x00ff_0000"]
impl crate::Resettable for DFSDM2_ISR_SPEC {
