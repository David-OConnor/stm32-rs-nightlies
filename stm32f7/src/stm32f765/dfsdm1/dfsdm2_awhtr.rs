...
pub struct R(crate::R<DFSDM2_AWHTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM2_AWHTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM2_AWHTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM2_AWHTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM2_AWHTR` writer"]
pub struct W(crate::W<DFSDM2_AWHTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM2_AWHTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM2_AWHTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM2_AWHTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BKAWH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM2_AWHTR_SPEC, u8, u8, 4, O>;
...
pub type AWHT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM2_AWHTR_SPEC, u32, u32, 24, O>;
impl R {
