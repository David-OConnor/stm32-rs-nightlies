...
#[doc = "Field `AXILPEN` reader - AXI to AHB bridge clock enable during Sleep mode"]
pub type AXILPEN_R = crate::BitReader<bool>;
#[doc = "Field `AXILPEN` writer - AXI to AHB bridge clock enable during Sleep mode"]
pub type AXILPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB1LPENR_SPEC, bool, O>;
...
#[doc = "Field `DTCMLPEN` reader - DTCM RAM interface clock enable during Sleep mode"]
pub type DTCMLPEN_R = crate::BitReader<bool>;
#[doc = "Field `DTCMLPEN` writer - DTCM RAM interface clock enable during Sleep mode"]
pub type DTCMLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB1LPENR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn axilpen(&mut self) -> AXILPEN_W<13> {
        AXILPEN_W::new(self)
    }
    #[doc = "Bit 15 - Flash interface clock enable during Sleep mode"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtcmlpen(&mut self) -> DTCMLPEN_W<20> {
        DTCMLPEN_W::new(self)
    }
    #[doc = "Bit 21 - DMA1 clock enable during Sleep mode"]
    #[inline(always)]
