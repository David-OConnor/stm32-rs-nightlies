...
pub type MACA1H_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MACA1HR_SPEC, u16, u16, 16, O>;
#[doc = "Field `MBC` reader - MBC"]
pub type MBC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MBC` writer - MBC"]
pub type MBC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MACA1HR_SPEC, u8, u8, 6, O>;
...
pub type SA_W<'a, const O: u8> = crate::BitWriter<'a, u32, MACA1HR_SPEC, SA_A, O>;
...
pub type AE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MACA1HR_SPEC, AE_A, O>;
