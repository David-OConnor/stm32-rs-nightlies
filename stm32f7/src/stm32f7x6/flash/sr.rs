...
#[doc = "Field `ERSERR` reader - Programming sequence error"]
pub type ERSERR_R = crate::BitReader<ERSERRW_A>;
...
impl From<ERSERRW_A> for bool {
    #[inline(always)]
    fn from(variant: ERSERRW_A) -> Self {
        variant as u8 != 0
    }
}
impl ERSERR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ERSERRW_A> {
        match self.bits {
            true => Some(ERSERRW_A::Clear),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `Clear`"]
    #[inline(always)]
    pub fn is_clear(&self) -> bool {
        *self == ERSERRW_A::Clear
    }
}
#[doc = "Field `ERSERR` writer - Programming sequence error"]
pub type ERSERR_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, SR_SPEC, ERSERRW_A, O>;
impl<'a, const O: u8> ERSERR_W<'a, O> {
    #[doc = "Clear error flag"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
        self.variant(ERSERRW_A::Clear)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn erserr(&mut self) -> ERSERR_W<7> {
        ERSERR_W::new(self)
    }
