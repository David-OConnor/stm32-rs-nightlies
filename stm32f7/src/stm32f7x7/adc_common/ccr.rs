...
#[doc = "Field `VBATE` reader - V_BAT enable"]
...
#[doc = "Field `VBATE` writer - V_BAT enable"]
...
#[doc = "Field `TSVREFE` reader - Temperature sensor and V_REFINT enable"]
pub type TSVREFE_R = crate::BitReader<TSVREFE_A>;
#[doc = "Temperature sensor and V_REFINT enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TSVREFE_A {
...
#[doc = "Field `TSVREFE` writer - Temperature sensor and V_REFINT enable"]
