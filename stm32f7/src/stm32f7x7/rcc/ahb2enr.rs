...
#[doc = "Field `JPEGEN` reader - JPEG enable"]
pub type JPEGEN_R = crate::BitReader<bool>;
#[doc = "Field `JPEGEN` writer - JPEG enable"]
pub type JPEGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2ENR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 1 - JPEG enable"]
    #[inline(always)]
    pub fn jpegen(&self) -> JPEGEN_R {
        JPEGEN_R::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn jpegen(&mut self) -> JPEGEN_W<1> {
        JPEGEN_W::new(self)
    }
    #[doc = "Bit 4 - Cryptographic modules clock enable"]
    #[inline(always)]
