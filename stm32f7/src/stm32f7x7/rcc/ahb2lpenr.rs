...
pub type JPEGLPEN_R = crate::BitReader<bool>;
#[doc = "Field `JPEGLPEN` writer - JPEG module enabled during Sleep mode"]
pub type JPEGLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2LPENR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn jpeglpen(&mut self) -> JPEGLPEN_W<1> {
        JPEGLPEN_W::new(self)
    }
    #[doc = "Bit 4 - Cryptography modules clock enable during Sleep mode"]
    #[inline(always)]
