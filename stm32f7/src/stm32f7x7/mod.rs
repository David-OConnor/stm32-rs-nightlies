#![doc = "Peripheral access API for STM32F7X7 microcontrollers (generated using svd2rust v0.28.0 (27eebb4 2022-12-25))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
interrupts"]
    ...
    TIM1_BRK_TIM9 = 24,
    #[doc = "25 - TIM1 Update interrupt and TIM10"]
    TIM1_UP_TIM10 = 25,
...
impl DFSDM {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const dfsdm::RegisterBlock = 0x4001_7400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
