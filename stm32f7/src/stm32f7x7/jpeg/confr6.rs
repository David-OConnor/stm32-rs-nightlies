...
#[doc = "`read()` method returns [confr6::R](R) reader structure"]
impl crate::Readable for CONFR6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [confr6::W](W) writer structure"]
impl crate::Writable for CONFR6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CONFR6 to value 0"]
