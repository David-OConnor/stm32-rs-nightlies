...
pub type MER1_R = crate::BitReader<MER1_A>;
...
impl MER1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<MER1_A> {
        match self.bits {
            true => Some(MER1_A::MassErase),
            _ => None,
        }
    }
...
pub type MER1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, MER1_A, O>;
...
pub type MER2_R = crate::BitReader<MER2_A>;
...
impl MER2_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<MER2_A> {
        match self.bits {
            true => Some(MER2_A::MassErase),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `MassErase`"]
...
pub type MER2_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, MER2_A, O>;
