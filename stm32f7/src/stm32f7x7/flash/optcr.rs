...
pub type N_DBOOT_R = crate::BitReader<bool>;
#[doc = "Field `nDBOOT` writer - Dual Boot mode (valid only when nDBANK=0)"]
pub type N_DBOOT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPTCR_SPEC, bool, O>;
#[doc = "Field `nDBANK` reader - Not dual bank mode"]
pub type N_DBANK_R = crate::BitReader<bool>;
#[doc = "Field `nDBANK` writer - Not dual bank mode"]
pub type N_DBANK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPTCR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn n_dboot(&mut self) -> N_DBOOT_W<28> {
        N_DBOOT_W::new(self)
    }
    #[doc = "Bit 29 - Not dual bank mode"]
    #[inline(always)]
    #[must_use]
    pub fn n_dbank(&mut self) -> N_DBANK_W<29> {
        N_DBANK_W::new(self)
    }
    #[doc = "Bit 30 - Independent watchdog counter freeze in standby mode"]
    #[inline(always)]
