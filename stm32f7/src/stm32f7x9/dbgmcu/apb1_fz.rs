...
pub type DBG_LPTIM1_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1_FZ_SPEC, bool, O>;
...
pub type DBG_CAN3_STOP_R = crate::BitReader<bool>;
#[doc = "Field `DBG_CAN3_STOP` writer - DBG_CAN3_STOP"]
pub type DBG_CAN3_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1_FZ_SPEC, bool, O>;
...
pub type DBG_I2C3_SMBUS_TIMEOUT_R = crate::BitReader<bool>;
#[doc = "Field `DBG_I2C3_SMBUS_TIMEOUT` writer - DBG_I2C3_SMBUS_TIMEOUT"]
pub type DBG_I2C3_SMBUS_TIMEOUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB1_FZ_SPEC, bool, O>;
#[doc = "Field `DBG_I2C4_SMBUS_TIMEOUT` reader - DBG_I2C4SMBUS_TIMEOUT"]
pub type DBG_I2C4_SMBUS_TIMEOUT_R = crate::BitReader<bool>;
#[doc = "Field `DBG_I2C4_SMBUS_TIMEOUT` writer - DBG_I2C4SMBUS_TIMEOUT"]
pub type DBG_I2C4_SMBUS_TIMEOUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, APB1_FZ_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_lptim1_stop(&mut self) -> DBG_LPTIM1_STOP_W<9> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_can3_stop(&mut self) -> DBG_CAN3_STOP_W<13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_i2c3_smbus_timeout(&mut self) -> DBG_I2C3_SMBUS_TIMEOUT_W<23> {
        DBG_I2C3_SMBUS_TIMEOUT_W::new(self)
    }
    #[doc = "Bit 24 - DBG_I2C4SMBUS_TIMEOUT"]
    #[inline(always)]
    #[must_use]
    pub fn dbg_i2c4_smbus_timeout(&mut self) -> DBG_I2C4_SMBUS_TIMEOUT_W<24> {
