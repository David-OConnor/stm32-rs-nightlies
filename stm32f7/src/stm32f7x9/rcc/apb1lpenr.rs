...
#[doc = "Field `CAN3LPEN` reader - CAN 3 clock enable during Sleep mode"]
pub type CAN3LPEN_R = crate::BitReader<bool>;
#[doc = "Field `CAN3LPEN` writer - CAN 3 clock enable during Sleep mode"]
pub type CAN3LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1LPENR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 13 - CAN 3 clock enable during Sleep mode"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can3lpen(&mut self) -> CAN3LPEN_W<13> {
        CAN3LPEN_W::new(self)
    }
    #[doc = "Bit 14 - SPI2 clock enable during Sleep mode"]
    #[inline(always)]
