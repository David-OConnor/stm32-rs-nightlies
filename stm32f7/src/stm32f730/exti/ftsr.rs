...
#[doc = "Field `TR23` reader - Falling trigger event configuration of line 23"]
pub use TR0_R as TR23_R;
...
#[doc = "Field `TR23` writer - Falling trigger event configuration of line 23"]
pub use TR0_W as TR23_W;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tr23(&mut self) -> TR23_W<23> {
        TR23_W::new(self)
    }
