...
#[doc = "Field `RTCAPBLPEN` reader - RTCAPB clock enable during Sleep mode"]
pub type RTCAPBLPEN_R = crate::BitReader<bool>;
#[doc = "Field `RTCAPBLPEN` writer - RTCAPB clock enable during Sleep mode"]
pub type RTCAPBLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1LPENR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 10 - RTCAPB clock enable during Sleep mode"]
    #[inline(always)]
