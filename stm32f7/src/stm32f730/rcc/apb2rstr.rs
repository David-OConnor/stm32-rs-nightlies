...
#[doc = "Field `USBPHYCRST` reader - USB OTG HS PHY controller reset"]
pub use TIM1RST_R as USBPHYCRST_R;
...
#[doc = "Field `USBPHYCRST` writer - USB OTG HS PHY controller reset"]
pub use TIM1RST_W as USBPHYCRST_W;
impl R {
    ...
    pub fn usbphycrst(&self) -> USBPHYCRST_R {
        USBPHYCRST_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM1 reset"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbphycrst(&mut self) -> USBPHYCRST_W<31> {
        USBPHYCRST_W::new(self)
    }
