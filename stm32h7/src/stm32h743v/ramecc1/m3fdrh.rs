...
pub struct W(crate::W<M3FDRH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M3FDRH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<M3FDRH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M3FDRH_SPEC>) -> Self {
        W(writer)
    }
}
...
impl crate::Writable for M3FDRH_SPEC {
    type Writer = W;
