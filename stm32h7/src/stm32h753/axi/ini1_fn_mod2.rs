...
pub struct R(crate::R<INI1_FN_MOD2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INI1_FN_MOD2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INI1_FN_MOD2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INI1_FN_MOD2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INI1_FN_MOD2` writer"]
pub struct W(crate::W<INI1_FN_MOD2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INI1_FN_MOD2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INI1_FN_MOD2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INI1_FN_MOD2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BYPASS_MERGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, INI1_FN_MOD2_SPEC, bool, O>;
impl R {
