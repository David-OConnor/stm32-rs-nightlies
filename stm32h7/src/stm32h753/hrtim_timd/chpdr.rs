...
pub type CHPFRQ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHPDR_SPEC, u8, u8, 4, O>;
...
pub type CHPDTY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHPDR_SPEC, u8, u8, 3, O>;
#[doc = "Field `STRTPW` reader - STRTPW"]
pub type STRTPW_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STRTPW` writer - STRTPW"]
pub type STRTPW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHPDR_SPEC, u8, u8, 4, O>;
impl R {
