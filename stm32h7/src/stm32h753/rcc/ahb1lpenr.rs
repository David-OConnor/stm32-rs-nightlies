...
#[doc = "Field `USB1OTGHSULPILPEN` reader - USB_PHY1 clock enable during CSleep mode"]
pub use DMA1LPEN_R as USB1OTGHSULPILPEN_R;
#[doc = "Field `USB2OTGLPEN` reader - USB2OTG peripheral clock enable during CSleep mode"]
pub use DMA1LPEN_R as USB2OTGLPEN_R;
#[doc = "Field `USB2OTGHSULPILPEN` reader - USB_PHY2 clocks enable during CSleep mode"]
pub use DMA1LPEN_R as USB2OTGHSULPILPEN_R;
...
#[doc = "Field `USB1OTGHSULPILPEN` writer - USB_PHY1 clock enable during CSleep mode"]
pub use DMA1LPEN_W as USB1OTGHSULPILPEN_W;
#[doc = "Field `USB2OTGLPEN` writer - USB2OTG peripheral clock enable during CSleep mode"]
pub use DMA1LPEN_W as USB2OTGLPEN_W;
#[doc = "Field `USB2OTGHSULPILPEN` writer - USB_PHY2 clocks enable during CSleep mode"]
pub use DMA1LPEN_W as USB2OTGHSULPILPEN_W;
impl R {
    ...
    pub fn usb1otghsulpilpen(&self) -> USB1OTGHSULPILPEN_R {
        USB1OTGHSULPILPEN_R::new(((self.bits >> 26) & 1) != 0)
    }
    ...
    pub fn usb2otghsulpilpen(&self) -> USB2OTGHSULPILPEN_R {
        USB2OTGHSULPILPEN_R::new(((self.bits >> 28) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA1 Clock Enable During CSleep Mode"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb1otghsulpilpen(&mut self) -> USB1OTGHSULPILPEN_W<26> {
        USB1OTGHSULPILPEN_W::new(self)
    }
    #[doc = "Bit 27 - USB2OTG peripheral clock enable during CSleep mode"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usb2otghsulpilpen(&mut self) -> USB2OTGHSULPILPEN_W<28> {
        USB2OTGHSULPILPEN_W::new(self)
    }
