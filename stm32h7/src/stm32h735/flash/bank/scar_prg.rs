...
pub struct R(crate::R<SCAR_PRG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCAR_PRG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCAR_PRG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCAR_PRG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCAR_PRG` writer"]
pub struct W(crate::W<SCAR_PRG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCAR_PRG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCAR_PRG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCAR_PRG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SEC_AREA_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SCAR_PRG_SPEC, u16, u16, 12, O>;
...
pub type DMES_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCAR_PRG_SPEC, bool, O>;
impl R {
