...
#[doc = "Field `TRBUFF` reader - Enable the DMA to handle bufferable transfers"]
pub type TRBUFF_R = crate::BitReader<TRBUFF_A>;
#[doc = "Enable the DMA to handle bufferable transfers\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TRBUFF_A {
    #[doc = "0: Bufferable transfers not enabled"]
    Disabled = 0,
    #[doc = "1: Bufferable transfers enabled"]
    Enabled = 1,
}
impl From<TRBUFF_A> for bool {
    #[inline(always)]
    fn from(variant: TRBUFF_A) -> Self {
        variant as u8 != 0
    }
}
impl TRBUFF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TRBUFF_A {
        match self.bits {
            false => TRBUFF_A::Disabled,
            true => TRBUFF_A::Enabled,
        }
    }
    #[doc = "Checks if the value of the field is `Disabled`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == TRBUFF_A::Disabled
    }
    #[doc = "Checks if the value of the field is `Enabled`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == TRBUFF_A::Enabled
    }
}
#[doc = "Field `TRBUFF` writer - Enable the DMA to handle bufferable transfers"]
pub type TRBUFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, TRBUFF_A, O>;
impl<'a, const O: u8> TRBUFF_W<'a, O> {
    #[doc = "Bufferable transfers not enabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(TRBUFF_A::Disabled)
    }
    #[doc = "Bufferable transfers enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(TRBUFF_A::Enabled)
    }
}
...
impl R {
    ...
    #[doc = "Bit 20 - Enable the DMA to handle bufferable transfers"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trbuff(&mut self) -> TRBUFF_W<20> {
        TRBUFF_W::new(self)
    }
    #[doc = "Bits 21:22 - Peripheral burst transfer configuration"]
    #[inline(always)]
