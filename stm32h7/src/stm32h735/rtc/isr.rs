...
pub type ITSF_R = crate::BitReader<ITSFR_A>;
...
impl From<ITSFR_A> for bool {
    #[inline(always)]
    fn from(variant: ITSFR_A) -> Self {
        variant as u8 != 0
    }
}
impl ITSF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ITSFR_A> {
        match self.bits {
            true => Some(ITSFR_A::Match),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `Match`"]
...
impl From<ITSFW_AW> for bool {
    #[inline(always)]
    fn from(variant: ITSFW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ITSF` writer - Internal tTime-stamp flag"]
pub type ITSF_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, ISR_SPEC, ITSFW_AW, O>;
...
impl crate::Writable for ISR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x0002_ff20;
