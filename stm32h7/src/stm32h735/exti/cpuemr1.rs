...
pub struct R(crate::R<CPUEMR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPUEMR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPUEMR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPUEMR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPUEMR1` writer"]
pub struct W(crate::W<CPUEMR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPUEMR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPUEMR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPUEMR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MR0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPUEMR1_SPEC, MR0_A, O>;
...
#[doc = "EXTI event mask register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpuemr1](index.html) module"]
pub struct CPUEMR1_SPEC;
impl crate::RegisterSpec for CPUEMR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cpuemr1::R](R) reader structure"]
impl crate::Readable for CPUEMR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpuemr1::W](W) writer structure"]
impl crate::Writable for CPUEMR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CPUEMR1 to value 0"]
impl crate::Resettable for CPUEMR1_SPEC {
