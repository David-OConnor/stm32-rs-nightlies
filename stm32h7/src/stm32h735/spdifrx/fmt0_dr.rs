#[doc = "Register `FMT0_DR` reader"]
pub struct R(crate::R<FMT0_DR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FMT0_DR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FMT0_DR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FMT0_DR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Data input register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fmt0_dr](index.html) module"]
pub struct FMT0_DR_SPEC;
impl crate::RegisterSpec for FMT0_DR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fmt0_dr::R](R) reader structure"]
impl crate::Readable for FMT0_DR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets FMT0_DR to value 0"]
impl crate::Resettable for FMT0_DR_SPEC {
