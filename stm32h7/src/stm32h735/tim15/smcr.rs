...
pub type TS_2_0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TS_2_0` writer - Trigger selection"]
pub type TS_2_0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SMCR_SPEC, u8, u8, 3, O>;
...
pub type TS_4_3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SMCR_SPEC, u8, u8, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ts_2_0(&mut self) -> TS_2_0_W<4> {
        TS_2_0_W::new(self)
    }
    #[doc = "Bit 7 - Master/Slave mode"]
    #[inline(always)]
