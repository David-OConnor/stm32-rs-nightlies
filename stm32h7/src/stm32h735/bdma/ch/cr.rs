...
#[doc = "Field `HTIE` reader - Half transfer error interrupt enable"]
...
#[doc = "Field `HTIE` writer - Half transfer error interrupt enable"]
...
impl R {
    ...
    #[doc = "Bit 2 - Half transfer error interrupt enable"]
    #[inline(always)]
