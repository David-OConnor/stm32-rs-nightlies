...
pub use TIM2LPEN_R as I2C5LPEN_R;
...
pub use TIM2LPEN_W as I2C5LPEN_W;
...
impl R {
    ...
    pub fn i2c5lpen(&self) -> I2C5LPEN_R {
        I2C5LPEN_R::new(((self.bits >> 25) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c5lpen(&mut self) -> I2C5LPEN_W<25> {
        I2C5LPEN_W::new(self)
    }
    #[doc = "Bit 27 - HDMI-CEC Peripheral Clocks Enable During CSleep Mode"]
    #[inline(always)]
...
#[doc = "`reset()` method sets C1_APB1LLPENR to value 0xe8ff_cbff"]
impl crate::Resettable for C1_APB1LLPENR_SPEC {
    const RESET_VALUE: Self::Ux = 0xe8ff_cbff;
}
