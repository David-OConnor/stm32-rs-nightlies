...
#[doc = "Field `UART9LPEN` reader - UART9 peripheral clocks enable during CSleep Mode"]
pub use TIM1LPEN_R as UART9LPEN_R;
#[doc = "Field `USART10LPEN` reader - USART10 peripheral clocks enable during CSleep Mode"]
...
#[doc = "Field `UART9LPEN` writer - UART9 peripheral clocks enable during CSleep Mode"]
pub use TIM1LPEN_W as UART9LPEN_W;
#[doc = "Field `USART10LPEN` writer - USART10 peripheral clocks enable during CSleep Mode"]
...
impl R {
    ...
    #[doc = "Bit 6 - UART9 peripheral clocks enable during CSleep Mode"]
    #[inline(always)]
    pub fn uart9lpen(&self) -> UART9LPEN_R {
        UART9LPEN_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - USART10 peripheral clocks enable during CSleep Mode"]
    #[inline(always)]
