...
pub use DCMIEN_R as FMACEN_R;
#[doc = "Field `CORDICEN` reader - CORDIC enable"]
pub use DCMIEN_R as CORDICEN_R;
...
pub use DCMIEN_W as FMACEN_W;
#[doc = "Field `CORDICEN` writer - CORDIC enable"]
pub use DCMIEN_W as CORDICEN_W;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fmacen(&mut self) -> FMACEN_W<16> {
        FMACEN_W::new(self)
    }
    #[doc = "Bit 17 - CORDIC enable"]
    #[inline(always)]
    #[must_use]
    pub fn cordicen(&mut self) -> CORDICEN_W<17> {
        CORDICEN_W::new(self)
    }
    #[doc = "Bit 29 - SRAM1 block enable"]
    #[inline(always)]
