...
#[doc = "Field `DTSRST` reader - Digital temperature sensor block reset"]
...
#[doc = "Field `DTSRST` writer - Digital temperature sensor block reset"]
...
impl R {
    ...
    #[doc = "Bit 26 - Digital temperature sensor block reset"]
    #[inline(always)]
