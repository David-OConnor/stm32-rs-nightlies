...
#[doc = "RAMECC monitor x configuration register"]
pub mod m2cr;
#[doc = "M3CR (rw) register accessor: an alias for `Reg<M3CR_SPEC>`"]
pub type M3CR = crate::Reg<m3cr::M3CR_SPEC>;
#[doc = "RAMECC monitor x configuration register"]
pub mod m3cr;
#[doc = "M4CR (rw) register accessor: an alias for `Reg<M4CR_SPEC>`"]
pub type M4CR = crate::Reg<m4cr::M4CR_SPEC>;
#[doc = "RAMECC monitor x configuration register"]
pub mod m4cr;
#[doc = "M5CR (rw) register accessor: an alias for `Reg<M5CR_SPEC>`"]
...
#[doc = "RAMECC monitor x status register"]
pub mod m2sr;
#[doc = "M3SR (rw) register accessor: an alias for `Reg<M3SR_SPEC>`"]
pub type M3SR = crate::Reg<m3sr::M3SR_SPEC>;
#[doc = "RAMECC monitor x status register"]
pub mod m3sr;
#[doc = "M4SR (rw) register accessor: an alias for `Reg<M4SR_SPEC>`"]
...
#[doc = "RAMECC monitor x status register"]
pub mod m5sr;
#[doc = "M1FAR (r) register accessor: an alias for `Reg<M1FAR_SPEC>`"]
pub type M1FAR = crate::Reg<m1far::M1FAR_SPEC>;
#[doc = "RAMECC monitor x failing address register"]
pub mod m1far;
#[doc = "M2FAR (r) register accessor: an alias for `Reg<M2FAR_SPEC>`"]
pub type M2FAR = crate::Reg<m2far::M2FAR_SPEC>;
#[doc = "RAMECC monitor x failing address register"]
pub mod m2far;
#[doc = "M3FAR (r) register accessor: an alias for `Reg<M3FAR_SPEC>`"]
...
#[doc = "RAMECC monitor x failing address register"]
pub mod m5far;
#[doc = "M1FDRL (r) register accessor: an alias for `Reg<M1FDRL_SPEC>`"]
pub type M1FDRL = crate::Reg<m1fdrl::M1FDRL_SPEC>;
#[doc = "RAMECC monitor x failing data low register"]
pub mod m1fdrl;
#[doc = "M2FDRL (r) register accessor: an alias for `Reg<M2FDRL_SPEC>`"]
...
#[doc = "RAMECC monitor x failing data low register"]
pub mod m3fdrl;
#[doc = "M4FDRL (r) register accessor: an alias for `Reg<M4FDRL_SPEC>`"]
...
#[doc = "RAMECC monitor x failing data low register"]
pub mod m5fdrl;
#[doc = "M1FDRH (r) register accessor: an alias for `Reg<M1FDRH_SPEC>`"]
