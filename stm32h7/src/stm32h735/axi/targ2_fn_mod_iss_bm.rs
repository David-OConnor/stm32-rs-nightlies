#[doc = "Register `TARG2_FN_MOD_ISS_BM` reader"]
...
#[doc = "Register `TARG2_FN_MOD_ISS_BM` writer"]
...
#[doc = "`read()` method returns [targ2_fn_mod_iss_bm::R](R) reader structure"]
impl crate::Readable for TARG2_FN_MOD_ISS_BM_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [targ2_fn_mod_iss_bm::W](W) writer structure"]
impl crate::Writable for TARG2_FN_MOD_ISS_BM_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TARG2_FN_MOD_ISS_BM to value 0x04"]
