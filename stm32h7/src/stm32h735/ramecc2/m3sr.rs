...
pub struct W(crate::W<M3SR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M3SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<M3SR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M3SR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SEDCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, M3SR_SPEC, bool, O>;
...
pub type DEDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, M3SR_SPEC, bool, O>;
...
pub type DEBWDF_W<'a, const O: u8> = crate::BitWriter<'a, u32, M3SR_SPEC, bool, O>;
impl R {
