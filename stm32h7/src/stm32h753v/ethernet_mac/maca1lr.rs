...
#[doc = "Field `ADDRLO` reader - MAC Address 1 \\[31:0\\]"]
pub type ADDRLO_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ADDRLO` writer - MAC Address 1 \\[31:0\\]"]
pub type ADDRLO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MACA1LR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - MAC Address 1 \\[31:0\\]"]
    #[inline(always)]
