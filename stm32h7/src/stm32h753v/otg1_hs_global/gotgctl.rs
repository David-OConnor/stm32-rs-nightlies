...
#[doc = "Field `VBVALOEN` reader - V_BUS valid override enable"]
pub type VBVALOEN_R = crate::BitReader<bool>;
#[doc = "Field `VBVALOEN` writer - V_BUS valid override enable"]
pub type VBVALOEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GOTGCTL_SPEC, bool, O>;
#[doc = "Field `VBVALOVAL` reader - V_BUS valid override value"]
pub type VBVALOVAL_R = crate::BitReader<bool>;
#[doc = "Field `VBVALOVAL` writer - V_BUS valid override value"]
...
impl R {
    ...
    #[doc = "Bit 2 - V_BUS valid override enable"]
    #[inline(always)]
    pub fn vbvaloen(&self) -> VBVALOEN_R {
        VBVALOEN_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - V_BUS valid override value"]
    #[inline(always)]
