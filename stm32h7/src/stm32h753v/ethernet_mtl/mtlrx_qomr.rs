...
#[doc = "Field `DIS_TCP_EF` reader - Disable Dropping of TCP/IP Checksum Error Packets"]
pub type DIS_TCP_EF_R = crate::BitReader<bool>;
#[doc = "Field `DIS_TCP_EF` writer - Disable Dropping of TCP/IP Checksum Error Packets"]
...
impl R {
    ...
    #[doc = "Bit 6 - Disable Dropping of TCP/IP Checksum Error Packets"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:10 - Threshold for Activating Flow Control (in half-duplex and full-duplex modes)"]
    #[inline(always)]
    pub fn rfa(&self) -> RFA_R {
        RFA_R::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bits 14:16 - Threshold for Deactivating Flow Control (in half-duplex and full-duplex modes)"]
    #[inline(always)]
