...
#[doc = "Field `DOUT6` reader - Output data sent to MDIO Master during read frames"]
pub type DOUT6_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DOUT6` writer - Output data sent to MDIO Master during read frames"]
...
#[doc = "`read()` method returns [doutr6::R](R) reader structure"]
impl crate::Readable for DOUTR6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [doutr6::W](W) writer structure"]
impl crate::Writable for DOUTR6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOUTR6 to value 0"]
