...
pub struct R(crate::R<INI1_FN_MOD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INI1_FN_MOD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INI1_FN_MOD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INI1_FN_MOD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INI1_FN_MOD` writer"]
pub struct W(crate::W<INI1_FN_MOD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INI1_FN_MOD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INI1_FN_MOD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INI1_FN_MOD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type READ_ISS_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INI1_FN_MOD_SPEC, READ_ISS_OVERRIDE_A, O>;
...
pub type WRITE_ISS_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INI1_FN_MOD_SPEC, WRITE_ISS_OVERRIDE_A, O>;
