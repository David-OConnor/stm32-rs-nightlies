...
#[doc = "Register `M4CR` writer"]
pub struct W(crate::W<M4CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<M4CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<M4CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<M4CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ECCSEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M4CR_SPEC, bool, O>;
...
pub type ECCDEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M4CR_SPEC, bool, O>;
...
pub type ECCDEBWIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, M4CR_SPEC, bool, O>;
...
pub type ECCELEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, M4CR_SPEC, bool, O>;
impl R {
...
#[doc = "`write(|w| ..)` method takes [m4cr::W](W) writer structure"]
impl crate::Writable for M4CR_SPEC {
    type Writer = W;
