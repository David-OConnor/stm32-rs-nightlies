...
pub type OFFSET4_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, OFR4_SPEC, u32, u32, 26, O>;
...
pub type SSATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OFR4_SPEC, SSATE_A, O>;
