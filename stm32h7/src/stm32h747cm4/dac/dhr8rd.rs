...
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DHR8RD_SPEC, u8, u8, 8, O>;
...
pub type DACC2DHR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DHR8RD_SPEC, u8, u8, 8, O>;
impl R {
