#[doc = "Register `C1PR1` reader"]
pub struct R(crate::R<C1PR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C1PR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C1PR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C1PR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C1PR1` writer"]
pub struct W(crate::W<C1PR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C1PR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C1PR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C1PR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PR0_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, C1PR1_SPEC, PR0W_AW, O>;
...
#[doc = "EXTI pending register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c1pr1](index.html) module"]
pub struct C1PR1_SPEC;
impl crate::RegisterSpec for C1PR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c1pr1::R](R) reader structure"]
impl crate::Readable for C1PR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c1pr1::W](W) writer structure"]
impl crate::Writable for C1PR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x003f_ffff;
}
#[doc = "`reset()` method sets C1PR1 to value 0"]
impl crate::Resettable for C1PR1_SPEC {
