...
pub type TXQEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MTLTX_QOMR_SPEC, u8, u8, 2, O>;
...
pub type TQS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MTLTX_QOMR_SPEC, u16, u16, 9, O>;
impl R {
