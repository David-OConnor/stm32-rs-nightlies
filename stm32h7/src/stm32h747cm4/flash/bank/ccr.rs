...
pub type CLR_CRCRDERR_R = crate::BitReader<bool>;
#[doc = "Field `CLR_CRCRDERR` writer - Bank 1 CRCRDERR1 flag clear bit"]
pub type CLR_CRCRDERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr_crcrderr(&mut self) -> CLR_CRCRDERR_W<28> {
        CLR_CRCRDERR_W::new(self)
    }
