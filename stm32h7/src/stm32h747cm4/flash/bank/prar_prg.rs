...
#[doc = "Field `PROT_AREA_START` writer - Bank 1 PCROP area start configuration bits"]
pub type PROT_AREA_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PRAR_PRG_SPEC, u16, u16, 12, O>;
#[doc = "Field `PROT_AREA_END` reader - Bank 1 PCROP area end configuration bits"]
pub type PROT_AREA_END_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PROT_AREA_END` writer - Bank 1 PCROP area end configuration bits"]
