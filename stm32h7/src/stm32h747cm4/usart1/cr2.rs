...
#[doc = "Field `DIS_NSS` reader - When the DSI_NSS bit is set, the NSS pin input is ignored"]
pub type DIS_NSS_R = crate::BitReader<bool>;
#[doc = "Field `DIS_NSS` writer - When the DSI_NSS bit is set, the NSS pin input is ignored"]
...
impl R {
    ...
    #[doc = "Bit 3 - When the DSI_NSS bit is set, the NSS pin input is ignored"]
    #[inline(always)]
