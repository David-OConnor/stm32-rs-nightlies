...
pub type CMP1X_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP1CAR_SPEC, u16, u16, 16, O>;
...
pub type REPX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP1CAR_SPEC, u8, u8, 8, O>;
impl R {
