...
#[doc = "`read()` method returns [timadier5::R](R) reader structure"]
impl crate::Readable for TIMADIER5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timadier5::W](W) writer structure"]
impl crate::Writable for TIMADIER5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIMADIER5 to value 0"]
