...
pub type DOUT26_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DOUT26` writer - Output data sent to MDIO Master during read frames"]
pub type DOUT26_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOUTR26_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout26(&mut self) -> DOUT26_W<0> {
        DOUT26_W::new(self)
    }
