...
pub type CSGCM1R_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSGCM1R` writer - CSGCM1R"]
pub type CSGCM1R_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSGCM1R_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csgcm1r(&mut self) -> CSGCM1R_W<0> {
        CSGCM1R_W::new(self)
    }
