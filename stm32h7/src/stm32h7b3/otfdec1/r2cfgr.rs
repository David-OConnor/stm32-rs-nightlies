#[doc = "Register `R2CFGR` reader"]
pub struct R(crate::R<R2CFGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R2CFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R2CFGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R2CFGR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R2CFGR` writer"]
pub struct W(crate::W<R2CFGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R2CFGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R2CFGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R2CFGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REG_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, R2CFGR_SPEC, bool, O>;
...
pub type CONFIGLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, R2CFGR_SPEC, bool, O>;
#[doc = "Field `KEYLOCK` reader - region key lock"]
pub type KEYLOCK_R = crate::BitReader<bool>;
#[doc = "Field `KEYLOCK` writer - region key lock"]
pub type KEYLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, R2CFGR_SPEC, bool, O>;
#[doc = "Field `MODE` reader - operating mode"]
pub type MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MODE` writer - operating mode"]
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, R2CFGR_SPEC, u8, u8, 2, O>;
...
pub type REGX_VERSION_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, R2CFGR_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "OTFDEC region x configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r2cfgr](index.html) module"]
pub struct R2CFGR_SPEC;
impl crate::RegisterSpec for R2CFGR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r2cfgr::R](R) reader structure"]
impl crate::Readable for R2CFGR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r2cfgr::W](W) writer structure"]
impl crate::Writable for R2CFGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets R2CFGR to value 0"]
impl crate::Resettable for R2CFGR_SPEC {
