...
pub struct R(crate::R<CDCCIP2R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CDCCIP2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CDCCIP2R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CDCCIP2R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CDCCIP2R` writer"]
pub struct W(crate::W<CDCCIP2R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CDCCIP2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CDCCIP2R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CDCCIP2R_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USART234578SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CDCCIP2R_SPEC, u8, USART234578SEL_A, 3, O>;
...
pub type USART16910SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CDCCIP2R_SPEC, u8, USART16910SEL_A, 3, O>;
...
pub type RNGSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CDCCIP2R_SPEC, u8, RNGSEL_A, 2, O>;
...
pub type I2C123SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CDCCIP2R_SPEC, u8, I2C123SEL_A, 2, O>;
...
pub type USBSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CDCCIP2R_SPEC, u8, USBSEL_A, 2, O>;
...
pub type CECSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CDCCIP2R_SPEC, u8, CECSEL_A, 2, O>;
...
pub type LPTIM1SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CDCCIP2R_SPEC, u8, LPTIM1SEL_A, 3, O>;
