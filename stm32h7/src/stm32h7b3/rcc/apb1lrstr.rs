...
#[doc = "Field `TIM13RST` reader - TIM13 block reset Set and reset by software."]
...
#[doc = "Field `SPDIFRXRST` reader - SPDIFRX block reset Set and reset by software."]
...
#[doc = "Field `DAC1RST` reader - DAC1 (containing two converters) reset Set and reset by software."]
...
#[doc = "Field `TIM13RST` writer - TIM13 block reset Set and reset by software."]
...
#[doc = "Field `SPDIFRXRST` writer - SPDIFRX block reset Set and reset by software."]
...
#[doc = "Field `DAC1RST` writer - DAC1 (containing two converters) reset Set and reset by software."]
...
impl R {
    ...
    #[doc = "Bit 7 - TIM13 block reset Set and reset by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - LPTIM1 block reset Set and reset by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - SPDIFRX block reset Set and reset by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - I2C3 block reset Set and reset by software."]
    #[inline(always)]
    pub fn i2c3rst(&self) -> I2C3RST_R {
        I2C3RST_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 27 - HDMI-CEC block reset Set and reset by software."]
    #[inline(always)]
    pub fn cecrst(&self) -> CECRST_R {
        CECRST_R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 29 - DAC1 (containing two converters) reset Set and reset by software."]
    #[inline(always)]
