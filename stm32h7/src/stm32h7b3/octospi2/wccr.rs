...
pub type IMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WCCR_SPEC, u8, u8, 2, O>;
...
pub type ISIZE_R = crate::BitReader<bool>;
#[doc = "Field `ISIZE` writer - Instruction size"]
pub type ISIZE_W<'a, const O: u8> = crate::BitWriter<'a, u32, WCCR_SPEC, bool, O>;
...
impl R {
    #[doc = "Bits 0:1 - Instruction mode"]
    #[inline(always)]
    pub fn imode(&self) -> IMODE_R {
        IMODE_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - Instruction double transfer rate"]
    #[inline(always)]
    pub fn idtr(&self) -> IDTR_R {
        IDTR_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Instruction size"]
    #[inline(always)]
    pub fn isize(&self) -> ISIZE_R {
        ISIZE_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn idtr(&mut self) -> IDTR_W<2> {
        IDTR_W::new(self)
    }
    #[doc = "Bit 3 - Instruction size"]
    #[inline(always)]
    #[must_use]
    pub fn isize(&mut self) -> ISIZE_W<3> {
        ISIZE_W::new(self)
    }
    #[doc = "Bits 8:10 - Address mode"]
    #[inline(always)]
