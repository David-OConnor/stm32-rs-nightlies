...
pub struct R(crate::R<TARG5_FN_MOD_ISS_BM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TARG5_FN_MOD_ISS_BM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TARG5_FN_MOD_ISS_BM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TARG5_FN_MOD_ISS_BM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TARG5_FN_MOD_ISS_BM` writer"]
pub struct W(crate::W<TARG5_FN_MOD_ISS_BM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TARG5_FN_MOD_ISS_BM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TARG5_FN_MOD_ISS_BM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TARG5_FN_MOD_ISS_BM_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type READ_ISS_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TARG5_FN_MOD_ISS_BM_SPEC, bool, O>;
