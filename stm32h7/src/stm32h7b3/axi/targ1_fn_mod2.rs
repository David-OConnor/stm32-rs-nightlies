#[doc = "Register `TARG1_FN_MOD2` reader"]
...
#[doc = "Register `TARG1_FN_MOD2` writer"]
...
#[doc = "`read()` method returns [targ1_fn_mod2::R](R) reader structure"]
impl crate::Readable for TARG1_FN_MOD2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [targ1_fn_mod2::W](W) writer structure"]
impl crate::Writable for TARG1_FN_MOD2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TARG1_FN_MOD2 to value 0x04"]
