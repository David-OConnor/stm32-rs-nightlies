...
pub type TEC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_ECR_SPEC, u8, u8, 8, O>;
...
pub type TREC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_ECR_SPEC, u8, u8, 7, O>;
