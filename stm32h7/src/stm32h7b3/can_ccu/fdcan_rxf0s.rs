...
pub type F0FL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_RXF0S_SPEC, u8, u8, 7, O>;
#[doc = "Field `F0G` reader - Rx FIFO 0 Get Index"]
pub type F0G_R = crate::FieldReader<u8, u8>;
#[doc = "Field `F0G` writer - Rx FIFO 0 Get Index"]
pub type F0G_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_RXF0S_SPEC, u8, u8, 6, O>;
#[doc = "Field `F0P` reader - Rx FIFO 0 Put Index"]
pub type F0P_R = crate::FieldReader<u8, u8>;
#[doc = "Field `F0P` writer - Rx FIFO 0 Put Index"]
pub type F0P_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_RXF0S_SPEC, u8, u8, 6, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn f0g(&mut self) -> F0G_W<8> {
        F0G_W::new(self)
    }
    #[doc = "Bits 16:21 - Rx FIFO 0 Put Index"]
    #[inline(always)]
    #[must_use]
    pub fn f0p(&mut self) -> F0P_W<16> {
        F0P_W::new(self)
    }
    #[doc = "Bit 24 - Rx FIFO 0 Full"]
    #[inline(always)]
