...
pub struct R(crate::R<DOUTR27_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DOUTR27_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DOUTR27_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DOUTR27_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DOUTR27` writer"]
pub struct W(crate::W<DOUTR27_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DOUTR27_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DOUTR27_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DOUTR27_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DOUT27` reader - Output data sent to MDIO Master during read frames"]
pub type DOUT27_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DOUT27` writer - Output data sent to MDIO Master during read frames"]
pub type DOUT27_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DOUTR27_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dout27(&mut self) -> DOUT27_W<0> {
        DOUT27_W::new(self)
    }
