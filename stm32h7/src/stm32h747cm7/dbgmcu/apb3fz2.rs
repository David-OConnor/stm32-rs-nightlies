...
pub struct R(crate::R<APB3FZ2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<APB3FZ2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<APB3FZ2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<APB3FZ2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `APB3FZ2` writer"]
pub struct W(crate::W<APB3FZ2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<APB3FZ2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<APB3FZ2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<APB3FZ2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WWDG1_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB3FZ2_SPEC, bool, O>;
impl R {
