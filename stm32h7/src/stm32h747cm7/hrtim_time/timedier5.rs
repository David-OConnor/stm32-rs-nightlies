...
pub type SET1X_IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMEDIER5_SPEC, bool, O>;
...
pub type SET1X_DE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMEDIER5_SPEC, bool, O>;
