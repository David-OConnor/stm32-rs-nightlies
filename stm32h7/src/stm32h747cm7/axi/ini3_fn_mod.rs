#[doc = "Register `INI3_FN_MOD` reader"]
pub struct R(crate::R<INI3_FN_MOD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INI3_FN_MOD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INI3_FN_MOD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INI3_FN_MOD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INI3_FN_MOD` writer"]
pub struct W(crate::W<INI3_FN_MOD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INI3_FN_MOD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INI3_FN_MOD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INI3_FN_MOD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type READ_ISS_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INI3_FN_MOD_SPEC, READ_ISS_OVERRIDE_A, O>;
...
pub type WRITE_ISS_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, INI3_FN_MOD_SPEC, WRITE_ISS_OVERRIDE_A, O>;
...
#[doc = "AXI interconnect - INI x issuing functionality modification register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ini3_fn_mod](index.html) module"]
pub struct INI3_FN_MOD_SPEC;
impl crate::RegisterSpec for INI3_FN_MOD_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ini3_fn_mod::R](R) reader structure"]
impl crate::Readable for INI3_FN_MOD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ini3_fn_mod::W](W) writer structure"]
impl crate::Writable for INI3_FN_MOD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets INI3_FN_MOD to value 0x04"]
impl crate::Resettable for INI3_FN_MOD_SPEC {
