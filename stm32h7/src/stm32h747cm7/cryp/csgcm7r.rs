...
pub type CSGCM7R_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSGCM7R` writer - CSGCM7R"]
pub type CSGCM7R_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSGCM7R_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csgcm7r(&mut self) -> CSGCM7R_W<0> {
        CSGCM7R_W::new(self)
    }
