...
pub type CSGCM5R_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSGCM5R` writer - CSGCM5R"]
pub type CSGCM5R_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSGCM5R_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csgcm5r(&mut self) -> CSGCM5R_W<0> {
        CSGCM5R_W::new(self)
    }
