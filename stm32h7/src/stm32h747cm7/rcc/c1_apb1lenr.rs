...
pub type TIM2EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C1_APB1LENR_SPEC, TIM2EN_A, O>;
...
#[doc = "Field `WWDG2EN` reader - WWDG2 peripheral clock enable"]
pub use TIM2EN_R as WWDG2EN_R;
...
#[doc = "Field `WWDG2EN` writer - WWDG2 peripheral clock enable"]
pub use TIM2EN_W as WWDG2EN_W;
...
impl R {
    ...
    #[doc = "Bit 11 - WWDG2 peripheral clock enable"]
    #[inline(always)]
    pub fn wwdg2en(&self) -> WWDG2EN_R {
        WWDG2EN_R::new(((self.bits >> 11) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wwdg2en(&mut self) -> WWDG2EN_W<11> {
        WWDG2EN_W::new(self)
    }
    #[doc = "Bit 14 - SPI2 Peripheral Clocks Enable"]
    #[inline(always)]
