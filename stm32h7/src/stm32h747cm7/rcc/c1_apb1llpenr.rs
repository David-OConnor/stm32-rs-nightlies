...
#[doc = "Field `WWDG2LPEN` reader - WWDG2 peripheral Clocks Enable During CSleep Mode"]
...
#[doc = "Field `WWDG2LPEN` writer - WWDG2 peripheral Clocks Enable During CSleep Mode"]
