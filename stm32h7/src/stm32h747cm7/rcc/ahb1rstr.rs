...
#[doc = "Field `ARTRST` reader - ART block reset"]
pub use DMA1RST_R as ARTRST_R;
...
#[doc = "Field `ARTRST` writer - ART block reset"]
pub use DMA1RST_W as ARTRST_W;
...
impl R {
    ...
    #[doc = "Bit 14 - ART block reset"]
    #[inline(always)]
    pub fn artrst(&self) -> ARTRST_R {
        ARTRST_R::new(((self.bits >> 14) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn artrst(&mut self) -> ARTRST_W<14> {
        ARTRST_W::new(self)
    }
    #[doc = "Bit 15 - ETH1MAC block reset"]
    #[inline(always)]
