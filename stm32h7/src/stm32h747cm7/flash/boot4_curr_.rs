#[doc = "Register `BOOT4_CURR_` reader"]
...
#[doc = "Register `BOOT4_CURR_` writer"]
...
#[doc = "Field `BOOT_CM4_ADD0` reader - Arm Cortex-M4 boot address 0"]
pub type BOOT_CM4_ADD0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BOOT_CM4_ADD0` writer - Arm Cortex-M4 boot address 0"]
pub type BOOT_CM4_ADD0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BOOT4_CURR__SPEC, u16, u16, 16, O>;
#[doc = "Field `BOOT_CM4_ADD1` reader - Arm Cortex-M4 boot address 1"]
pub type BOOT_CM4_ADD1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BOOT_CM4_ADD1` writer - Arm Cortex-M4 boot address 1"]
...
#[doc = "`read()` method returns [boot4_curr_::R](R) reader structure"]
impl crate::Readable for BOOT4_CURR__SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [boot4_curr_::W](W) writer structure"]
impl crate::Writable for BOOT4_CURR__SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BOOT4_CURR_ to value 0"]
