#[doc = "Register `BOOT4_CURR` reader"]
...
#[doc = "Register `BOOT4_CURR` writer"]
...
#[doc = "`read()` method returns [boot4_curr::R](R) reader structure"]
impl crate::Readable for BOOT4_CURR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [boot4_curr::W](W) writer structure"]
impl crate::Writable for BOOT4_CURR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BOOT4_CURR to value 0"]
