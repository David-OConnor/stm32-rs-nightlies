...
pub struct R(crate::R<BOOT4_PRGR__SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BOOT4_PRGR__SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BOOT4_PRGR__SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BOOT4_PRGR__SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BOOT4_PRGR_` writer"]
pub struct W(crate::W<BOOT4_PRGR__SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BOOT4_PRGR__SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BOOT4_PRGR__SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BOOT4_PRGR__SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BOOT_CM4_ADD0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, BOOT4_PRGR__SPEC, u16, u16, 16, O>;
