...
#[doc = "Field `UESM` reader - USART enable in low-power mode"]
pub type UESM_R = crate::BitReader<UESM_A>;
#[doc = "USART enable in low-power mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UESM_A {
...
#[doc = "Field `UESM` writer - USART enable in low-power mode"]
...
#[doc = "Field `RXNEIE` reader - Receive data register not empty/RXFIFO not empty interrupt enable"]
pub type RXNEIE_R = crate::BitReader<RXNEIE_A>;
#[doc = "Receive data register not empty/RXFIFO not empty interrupt enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum RXNEIE_A {
    #[doc = "0: Interrupt is disabled"]
    Disabled = 0,
...
#[doc = "Field `RXNEIE` writer - Receive data register not empty/RXFIFO not empty interrupt enable"]
...
#[doc = "Field `TXEIE` reader - Transmit data register empty/TXFIFO not full interrupt enable"]
pub type TXEIE_R = crate::BitReader<TXEIE_A>;
#[doc = "Transmit data register empty/TXFIFO not full interrupt enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TXEIE_A {
    #[doc = "0: Interrupt is disabled"]
    Disabled = 0,
...
#[doc = "Field `TXEIE` writer - Transmit data register empty/TXFIFO not full interrupt enable"]
...
pub enum TXFEIE_A {
    ...
    Disabled = 0,
    #[doc = "1: USART interrupt generated when TXFE = 1 in the USART_ISR register"]
    Enabled = 1,
}
...
impl<'a, const O: u8> TXFEIE_W<'a, O> {
    ...
    #[doc = "USART interrupt generated when TXFE = 1 in the USART_ISR register"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
pub enum RXFFIE_A {
    #[doc = "0: Interrupt inhibited"]
    Disabled = 0,
    #[doc = "1: USART interrupt generated when RXFF = 1 in the USART_ISR register"]
    Enabled = 1,
}
...
impl<'a, const O: u8> RXFFIE_W<'a, O> {
    ...
    #[doc = "USART interrupt generated when RXFF = 1 in the USART_ISR register"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
