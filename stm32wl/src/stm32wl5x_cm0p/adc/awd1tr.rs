...
pub type LT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AWD1TR_SPEC, u16, u16, 12, O>;
#[doc = "Field `HT1` reader - HT1"]
pub type HT1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `HT1` writer - HT1"]
pub type HT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AWD1TR_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bits 0:11 - LT1"]
    #[inline(always)]
