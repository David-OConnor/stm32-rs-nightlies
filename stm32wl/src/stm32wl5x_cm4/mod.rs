#![doc = "Peripheral access API for STM32WL5X_CM4 microcontrollers (generated using svd2rust v0.28.0 (27eebb4 2022-12-25))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
#[repr(u16)]
pub enum Interrupt {
    #[doc = "0 - Window watchdog early wakeup interrupt"]
    WWDG = 0,
    #[doc = "1 - PVD through EXTI\\[16\\], PVM\\[3\\]
through EXTI\\[34\\]"]
    PVD_PVM_3 = 1,
    #[doc = "2 - Tamper, TimeStamp, LSECSS,RTC_SSRU interrupt"]
    TAMP_RTCSTAMP_LSECSS_RTCSSRU = 2,
    #[doc = "3 - RTC wakeup interrupt"]
    RTC_WKUP = 3,
    #[doc = "4 - Flash memory global interrupt and Flash memory ECC single error interrupt"]
    FLASH = 4,
    ...
    EXTI4 = 10,
    #[doc = "11 - DMA1 channel 1 non-secure interrupt"]
    DMA1_CH1 = 11,
    #[doc = "12 - DMA1 channel 2 non-secure interrupt"]
    DMA1_CH2 = 12,
    #[doc = "13 - DMA1 channel 3 non-secure interrupt"]
    DMA1_CH3 = 13,
    #[doc = "14 - DMA1 channel 4 non-secure interrupt"]
    DMA1_CH4 = 14,
    #[doc = "15 - DMA1 channel 5 non-secure interrupt"]
    DMA1_CH5 = 15,
    #[doc = "16 - DMA1 channel 6 non-secure interrupt"]
    DMA1_CH6 = 16,
    #[doc = "17 - DMA1 channel 7 non-secure interrupt"]
    DMA1_CH7 = 17,
    #[doc = "18 - ADC global interrupt"]
    ADC = 18,
    #[doc = "19 - DAC global interrupt"]
    DAC = 19,
    #[doc = "20 - PWR CPU2 HOLD wakeup interrupt ,CPU2 SEV through EXTI"]
    PWR_C2H_C2SEV = 20,
    #[doc = "21 - COMP2 and COMP1 interrupt through EXTI\\[22:21\\]"]
    COMP = 21,
    ...
    TIM1_CC = 26,
    #[doc = "27 - Timer 2 global interrupt"]
    TIM2 = 27,
    ...
    I2C1_ER = 31,
    #[doc = "32 - I2C2 event interrupt"]
    I2C2_EV = 32,
    #[doc = "33 - I2C2 error interrupt"]
    I2C2_ER = 33,
    #[doc = "34 - SPI 1 global interrupt"]
    SPI1 = 34,
    #[doc = "35 - SPI2S2 global interrupt"]
    SPI2S2 = 35,
...
interrupt through EXTI"]
    EXTI15_10 = 41,
    #[doc = "42 - RTC alarms A and B interrupt"]
    RTC_ALARM = 42,
    #[doc = "43 - LPtimer 3 global interrupt"]
    LPTIM3 = 43,
    #[doc = "44 - Sub-GHz radio SPI global interrupt"]
    SUBGHZSPI = 44,
    #[doc = "45 - IPCC CPU1 RX occupied interrupt"]
    IPCC_C1_RX_IT = 45,
    #[doc = "46 - IPCC CPU1 TX free interrupt"]
    IPCC_C1_TX_IT = 46,
    ...
    PKA = 53,
    #[doc = "54 - DMA2 channel 1 non-secure interrupt"]
    DMA2_CH1 = 54,
    #[doc = "55 - DMA2 channel 2 non-secure interrupt"]
    DMA2_CH2 = 55,
    #[doc = "56 - DMA2 channel 3 non-secure interrupt"]
    DMA2_CH3 = 56,
    #[doc = "57 - DMA2 channel 4 non-secure interrupt"]
    DMA2_CH4 = 57,
    #[doc = "58 - DMA2 channel 5 non-secure interrupt"]
    DMA2_CH5 = 58,
    #[doc = "59 - DMA2 channel 6 non-secure interrupt"]
    DMA2_CH6 = 59,
    #[doc = "60 - DMA2 channel 7 non-secure interrupt"]
    DMA2_CH7 = 60,
    #[doc = "61 - DMAMUX1 overrun interrupt"]
    DMAMUX1_OVR = 61,
}
