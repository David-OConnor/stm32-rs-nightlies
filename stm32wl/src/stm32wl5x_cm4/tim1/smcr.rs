...
#[doc = "Field `TS3_4` reader - Trigger selection"]
pub type TS3_4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TS3_4` writer - Trigger selection"]
pub type TS3_4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SMCR_SPEC, u8, u8, 2, O>;
impl R {
    ...
    pub fn ts3_4(&self) -> TS3_4_R {
        TS3_4_R::new(((self.bits >> 20) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Slave mode selection"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ts3_4(&mut self) -> TS3_4_W<20> {
        TS3_4_W::new(self)
    }
