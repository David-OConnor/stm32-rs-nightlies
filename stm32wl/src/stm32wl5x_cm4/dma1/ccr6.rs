...
pub type MINC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR6_SPEC, MINC_A, O>;
...
pub type MSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR6_SPEC, u8, MSIZE_A, 2, O>;
...
pub type PRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR6_SPEC, PRIV_A, O>;
