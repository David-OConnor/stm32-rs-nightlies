...
#[doc = "Field `IVI` reader - Initialization Vector Register (IVR \\[63:32\\])"]
pub type IVI_R = crate::FieldReader<u32, u32>;
#[doc = "Field `IVI` writer - Initialization Vector Register (IVR \\[63:32\\])"]
pub type IVI_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, IVR1_SPEC, u32, u32, 32, O>;
impl R {
