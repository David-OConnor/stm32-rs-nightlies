...
pub type EM0_W<'a, const O: u8> = crate::BitWriter<'a, u32, C1EMR1_SPEC, EM0_A, O>;
...
#[doc = "`read()` method returns [c1emr1::R](R) reader structure"]
impl crate::Readable for C1EMR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c1emr1::W](W) writer structure"]
impl crate::Writable for C1EMR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C1EMR1 to value 0"]
