...
#[doc = "Field `TSAMPLE1` reader - DAC Channel 1 sample Time (only valid in Sample and Hold mode)"]
pub type TSAMPLE1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TSAMPLE1` writer - DAC Channel 1 sample Time (only valid in Sample and Hold mode)"]
