...
#[doc = "Field `SUBGHZSPIRST` reader - Sub-GHz radio SPI reset"]
pub type SUBGHZSPIRST_R = crate::BitReader<bool>;
#[doc = "Field `SUBGHZSPIRST` writer - Sub-GHz radio SPI reset"]
pub type SUBGHZSPIRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB3RSTR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn subghzspirst(&mut self) -> SUBGHZSPIRST_W<0> {
        SUBGHZSPIRST_W::new(self)
    }
