...
pub type SSRUIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, SSRUIE_A, O>;
impl<'a, const O: u8> SSRUIE_W<'a, O> {
...
impl From<ADD1HW_AW> for bool {
    #[inline(always)]
    fn from(variant: ADD1HW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `ADD1H` writer - Add 1 hour (summer time change)"]
pub type ADD1H_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, ADD1HW_AW, O>;
...
impl From<SUB1HW_AW> for bool {
    #[inline(always)]
    fn from(variant: SUB1HW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SUB1H` writer - Subtract 1 hour (winter time change)"]
pub type SUB1H_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, SUB1HW_AW, O>;
...
pub type TAMPTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, TAMPTS_A, O>;
...
pub type TAMPOE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, TAMPOE_A, O>;
impl<'a, const O: u8> TAMPOE_W<'a, O> {
...
pub type TAMPALRM_PU_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, TAMPALRM_PU_A, O>;
impl<'a, const O: u8> TAMPALRM_PU_W<'a, O> {
...
pub type TAMPALRM_TYPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, TAMPALRM_TYPE_A, O>;
impl<'a, const O: u8> TAMPALRM_TYPE_W<'a, O> {
...
pub type OUT2EN_R = crate::BitReader<OUT2EN_A>;
...
pub type OUT2EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, OUT2EN_A, O>;
impl<'a, const O: u8> OUT2EN_W<'a, O> {
