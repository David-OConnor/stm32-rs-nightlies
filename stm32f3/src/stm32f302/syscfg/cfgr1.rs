...
pub enum MEM_MODE_A {
    ...
    Sram = 3,
    #[doc = "4: FMC Bank (Only the first two banks) (Available on STM32F302xD/E only)"]
    Fmc = 4,
}
...
impl<'a, const O: u8> MEM_MODE_W<'a, O> {
    ...
    #[doc = "FMC Bank (Only the first two banks) (Available on STM32F302xD/E only)"]
    #[inline(always)]
...
pub enum ENCODER_MODE_A {
    ...
    MapTim3tim15 = 2,
    #[doc = "3: TIM4 IC1 and TIM4 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively (STM32F302xB/C devices only)"]
    MapTim4tim15 = 3,
}
...
impl<'a, const O: u8> ENCODER_MODE_W<'a, O> {
    ...
    #[doc = "TIM4 IC1 and TIM4 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively (STM32F302xB/C devices only)"]
    #[inline(always)]
...
pub enum I2C3_FMP_A {
    #[doc = "0: FM+ mode is controlled by I2C_Pxx_FMP bits only"]
    Standard = 0,
    #[doc = "1: FM+ mode is enabled on all I2C3 pins selected through selection trhough IOPORT control registers AF selection bits"]
    Fmp = 1,
}
