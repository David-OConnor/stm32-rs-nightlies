...
pub enum LOCKUP_LOCK_A {
    #[doc = "0: Cortex-M4 LOCKUP output disconnected from TIM1/15/16/17 Break input"]
    Disconnected = 0,
    #[doc = "1: Cortex-M4 LOCKUP output connected to TIM1/15/16/17 Break input"]
    Connected = 1,
}
...
impl<'a, const O: u8> LOCKUP_LOCK_W<'a, O> {
    #[doc = "Cortex-M4 LOCKUP output disconnected from TIM1/15/16/17 Break input"]
    #[inline(always)]
    pub fn disconnected(self) -> &'a mut W {
        self.variant(LOCKUP_LOCK_A::Disconnected)
    }
    #[doc = "Cortex-M4 LOCKUP output connected to TIM1/15/16/17 Break input"]
    #[inline(always)]
