...
#[doc = "Field `OC3M_3` reader - Output compare 3 mode bit3"]
pub type OC3M_3_R = crate::BitReader<OC3M_3_A>;
#[doc = "Output compare 3 mode bit3\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OC3M_3_A {
...
#[doc = "Field `OC3M_3` writer - Output compare 3 mode bit3"]
...
#[doc = "Field `OC4M_3` reader - Output compare 4 mode bit3"]
pub use OC3M_3_R as OC4M_3_R;
#[doc = "Field `OC4M_3` writer - Output compare 4 mode bit3"]
