...
#[doc = "Field `COMP2_INP_DAC` reader - Comparator 2 non inverting input connection to DAC output"]
pub type COMP2_INP_DAC_R = crate::BitReader<bool>;
#[doc = "Field `COMP2_INP_DAC` writer - Comparator 2 non inverting input connection to DAC output"]
pub type COMP2_INP_DAC_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_CSR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 1 - Comparator 2 non inverting input connection to DAC output"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comp2_inp_dac(&mut self) -> COMP2_INP_DAC_W<1> {
        COMP2_INP_DAC_W::new(self)
    }
    #[doc = "Bits 2:3 - Comparator 2 mode"]
    #[inline(always)]
    #[must_use]
