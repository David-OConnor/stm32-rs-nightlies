...
pub type OPAMP4EN_R = crate::BitReader<bool>;
#[doc = "Field `OPAMP4EN` writer - OPAMP4 enable"]
pub type OPAMP4EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
#[doc = "Field `FORCE_VP` reader - FORCE_VP"]
pub type FORCE_VP_R = crate::BitReader<bool>;
#[doc = "Field `FORCE_VP` writer - FORCE_VP"]
pub type FORCE_VP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
...
pub type VP_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP4_CSR_SPEC, u8, u8, 2, O>;
...
pub type VM_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP4_CSR_SPEC, u8, u8, 2, O>;
...
pub type TCM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
...
pub type VMS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
...
pub type VPS_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP4_CSR_SPEC, u8, u8, 2, O>;
...
pub type CALON_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
...
pub type CALSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP4_CSR_SPEC, u8, u8, 2, O>;
...
pub type PGA_GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPAMP4_CSR_SPEC, u8, u8, 4, O>;
...
pub type USER_TRIM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
...
pub type TRIMOFFSETP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPAMP4_CSR_SPEC, u8, u8, 5, O>;
...
pub type TSTREF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP4_CSR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn opamp4en(&mut self) -> OPAMP4EN_W<0> {
        OPAMP4EN_W::new(self)
    }
    #[doc = "Bit 1 - FORCE_VP"]
    #[inline(always)]
