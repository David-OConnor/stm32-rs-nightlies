...
pub type C5IF_R = crate::BitReader<bool>;
#[doc = "Field `C5IF` writer - Capture/Compare 5 interrupt flag"]
pub type C5IF_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR_SPEC, bool, O>;
#[doc = "Field `C6IF` reader - Capture/Compare 6 interrupt flag"]
pub type C6IF_R = crate::BitReader<bool>;
#[doc = "Field `C6IF` writer - Capture/Compare 6 interrupt flag"]
pub type C6IF_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn c5if(&mut self) -> C5IF_W<16> {
        C5IF_W::new(self)
    }
    #[doc = "Bit 17 - Capture/Compare 6 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn c6if(&mut self) -> C6IF_W<17> {
        C6IF_W::new(self)
    }
