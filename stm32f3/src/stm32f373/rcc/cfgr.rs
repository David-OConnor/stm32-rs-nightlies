...
pub type SDPRE_R = crate::FieldReader<u8, SDPRE_A>;
#[doc = "SDADC prescaler\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum SDPRE_A {
...
pub type SDPRE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR_SPEC, u8, SDPRE_A, 5, O>;
impl<'a, const O: u8> SDPRE_W<'a, O> {
    #[doc = "SYSCLK divided by 2"]
    #[inline(always)]
    pub fn div2(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdpre(&mut self) -> SDPRE_W<27> {
        SDPRE_W::new(self)
    }
