...
impl OSPEEDR0_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<OSPEEDR0_A> {
        match self.bits {
            0 => Some(OSPEEDR0_A::LowSpeed),
            1 => Some(OSPEEDR0_A::MediumSpeed),
            3 => Some(OSPEEDR0_A::HighSpeed),
            _ => None,
        }
    }
...
pub type OSPEEDR0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OSPEEDR_SPEC, u8, OSPEEDR0_A, 2, O>;
...
#[doc = "`reset()` method sets OSPEEDR to value 0xc000_0000"]
