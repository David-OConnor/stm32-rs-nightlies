...
pub type UPDT_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTAR_SPEC, UPDT_A, O>;
...
pub type CMP2_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTAR_SPEC, CMP2_A, O>;
...
pub type MSTPER_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTAR_SPEC, MSTPER_A, O>;
...
pub type MSTCMP1_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTAR_SPEC, MSTCMP1_A, O>;
...
pub type EXTEVNT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTAR_SPEC, EXTEVNT1_A, O>;
...
pub type TIMBCMP1_R = crate::BitReader<TIMBCMP1_A>;
...
impl From<TIMBCMP1_A> for bool {
    #[inline(always)]
    fn from(variant: TIMBCMP1_A) -> Self {
        variant as u8 != 0
    }
}
impl TIMBCMP1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TIMBCMP1_A {
        match self.bits {
            false => TIMBCMP1_A::NoEffect,
            true => TIMBCMP1_A::ResetCounter,
        }
    }
    #[doc = "Checks if the value of the field is `NoEffect`"]
    #[inline(always)]
    pub fn is_no_effect(&self) -> bool {
        *self == TIMBCMP1_A::NoEffect
    }
    #[doc = "Checks if the value of the field is `ResetCounter`"]
    #[inline(always)]
    pub fn is_reset_counter(&self) -> bool {
        *self == TIMBCMP1_A::ResetCounter
    }
}
#[doc = "Field `TIMBCMP1` writer - Timer B Compare 1"]
pub type TIMBCMP1_W<'a, const O: u8> = crate::BitWriter<'a, u32, RSTAR_SPEC, TIMBCMP1_A, O>;
impl<'a, const O: u8> TIMBCMP1_W<'a, O> {
