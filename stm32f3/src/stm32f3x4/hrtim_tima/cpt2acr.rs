...
pub type SWCPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT2ACR_SPEC, SWCPT_A, O>;
...
pub type UPDCPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT2ACR_SPEC, UPDCPT_A, O>;
...
pub type EXEV1CPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT2ACR_SPEC, EXEV1CPT_A, O>;
...
pub type TB1SET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT2ACR_SPEC, TB1SET_A, O>;
...
pub type TB1RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT2ACR_SPEC, TB1RST_A, O>;
...
pub type TBCMP1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT2ACR_SPEC, TBCMP1_A, O>;
