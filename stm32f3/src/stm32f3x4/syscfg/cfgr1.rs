...
pub type DAC_TRIG_RMP_R = crate::BitReader<DAC_TRIG_RMP_A>;
...
pub type DAC_TRIG_RMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR1_SPEC, DAC_TRIG_RMP_A, O>;
impl<'a, const O: u8> DAC_TRIG_RMP_W<'a, O> {
    #[doc = "Not remapped"]
    #[inline(always)]
    pub fn not_remapped(self) -> &'a mut W {
...
impl ENCODER_MODE_R {
    ...
    pub fn variant(&self) -> Option<ENCODER_MODE_A> {
        match self.bits {
            ...
            2 => Some(ENCODER_MODE_A::MapTim3tim15),
            _ => None,
        }
    }
