...
#[doc = "Field `HRTIM1EN` reader - High Resolution Timer 1 clock enable"]
...
#[doc = "Field `HRTIM1EN` writer - High Resolution Timer 1 clock enable"]
...
impl R {
    ...
    #[doc = "Bit 29 - High Resolution Timer 1 clock enable"]
    #[inline(always)]
    pub fn hrtim1en(&self) -> HRTIM1EN_R {
        HRTIM1EN_R::new(((self.bits >> 29) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - SYSCFG clock enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn hrtim1en(&mut self) -> HRTIM1EN_W<29> {
        HRTIM1EN_W::new(self)
    }
