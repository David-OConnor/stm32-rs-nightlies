...
pub type CKPSCX_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, TIMECR_SPEC, u8, u8, 3, O>;
...
pub type CONT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, CONT_A, O>;
...
pub type RETRIG_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, RETRIG_A, O>;
...
pub type HALF_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, HALF_A, O>;
...
pub type PSHPLL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, PSHPLL_A, O>;
...
pub type SYNCRSTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, SYNCRSTX_A, O>;
...
pub type SYNCSTRTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, SYNCSTRTX_A, O>;
...
pub type DELCMP2_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TIMECR_SPEC, u8, DELCMP2_A, 2, O>;
...
pub type DELCMP4_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TIMECR_SPEC, u8, DELCMP4_A, 2, O>;
...
pub type TX_REPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, TX_REPU_A, O>;
...
pub type TX_RSTU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, TX_RSTU_A, O>;
...
pub type TBU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, TBU_A, O>;
...
pub type MSTU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, MSTU_A, O>;
...
pub type DACSYNC_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TIMECR_SPEC, u8, DACSYNC_A, 2, O>;
...
pub type PREEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMECR_SPEC, PREEN_A, O>;
...
pub type UPDGAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMECR_SPEC, u8, UPDGAT_A, 4, O>;
