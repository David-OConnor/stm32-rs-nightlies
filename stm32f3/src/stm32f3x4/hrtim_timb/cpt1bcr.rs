...
pub type SWCPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT1BCR_SPEC, SWCPT_A, O>;
...
pub type UPDCPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT1BCR_SPEC, UPDCPT_A, O>;
...
pub type EXEV1CPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT1BCR_SPEC, EXEV1CPT_A, O>;
...
pub type TA1SET_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT1BCR_SPEC, TA1SET_A, O>;
...
pub type TA1RST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT1BCR_SPEC, TA1RST_A, O>;
...
pub type TACMP1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPT1BCR_SPEC, TACMP1_A, O>;
