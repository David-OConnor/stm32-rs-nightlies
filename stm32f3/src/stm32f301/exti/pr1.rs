...
pub type PR0_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, PR1_SPEC, PR0W_AW, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pr29(&mut self) -> PR29_W<29> {
        PR29_W::new(self)
    }
    #[doc = "Bit 30 - Pending bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn pr30(&mut self) -> PR30_W<30> {
        PR30_W::new(self)
    }
    #[doc = "Bit 31 - Pending bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn pr31(&mut self) -> PR31_W<31> {
        PR31_W::new(self)
    }
...
impl crate::Writable for PR1_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0xe07f_ffff;
}
