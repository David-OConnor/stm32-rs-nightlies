...
#[doc = "Field `CALFACT_S` reader - Calibration Factors In Single-Ended mode"]
pub type CALFACT_S_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CALFACT_S` writer - Calibration Factors In Single-Ended mode"]
pub type CALFACT_S_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CALFACT_SPEC, u8, u8, 7, O>;
#[doc = "Field `CALFACT_D` reader - Calibration Factors in differential mode"]
pub type CALFACT_D_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CALFACT_D` writer - Calibration Factors in differential mode"]
pub type CALFACT_D_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CALFACT_SPEC, u8, u8, 7, O>;
impl R {
