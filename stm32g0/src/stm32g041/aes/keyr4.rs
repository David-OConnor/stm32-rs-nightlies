...
pub type AES_KEYR4_R = crate::FieldReader<u32, u32>;
#[doc = "Field `AES_KEYR4` writer - AES key register (MSB key \\[159:128\\])"]
pub type AES_KEYR4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, KEYR4_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aes_keyr4(&mut self) -> AES_KEYR4_W<0> {
        AES_KEYR4_W::new(self)
    }
