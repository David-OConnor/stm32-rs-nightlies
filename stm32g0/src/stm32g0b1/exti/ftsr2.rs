...
#[doc = "Field `FT2` reader - Falling trigger event configuration bit of configurable line 34"]
pub type FT2_R = crate::BitReader<FT2_A>;
#[doc = "Falling trigger event configuration bit of configurable line 34\n\nValue on reset: 0"]
...
#[doc = "Field `FT2` writer - Falling trigger event configuration bit of configurable line 34"]
...
impl R {
    #[doc = "Bit 2 - Falling trigger event configuration bit of configurable line 34"]
    #[inline(always)]
