...
#[doc = "Field `SPE` reader - SPI enable Note: When disabling the SPI, follow the procedure described in SPI on pageÂ 1021. This bit is not used in I2S mode."]
pub type SPE_R = crate::BitReader<SPE_A>;
#[doc = "SPI enable Note: When disabling the SPI, follow the procedure described in SPI on pageÂ 1021. This bit is not used in I2S mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SPE_A {
...
#[doc = "Field `SPE` writer - SPI enable Note: When disabling the SPI, follow the procedure described in SPI on pageÂ 1021. This bit is not used in I2S mode."]
...
#[doc = "Internal slave select This bit has an effect only when the SSM bit is set. The value of this bit is forced onto the NSS pin and the I/O value of the NSS pin is ignored. Note: This bit is not used in I2S mode and SPI TI mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SSI_A {
...
#[doc = "Field `CRCL` reader - CRC length This bit is set and cleared by software to select the CRC length. Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode."]
pub type CRCL_R = crate::BitReader<CRCL_A>;
#[doc = "CRC length This bit is set and cleared by software to select the CRC length. Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CRCL_A {
...
#[doc = "Field `CRCL` writer - CRC length This bit is set and cleared by software to select the CRC length. Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode."]
pub type CRCL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, CRCL_A, O>;
...
#[doc = "Transmit CRC next Note: This bit has to be written as soon as the last data is written in the SPI_DR register. This bit is not used in I2S mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CRCNEXT_A {
...
#[doc = "Field `CRCEN` reader - Hardware CRC calculation enable Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode."]
pub type CRCEN_R = crate::BitReader<CRCEN_A>;
#[doc = "Hardware CRC calculation enable Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CRCEN_A {
...
#[doc = "Field `CRCEN` writer - Hardware CRC calculation enable Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode."]
...
impl R {
    ...
    #[doc = "Bit 6 - SPI enable Note: When disabling the SPI, follow the procedure described in SPI on pageÂ 1021. This bit is not used in I2S mode."]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - CRC length This bit is set and cleared by software to select the CRC length. Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode."]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - Hardware CRC calculation enable Note: This bit should be written only when SPI is disabled (SPE = '0â\u{80}\u{99}) for correct operation. This bit is not used in I2S mode."]
    #[inline(always)]
