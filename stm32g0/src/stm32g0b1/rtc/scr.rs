...
#[doc = "Field `CALRAF` writer - Clear alarm A flag Writing 1 in this bit clears the ALRBF bit in the RTC_SR register."]
...
impl W {
    #[doc = "Bit 0 - Clear alarm A flag Writing 1 in this bit clears the ALRBF bit in the RTC_SR register."]
    #[inline(always)]
    #[must_use]
