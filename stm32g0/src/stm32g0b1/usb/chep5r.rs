...
#[doc = "`read()` method returns [chep5r::R](R) reader structure"]
impl crate::Readable for CHEP5R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [chep5r::W](W) writer structure"]
impl crate::Writable for CHEP5R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHEP5R to value 0"]
