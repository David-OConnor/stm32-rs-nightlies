...
pub type VRS_W<'a, const O: u8> = crate::BitWriter<'a, u32, VREFBUF_CSR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - Voltage reference scale These bits select the value generated by the voltage reference buffer. Other: Reserved"]
    #[inline(always)]
