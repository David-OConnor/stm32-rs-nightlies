...
#[doc = "Field `TS_4` reader - Trigger selection"]
pub type TS_4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TS_4` writer - Trigger selection"]
pub type TS_4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SMCR_SPEC, u8, u8, 3, O>;
...
pub type TS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SMCR_SPEC, u8, u8, 2, O>;
impl R {
    ...
    pub fn ts_4(&self) -> TS_4_R {
        TS_4_R::new(((self.bits >> 4) & 7) as u8)
    }
