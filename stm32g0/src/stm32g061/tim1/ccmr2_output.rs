...
#[doc = "Field `CC3S` reader - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0â\u{80}\u{99} in TIMx_CCER)."]
pub type CC3S_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CC3S` writer - Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0â\u{80}\u{99} in TIMx_CCER)."]
...
#[doc = "Field `OC3M` reader - Output compare 3 mode Refer to OC1M\\[3:0\\]
description."]
pub type OC3M_R = crate::FieldReader<u8, OC3M_A>;
#[doc = "Output compare 3 mode Refer to OC1M\\[3:0\\]
description.\n\nValue on reset: 0"]
...
#[doc = "Field `OC3M` writer - Output compare 3 mode Refer to OC1M\\[3:0\\]
description."]
...
#[doc = "Field `CC4S` reader - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0â\u{80}\u{99} in TIMx_CCER)."]
pub type CC4S_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CC4S` writer - Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0â\u{80}\u{99} in TIMx_CCER)."]
...
#[doc = "Field `OC4M` reader - Output compare 4 mode Refer to OC3M\\[3:0\\]
description."]
pub use OC3M_R as OC4M_R;
#[doc = "Field `OC4M` writer - Output compare 4 mode Refer to OC3M\\[3:0\\]
description."]
...
#[doc = "Field `OC3M_3` reader - Output compare 3 mode Refer to OC1M\\[3:0\\]
description."]
...
#[doc = "Field `OC3M_3` writer - Output compare 3 mode Refer to OC1M\\[3:0\\]
description."]
...
#[doc = "Field `OC4M_3` reader - Output compare 4 mode Refer to OC3M\\[3:0\\]
description."]
pub use OC3M_3_R as OC4M_3_R;
#[doc = "Field `OC4M_3` writer - Output compare 4 mode Refer to OC3M\\[3:0\\]
description."]
