...
#[doc = "Field `SUSP` reader - AES suspend Upon suspend operation, this bitfield of every AES_SUSPxR register takes the value of one of internal AES registers."]
pub type SUSP_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SUSP` writer - AES suspend Upon suspend operation, this bitfield of every AES_SUSPxR register takes the value of one of internal AES registers."]
pub type SUSP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SUSP7R_SPEC, u32, u32, 32, O>;
impl R {
