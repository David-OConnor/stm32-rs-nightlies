...
pub type EM0_W<'a, const O: u8> = crate::BitWriter<'a, u32, EMR1_SPEC, EM0_A, O>;
...
#[doc = "Field `EM27` reader - CPU wakeup with event mask on event input"]
pub use EM0_R as EM27_R;
...
#[doc = "Field `EM27` writer - CPU wakeup with event mask on event input"]
pub use EM0_W as EM27_W;
...
impl R {
    ...
    #[doc = "Bit 27 - CPU wakeup with event mask on event input"]
    #[inline(always)]
