...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum ASTRTEN_A {
    #[doc = "0: Asynchronous start disabled"]
    AsyncStartDisabled = 0,
    #[doc = "1: Asynchronous start enabled"]
    AsyncStartEnabled = 1,
}
...
impl ASTRTEN_R {
    ...
    #[doc = "Checks if the value of the field is `AsyncStartDisabled`"]
    #[inline(always)]
    pub fn is_async_start_disabled(&self) -> bool {
        *self == ASTRTEN_A::AsyncStartDisabled
    }
    #[doc = "Checks if the value of the field is `AsyncStartEnabled`"]
    #[inline(always)]
