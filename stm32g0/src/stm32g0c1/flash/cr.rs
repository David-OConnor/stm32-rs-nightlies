...
pub type PNB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 6, O>;
...
pub type SEC_PROT_R = crate::BitReader<bool>;
#[doc = "Field `SEC_PROT` writer - Securable memory area protection enable"]
pub type SEC_PROT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sec_prot(&mut self) -> SEC_PROT_W<28> {
        SEC_PROT_W::new(self)
    }
    #[doc = "Bit 30 - Options Lock"]
    #[inline(always)]
