...
pub type DACC1DHR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DHR12LD_SPEC, u16, u16, 12, O>;
...
pub type DACC2DHR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DHR12LD_SPEC, u16, u16, 12, O>;
impl R {
