...
#[doc = "Field `MER` reader - This bit triggers the mass erase (all user pages) when set"]
pub type MER_R = crate::BitReader<bool>;
#[doc = "Field `MER` writer - This bit triggers the mass erase (all user pages) when set"]
