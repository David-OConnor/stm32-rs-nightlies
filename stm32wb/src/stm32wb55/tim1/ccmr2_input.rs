...
#[doc = "Field `C3PSC` reader - Input capture 3 prescaler"]
pub type C3PSC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `C3PSC` writer - Input capture 3 prescaler"]
pub type C3PSC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCMR2_INPUT_SPEC, u8, u8, 2, O>;
...
impl R {
    ...
    pub fn c3psc(&self) -> C3PSC_R {
        C3PSC_R::new(((self.bits >> 2) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn c3psc(&mut self) -> C3PSC_W<2> {
        C3PSC_W::new(self)
    }
    #[doc = "Bits 4:7 - Input capture 3 filter"]
    #[inline(always)]
