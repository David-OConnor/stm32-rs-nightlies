...
#[doc = "Field `C1F` reader - Input capture 1 filter"]
pub type C1F_R = crate::FieldReader<u8, u8>;
#[doc = "Field `C1F` writer - Input capture 1 filter"]
pub type C1F_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCMR1_INPUT_SPEC, u8, u8, 4, O>;
