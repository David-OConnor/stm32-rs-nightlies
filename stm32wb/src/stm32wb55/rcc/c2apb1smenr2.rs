...
pub type LPUART1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB1SMENR2_SPEC, bool, O>;
...
pub type LPTIM2SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C2APB1SMENR2_SPEC, bool, O>;
impl R {
