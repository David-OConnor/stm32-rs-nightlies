...
#[doc = "Field `TIM1SMEN` reader - TIM1 timer clocks enable during CPU1 Sleep mode"]
pub type TIM1SMEN_R = crate::BitReader<bool>;
#[doc = "Field `TIM1SMEN` writer - TIM1 timer clocks enable during CPU1 Sleep mode"]
pub type TIM1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2SMENR_SPEC, bool, O>;
#[doc = "Field `SPI1SMEN` reader - SPI1 clocks enable during CPU1 Sleep mode"]
pub type SPI1SMEN_R = crate::BitReader<bool>;
#[doc = "Field `SPI1SMEN` writer - SPI1 clocks enable during CPU1 Sleep mode"]
pub type SPI1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2SMENR_SPEC, bool, O>;
#[doc = "Field `USART1SMEN` reader - USART1clocks enable during CPU1 Sleep mode"]
pub type USART1SMEN_R = crate::BitReader<bool>;
#[doc = "Field `USART1SMEN` writer - USART1clocks enable during CPU1 Sleep mode"]
pub type USART1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2SMENR_SPEC, bool, O>;
#[doc = "Field `TIM16SMEN` reader - TIM16 timer clocks enable during CPU1 Sleep mode"]
pub type TIM16SMEN_R = crate::BitReader<bool>;
#[doc = "Field `TIM16SMEN` writer - TIM16 timer clocks enable during CPU1 Sleep mode"]
pub type TIM16SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2SMENR_SPEC, bool, O>;
#[doc = "Field `TIM17SMEN` reader - TIM17 timer clocks enable during CPU1 Sleep mode"]
pub type TIM17SMEN_R = crate::BitReader<bool>;
#[doc = "Field `TIM17SMEN` writer - TIM17 timer clocks enable during CPU1 Sleep mode"]
pub type TIM17SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2SMENR_SPEC, bool, O>;
#[doc = "Field `SAI1SMEN` reader - SAI1 clocks enable during CPU1 Sleep mode"]
pub type SAI1SMEN_R = crate::BitReader<bool>;
#[doc = "Field `SAI1SMEN` writer - SAI1 clocks enable during CPU1 Sleep mode"]
...
#[doc = "`reset()` method sets APB2SMENR to value 0x0026_5800"]
