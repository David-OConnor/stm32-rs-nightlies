...
pub struct R(crate::R<COUNT3_RX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COUNT3_RX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COUNT3_RX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COUNT3_RX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `COUNT3_RX` writer"]
pub struct W(crate::W<COUNT3_RX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<COUNT3_RX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<COUNT3_RX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<COUNT3_RX_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `COUNT3_RX` reader - Reception byte count"]
pub type COUNT3_RX_R = crate::FieldReader<u16, u16>;
...
pub type NUM_BLOCK_W<'a, const O: u8> = crate::FieldWriter<'a, u16, COUNT3_RX_SPEC, u8, u8, 5, O>;
#[doc = "Field `BL_SIZE` reader - Block size"]
pub type BL_SIZE_R = crate::BitReader<bool>;
#[doc = "Field `BL_SIZE` writer - Block size"]
pub type BL_SIZE_W<'a, const O: u8> = crate::BitWriter<'a, u16, COUNT3_RX_SPEC, bool, O>;
impl R {
...
#[doc = "Reception byte count 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [count3_rx](index.html) module"]
pub struct COUNT3_RX_SPEC;
impl crate::RegisterSpec for COUNT3_RX_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [count3_rx::R](R) reader structure"]
impl crate::Readable for COUNT3_RX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [count3_rx::W](W) writer structure"]
impl crate::Writable for COUNT3_RX_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets COUNT3_RX to value 0"]
impl crate::Resettable for COUNT3_RX_SPEC {
