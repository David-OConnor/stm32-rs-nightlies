...
pub type ADDR7_RX_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ADDR7_RX` writer - Reception buffer address"]
pub type ADDR7_RX_W<'a, const O: u8> = crate::FieldWriter<'a, u16, ADDR7_RX_SPEC, u16, u16, 15, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr7_rx(&mut self) -> ADDR7_RX_W<1> {
        ADDR7_RX_W::new(self)
    }
