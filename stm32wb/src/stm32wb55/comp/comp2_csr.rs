...
#[doc = "Field `COMP2_INMSEL` reader - Comparator 2 input minus selection bits"]
pub type COMP2_INMSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP2_INMSEL` writer - Comparator 2 input minus selection bits"]
pub type COMP2_INMSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, COMP2_CSR_SPEC, u8, u8, 2, O>;
#[doc = "Field `COMP2_INPSEL` reader - Comparator 1 input plus selection bit"]
pub type COMP2_INPSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COMP2_INPSEL` writer - Comparator 1 input plus selection bit"]
...
#[doc = "Field `COMP2_LOCK` reader - CSR register lock bit"]
pub type COMP2_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `COMP2_LOCK` writer - CSR register lock bit"]
