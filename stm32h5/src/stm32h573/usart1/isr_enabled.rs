...
pub struct R(crate::R<ISR_ENABLED_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ISR_ENABLED_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ISR_ENABLED_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ISR_ENABLED_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "USART interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [isr_enabled](index.html) module"]
pub struct ISR_ENABLED_SPEC;
impl crate::RegisterSpec for ISR_ENABLED_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [isr_enabled::R](R) reader structure"]
impl crate::Readable for ISR_ENABLED_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ISR_enabled to value 0xc0"]
impl crate::Resettable for ISR_ENABLED_SPEC {
