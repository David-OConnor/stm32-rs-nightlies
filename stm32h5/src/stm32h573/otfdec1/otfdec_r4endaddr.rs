#[doc = "Register `OTFDEC_R4ENDADDR` reader"]
pub struct R(crate::R<OTFDEC_R4ENDADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTFDEC_R4ENDADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTFDEC_R4ENDADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTFDEC_R4ENDADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTFDEC_R4ENDADDR` writer"]
pub struct W(crate::W<OTFDEC_R4ENDADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTFDEC_R4ENDADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTFDEC_R4ENDADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTFDEC_R4ENDADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type REGX_END_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTFDEC_R4ENDADDR_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "OTFDEC region 4 end address register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otfdec_r4endaddr](index.html) module"]
pub struct OTFDEC_R4ENDADDR_SPEC;
impl crate::RegisterSpec for OTFDEC_R4ENDADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otfdec_r4endaddr::R](R) reader structure"]
impl crate::Readable for OTFDEC_R4ENDADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otfdec_r4endaddr::W](W) writer structure"]
impl crate::Writable for OTFDEC_R4ENDADDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTFDEC_R4ENDADDR to value 0x0fff"]
impl crate::Resettable for OTFDEC_R4ENDADDR_SPEC {
