...
pub struct W(crate::W<TIM1_EGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM1_EGR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<TIM1_EGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM1_EGR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UG` writer - Update generation This bit can be set by software, it is automatically cleared by hardware."]
pub type UG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
...
pub type CC1G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
#[doc = "Field `CC2G` writer - Capture/compare 2 generation Refer to CC1G description"]
pub type CC2G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
#[doc = "Field `CC3G` writer - Capture/compare 3 generation Refer to CC1G description"]
pub type CC3G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
#[doc = "Field `CC4G` writer - Capture/compare 4 generation Refer to CC1G description"]
pub type CC4G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
...
pub type COMG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
...
pub type TG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
...
pub type BG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
...
pub type B2G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM1_EGR_SPEC, bool, O>;
impl W {
