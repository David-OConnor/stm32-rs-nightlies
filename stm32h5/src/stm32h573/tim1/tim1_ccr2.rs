...
pub struct R(crate::R<TIM1_CCR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM1_CCR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM1_CCR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM1_CCR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM1_CCR2` writer"]
pub struct W(crate::W<TIM1_CCR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM1_CCR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM1_CCR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM1_CCR2_SPEC>) -> Self {
        W(writer)
    }
}
...
bits are reset. Dithering mode (DITHEN = 1) The register holds the capture in CCR2\\[19:4\\]. The CCR2\\[3:0\\]
bits are reset."]
pub type CCR2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_CCR2_SPEC, u32, u32, 20, O>;
impl R {
...
#[doc = "TIM1 capture/compare register 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim1_ccr2](index.html) module"]
pub struct TIM1_CCR2_SPEC;
impl crate::RegisterSpec for TIM1_CCR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim1_ccr2::R](R) reader structure"]
impl crate::Readable for TIM1_CCR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim1_ccr2::W](W) writer structure"]
impl crate::Writable for TIM1_CCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM1_CCR2 to value 0"]
impl crate::Resettable for TIM1_CCR2_SPEC {
