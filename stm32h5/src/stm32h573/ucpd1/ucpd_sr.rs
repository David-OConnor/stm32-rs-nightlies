#[doc = "Register `UCPD_SR` reader"]
pub struct R(crate::R<UCPD_SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCPD_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCPD_SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCPD_SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UCPD status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ucpd_sr](index.html) module"]
pub struct UCPD_SR_SPEC;
impl crate::RegisterSpec for UCPD_SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ucpd_sr::R](R) reader structure"]
impl crate::Readable for UCPD_SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UCPD_SR to value 0"]
impl crate::Resettable for UCPD_SR_SPEC {
