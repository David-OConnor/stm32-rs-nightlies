#[doc = "Register `TIM4_CCMR1_Input` reader"]
pub struct R(crate::R<TIM4_CCMR1_INPUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM4_CCMR1_INPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM4_CCMR1_INPUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM4_CCMR1_INPUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM4_CCMR1_Input` writer"]
pub struct W(crate::W<TIM4_CCMR1_INPUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM4_CCMR1_INPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM4_CCMR1_INPUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM4_CCMR1_INPUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CC1S_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_CCMR1_INPUT_SPEC, u8, u8, 2, O>;
...
pub type IC1PSC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM4_CCMR1_INPUT_SPEC, u8, u8, 2, O>;
...
pub type IC1F_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_CCMR1_INPUT_SPEC, u8, u8, 4, O>;
...
pub type CC2S_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_CCMR1_INPUT_SPEC, u8, u8, 2, O>;
...
pub type IC2F_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_CCMR1_INPUT_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "TIM4 capture/compare mode register 1 \\[alternate\\]\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim4_ccmr1_input](index.html) module"]
pub struct TIM4_CCMR1_INPUT_SPEC;
impl crate::RegisterSpec for TIM4_CCMR1_INPUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim4_ccmr1_input::R](R) reader structure"]
impl crate::Readable for TIM4_CCMR1_INPUT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim4_ccmr1_input::W](W) writer structure"]
impl crate::Writable for TIM4_CCMR1_INPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM4_CCMR1_Input to value 0"]
impl crate::Resettable for TIM4_CCMR1_INPUT_SPEC {
