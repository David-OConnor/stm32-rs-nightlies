...
#[doc = "Field `OTFDEC1IE` reader - illegal access interrupt enable for OTFDEC1"]
pub type OTFDEC1IE_R = crate::BitReader<bool>;
#[doc = "Field `OTFDEC1IE` writer - illegal access interrupt enable for OTFDEC1"]
pub type OTFDEC1IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTZC1_TZIC_IER4_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 4 - illegal access interrupt enable for OTFDEC1"]
    #[inline(always)]
    pub fn otfdec1ie(&self) -> OTFDEC1IE_R {
        OTFDEC1IE_R::new(((self.bits >> 4) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otfdec1ie(&mut self) -> OTFDEC1IE_W<4> {
