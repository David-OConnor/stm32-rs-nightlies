#[doc = "Register `SAES_DINR` writer"]
pub struct W(crate::W<SAES_DINR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SAES_DINR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<SAES_DINR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SAES_DINR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SAES_DINR_SPEC, u32, u32, 32, O>;
impl W {
...
#[doc = "SAES data input register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [saes_dinr](index.html) module"]
pub struct SAES_DINR_SPEC;
impl crate::RegisterSpec for SAES_DINR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [saes_dinr::W](W) writer structure"]
impl crate::Writable for SAES_DINR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SAES_DINR to value 0"]
impl crate::Resettable for SAES_DINR_SPEC {
