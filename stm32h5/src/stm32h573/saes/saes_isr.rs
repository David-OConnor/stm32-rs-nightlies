#[doc = "Register `SAES_ISR` reader"]
pub struct R(crate::R<SAES_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SAES_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SAES_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SAES_ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "SAES interrupt status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [saes_isr](index.html) module"]
pub struct SAES_ISR_SPEC;
impl crate::RegisterSpec for SAES_ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [saes_isr::R](R) reader structure"]
impl crate::Readable for SAES_ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets SAES_ISR to value 0"]
impl crate::Resettable for SAES_ISR_SPEC {
