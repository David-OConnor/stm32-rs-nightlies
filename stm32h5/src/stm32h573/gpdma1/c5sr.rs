#[doc = "Register `C5SR` reader"]
pub struct R(crate::R<C5SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C5SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C5SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C5SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPDMA channel 5 status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c5sr](index.html) module"]
pub struct C5SR_SPEC;
impl crate::RegisterSpec for C5SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c5sr::R](R) reader structure"]
impl crate::Readable for C5SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets C5SR to value 0x01"]
impl crate::Resettable for C5SR_SPEC {
