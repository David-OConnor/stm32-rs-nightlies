...
#[doc = "`read()` method returns [c7llr::R](R) reader structure"]
impl crate::Readable for C7LLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c7llr::W](W) writer structure"]
impl crate::Writable for C7LLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C7LLR to value 0"]
