...
#[doc = "Field `ETHERNETSO` reader - ETHERNET RAM shut-off in Stop mode."]
pub type ETHERNETSO_R = crate::BitReader<bool>;
#[doc = "Field `ETHERNETSO` writer - ETHERNET RAM shut-off in Stop mode."]
pub type ETHERNETSO_W<'a, const O: u8> = crate::BitWriter<'a, u32, PMCR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 16 - ETHERNET RAM shut-off in Stop mode."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ethernetso(&mut self) -> ETHERNETSO_W<16> {
        ETHERNETSO_W::new(self)
    }
    #[doc = "Bit 23 - AHB SRAM3 shut-off in Stop mode."]
    #[inline(always)]
    #[must_use]
