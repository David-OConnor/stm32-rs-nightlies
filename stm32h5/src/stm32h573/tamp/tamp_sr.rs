...
#[doc = "Register `TAMP_SR` writer"]
pub struct W(crate::W<TAMP_SR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TAMP_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TAMP_SR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TAMP_SR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ITAMP15F_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAMP_SR_SPEC, bool, O>;
impl R {
...
#[doc = "`write(|w| ..)` method takes [tamp_sr::W](W) writer structure"]
impl crate::Writable for TAMP_SR_SPEC {
    type Writer = W;
