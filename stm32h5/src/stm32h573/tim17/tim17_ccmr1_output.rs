#[doc = "Register `TIM17_CCMR1_Output` reader"]
pub struct R(crate::R<TIM17_CCMR1_OUTPUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM17_CCMR1_OUTPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM17_CCMR1_OUTPUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM17_CCMR1_OUTPUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM17_CCMR1_Output` writer"]
pub struct W(crate::W<TIM17_CCMR1_OUTPUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM17_CCMR1_OUTPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM17_CCMR1_OUTPUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM17_CCMR1_OUTPUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CC1S_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM17_CCMR1_OUTPUT_SPEC, u8, u8, 2, O>;
...
pub type OC1FE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM17_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC1PE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM17_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC1M1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM17_CCMR1_OUTPUT_SPEC, u8, u8, 3, O>;
...
pub type OC1CE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM17_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC1M2_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM17_CCMR1_OUTPUT_SPEC, bool, O>;
impl R {
...
#[doc = "TIM17 capture/compare mode register 1 \\[alternate\\]\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim17_ccmr1_output](index.html) module"]
pub struct TIM17_CCMR1_OUTPUT_SPEC;
impl crate::RegisterSpec for TIM17_CCMR1_OUTPUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim17_ccmr1_output::R](R) reader structure"]
impl crate::Readable for TIM17_CCMR1_OUTPUT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim17_ccmr1_output::W](W) writer structure"]
impl crate::Writable for TIM17_CCMR1_OUTPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM17_CCMR1_Output to value 0"]
impl crate::Resettable for TIM17_CCMR1_OUTPUT_SPEC {
