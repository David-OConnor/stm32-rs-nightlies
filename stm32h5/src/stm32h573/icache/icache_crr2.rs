#[doc = "Register `ICACHE_CRR2` reader"]
...
#[doc = "Register `ICACHE_CRR2` writer"]
...
#[doc = "`read()` method returns [icache_crr2::R](R) reader structure"]
impl crate::Readable for ICACHE_CRR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [icache_crr2::W](W) writer structure"]
impl crate::Writable for ICACHE_CRR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ICACHE_CRR2 to value 0x0200"]
