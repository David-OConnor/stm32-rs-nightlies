#[doc = "Register `TIM16_CCMR1_Input` reader"]
...
#[doc = "Register `TIM16_CCMR1_Input` writer"]
...
#[doc = "`read()` method returns [tim16_ccmr1_input::R](R) reader structure"]
impl crate::Readable for TIM16_CCMR1_INPUT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim16_ccmr1_input::W](W) writer structure"]
impl crate::Writable for TIM16_CCMR1_INPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM16_CCMR1_Input to value 0"]
