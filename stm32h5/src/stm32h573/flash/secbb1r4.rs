...
pub struct R(crate::R<SECBB1R4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SECBB1R4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SECBB1R4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SECBB1R4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SECBB1R4` writer"]
pub struct W(crate::W<SECBB1R4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SECBB1R4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SECBB1R4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SECBB1R4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SECBB1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SECBB1R4_SPEC, u32, u32, 32, O>;
impl R {
