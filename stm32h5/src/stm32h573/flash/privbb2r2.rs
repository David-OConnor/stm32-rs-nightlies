...
pub struct R(crate::R<PRIVBB2R2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRIVBB2R2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRIVBB2R2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRIVBB2R2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRIVBB2R2` writer"]
pub struct W(crate::W<PRIVBB2R2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRIVBB2R2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRIVBB2R2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRIVBB2R2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRIVBB2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PRIVBB2R2_SPEC, u32, u32, 32, O>;
impl R {
