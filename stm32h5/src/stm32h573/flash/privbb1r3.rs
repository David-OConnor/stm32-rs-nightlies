...
pub struct R(crate::R<PRIVBB1R3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRIVBB1R3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRIVBB1R3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRIVBB1R3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PRIVBB1R3` writer"]
pub struct W(crate::W<PRIVBB1R3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PRIVBB1R3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PRIVBB1R3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PRIVBB1R3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PRIVBB1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PRIVBB1R3_SPEC, u32, u32, 32, O>;
impl R {
