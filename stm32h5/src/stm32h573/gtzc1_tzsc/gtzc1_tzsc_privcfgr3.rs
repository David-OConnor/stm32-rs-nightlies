...
pub type ETHPRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTZC1_TZSC_PRIVCFGR3_SPEC, bool, O>;
...
pub type AESPRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTZC1_TZSC_PRIVCFGR3_SPEC, bool, O>;
...
pub type SAESPRIV_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GTZC1_TZSC_PRIVCFGR3_SPEC, bool, O>;
...
pub type PKAPRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, GTZC1_TZSC_PRIVCFGR3_SPEC, bool, O>;
...
pub type SDMMC2PRIV_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, GTZC1_TZSC_PRIVCFGR3_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aespriv(&mut self) -> AESPRIV_W<16> {
        AESPRIV_W::new(self)
    }
    #[doc = "Bit 17 - privileged access mode for HASH"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn saespriv(&mut self) -> SAESPRIV_W<19> {
        SAESPRIV_W::new(self)
    }
    #[doc = "Bit 20 - privileged access mode for PKA"]
    #[inline(always)]
    #[must_use]
    pub fn pkapriv(&mut self) -> PKAPRIV_W<20> {
        PKAPRIV_W::new(self)
    }
    #[doc = "Bit 21 - privileged access mode for SDMMC2"]
    #[inline(always)]
