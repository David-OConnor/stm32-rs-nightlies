...
pub struct R(crate::R<LPUART_CR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPUART_CR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPUART_CR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPUART_CR3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LPUART_CR3` writer"]
pub struct W(crate::W<LPUART_CR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPUART_CR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LPUART_CR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPUART_CR3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type HDSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type DMAR_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type DMAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type RTSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type CTSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type CTSIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type OVRDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type DDRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type DEM_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type DEP_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type WUS0_R = crate::BitReader<bool>;
#[doc = "Field `WUS0` writer - Wakeup from low-power mode interrupt flag selection This bitfield specifies the event which activates the WUF (Wakeup from low-power mode flag). This bitfield can only be written when the LPUART is disabled (UE=0). Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2386."]
pub type WUS0_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
#[doc = "Field `WUS1` reader - Wakeup from low-power mode interrupt flag selection This bitfield specifies the event which activates the WUF (Wakeup from low-power mode flag). This bitfield can only be written when the LPUART is disabled (UE=0). Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2386."]
pub type WUS1_R = crate::BitReader<bool>;
#[doc = "Field `WUS1` writer - Wakeup from low-power mode interrupt flag selection This bitfield specifies the event which activates the WUF (Wakeup from low-power mode flag). This bitfield can only be written when the LPUART is disabled (UE=0). Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2386."]
pub type WUS1_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type WUFIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type TXFTIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type RXFTCFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPUART_CR3_SPEC, u8, u8, 3, O>;
...
pub type RXFTIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_CR3_SPEC, bool, O>;
...
pub type TXFTCFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPUART_CR3_SPEC, u8, u8, 3, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wus0(&mut self) -> WUS0_W<20> {
        WUS0_W::new(self)
    }
    #[doc = "Bit 21 - Wakeup from low-power mode interrupt flag selection This bitfield specifies the event which activates the WUF (Wakeup from low-power mode flag). This bitfield can only be written when the LPUART is disabled (UE=0). Note: If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2386."]
    #[inline(always)]
    #[must_use]
    pub fn wus1(&mut self) -> WUS1_W<21> {
        WUS1_W::new(self)
    }
    #[doc = "Bit 22 - Wakeup from low-power mode interrupt enable This bit is set and cleared by software. Note: WUFIE must be set before entering in low-power mode. If the USART does not support the wakeup from Stop feature, this bit is reserved and must be kept at reset value. Refer to page 2386."]
    #[inline(always)]
...
#[doc = "LPUART control register 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lpuart_cr3](index.html) module"]
pub struct LPUART_CR3_SPEC;
impl crate::RegisterSpec for LPUART_CR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lpuart_cr3::R](R) reader structure"]
impl crate::Readable for LPUART_CR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lpuart_cr3::W](W) writer structure"]
impl crate::Writable for LPUART_CR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LPUART_CR3 to value 0"]
impl crate::Resettable for LPUART_CR3_SPEC {
