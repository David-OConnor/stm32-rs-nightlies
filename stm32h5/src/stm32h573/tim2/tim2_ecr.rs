#[doc = "Register `TIM2_ECR` reader"]
pub struct R(crate::R<TIM2_ECR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM2_ECR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM2_ECR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM2_ECR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM2_ECR` writer"]
pub struct W(crate::W<TIM2_ECR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM2_ECR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM2_ECR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM2_ECR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_ECR_SPEC, bool, O>;
...
bitfield must be written when IE bit is reset (index disabled)."]
pub type IDIR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_ECR_SPEC, u8, u8, 2, O>;
...
pub type IBLK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_ECR_SPEC, u8, u8, 2, O>;
...
pub type FIDX_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_ECR_SPEC, bool, O>;
...
= 1010, 1011, 1100, 1101), these bits indicates on which level the Index event resets the counter. In bidirectional clock mode, this applies for both clock inputs. x0: Index resets the counter when clock is 0 x1: Index resets the counter when clock is 1 Note: IPOS\\[1\\]
bit is not significant"]
pub type IPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_ECR_SPEC, u8, u8, 2, O>;
...
x tPWG"]
pub type PW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_ECR_SPEC, u8, u8, 8, O>;
...
pub type PWPRSC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_ECR_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "TIM2 timer encoder control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim2_ecr](index.html) module"]
pub struct TIM2_ECR_SPEC;
impl crate::RegisterSpec for TIM2_ECR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim2_ecr::R](R) reader structure"]
impl crate::Readable for TIM2_ECR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim2_ecr::W](W) writer structure"]
impl crate::Writable for TIM2_ECR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM2_ECR to value 0"]
impl crate::Resettable for TIM2_ECR_SPEC {
