...
#[doc = "Field `SS` reader - Sub seconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS\\[14:0\\]
in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR."]
pub type SS_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SS` writer - Sub seconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS\\[14:0\\]
in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR."]
...
is don’t care in Alarm B comparison. Only SS\\[30:0\\]
are compared. From 32 to 63: All 32 SS bits are compared and must match to activate alarm. Note: In BCD mode (BIN=00)The overflow bits of the synchronous counter (bits 15) is never compared. This bit can be different from 0 only after a shift operation."]
...
impl R {
    #[doc = "Bits 0:14 - Sub seconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS\\[14:0\\]
in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR."]
    #[inline(always)]
    pub fn ss(&self) -> SS_R {
