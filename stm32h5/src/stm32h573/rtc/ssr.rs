...
are forced by hardware to 0x0000. SS\\[15:0\\]: Sub second value/Synchronous binary counter LSB values When Binary mode is selected (BIN = 01 or 10 or 11): SS\\[15:0\\]
