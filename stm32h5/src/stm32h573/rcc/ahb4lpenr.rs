...
pub type OTFDEC1LPEN_R = crate::BitReader<bool>;
#[doc = "Field `OTFDEC1LPEN` writer - OTFDEC1 clock enable during sleep mode Set and reset by software."]
pub type OTFDEC1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB4LPENR_SPEC, bool, O>;
...
pub type SDMMC2LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB4LPENR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otfdec1lpen(&mut self) -> OTFDEC1LPEN_W<7> {
        OTFDEC1LPEN_W::new(self)
    }
    #[doc = "Bit 11 - SDMMC1 and SDMMC1 delay peripheral clock enable during sleep mode Set and reset by software"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdmmc2lpen(&mut self) -> SDMMC2LPEN_W<12> {
