...
#[doc = "Field `AESEN` reader - AES clock enable Set and reset by software."]
pub type AESEN_R = crate::BitReader<bool>;
#[doc = "Field `AESEN` writer - AES clock enable Set and reset by software."]
...
#[doc = "Field `PKAEN` reader - PKA clock enable Set and reset by software."]
pub type PKAEN_R = crate::BitReader<bool>;
#[doc = "Field `PKAEN` writer - PKA clock enable Set and reset by software."]
pub type PKAEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2ENR_SPEC, bool, O>;
#[doc = "Field `SAESEN` reader - SAES clock enable Set and reset by software."]
pub type SAESEN_R = crate::BitReader<bool>;
#[doc = "Field `SAESEN` writer - SAES clock enable Set and reset by software."]
...
impl R {
    ...
    #[doc = "Bit 16 - AES clock enable Set and reset by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - PKA clock enable Set and reset by software."]
    #[inline(always)]
    pub fn pkaen(&self) -> PKAEN_R {
        PKAEN_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - SAES clock enable Set and reset by software."]
    #[inline(always)]
