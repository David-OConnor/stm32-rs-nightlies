...
#[doc = "Field `AESLPEN` reader - AES clock enable during sleep mode Set and reset by software."]
pub type AESLPEN_R = crate::BitReader<bool>;
#[doc = "Field `AESLPEN` writer - AES clock enable during sleep mode Set and reset by software."]
pub type AESLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2LPENR_SPEC, bool, O>;
...
#[doc = "Field `PKALPEN` reader - PKA clock enable during sleep mode Set and reset by software."]
pub type PKALPEN_R = crate::BitReader<bool>;
#[doc = "Field `PKALPEN` writer - PKA clock enable during sleep mode Set and reset by software."]
pub type PKALPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2LPENR_SPEC, bool, O>;
#[doc = "Field `SAESLPEN` reader - SAES clock enable during sleep mode Set and reset by software."]
pub type SAESLPEN_R = crate::BitReader<bool>;
#[doc = "Field `SAESLPEN` writer - SAES clock enable during sleep mode Set and reset by software."]
pub type SAESLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2LPENR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 16 - AES clock enable during sleep mode Set and reset by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - PKA clock enable during sleep mode Set and reset by software."]
    #[inline(always)]
    pub fn pkalpen(&self) -> PKALPEN_R {
        PKALPEN_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - SAES clock enable during sleep mode Set and reset by software."]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aeslpen(&mut self) -> AESLPEN_W<16> {
        AESLPEN_W::new(self)
    }
    #[doc = "Bit 17 - HASH clock enable during sleep mode Set and reset by software."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pkalpen(&mut self) -> PKALPEN_W<19> {
        PKALPEN_W::new(self)
    }
    #[doc = "Bit 20 - SAES clock enable during sleep mode Set and reset by software."]
    #[inline(always)]
    #[must_use]
    pub fn saeslpen(&mut self) -> SAESLPEN_W<20> {
        SAESLPEN_W::new(self)
    }
    #[doc = "Bit 30 - SRAM2 clock enable during sleep mode Set and reset by software."]
    #[inline(always)]
