...
#[doc = "Field `AESRST` reader - AES block reset Set and reset by software."]
pub type AESRST_R = crate::BitReader<bool>;
#[doc = "Field `AESRST` writer - AES block reset Set and reset by software."]
...
#[doc = "Field `PKARST` reader - PKA block reset Set and reset by software."]
pub type PKARST_R = crate::BitReader<bool>;
#[doc = "Field `PKARST` writer - PKA block reset Set and reset by software."]
pub type PKARST_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2RSTR_SPEC, bool, O>;
#[doc = "Field `SAESRST` reader - SAES block reset Set and reset by software."]
pub type SAESRST_R = crate::BitReader<bool>;
#[doc = "Field `SAESRST` writer - SAES block reset Set and reset by software."]
...
impl R {
    ...
    #[doc = "Bit 16 - AES block reset Set and reset by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - PKA block reset Set and reset by software."]
    #[inline(always)]
    pub fn pkarst(&self) -> PKARST_R {
        PKARST_R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - SAES block reset Set and reset by software."]
    #[inline(always)]
