...
pub struct R(crate::R<CRS_CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CRS_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CRS_CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRS_CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CRS_CR` writer"]
pub struct W(crate::W<CRS_CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CRS_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CRS_CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CRS_CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYNCOKIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
...
pub type SYNCWARNIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
...
pub type ERRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
...
pub type ESYNCIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
...
pub type CEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
#[doc = "Field `AUTOTRIMEN` reader - Automatic trimming enable This bit enables the automatic hardware adjustment of TRIM bits according to the measured frequency error between two SYNC events. If this bit is set, the TRIM bits are read-only. The TRIM value can be adjusted by hardware by one or two steps at a time, depending on the measured frequency error value. Refer to for more details."]
pub type AUTOTRIMEN_R = crate::BitReader<bool>;
#[doc = "Field `AUTOTRIMEN` writer - Automatic trimming enable This bit enables the automatic hardware adjustment of TRIM bits according to the measured frequency error between two SYNC events. If this bit is set, the TRIM bits are read-only. The TRIM value can be adjusted by hardware by one or two steps at a time, depending on the measured frequency error value. Refer to for more details."]
pub type AUTOTRIMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
...
pub type SWSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRS_CR_SPEC, bool, O>;
...
pub type TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CRS_CR_SPEC, u8, u8, 6, O>;
impl R {
    ...
    #[doc = "Bit 6 - Automatic trimming enable This bit enables the automatic hardware adjustment of TRIM bits according to the measured frequency error between two SYNC events. If this bit is set, the TRIM bits are read-only. The TRIM value can be adjusted by hardware by one or two steps at a time, depending on the measured frequency error value. Refer to for more details."]
    #[inline(always)]
...
#[doc = "CRS control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crs_cr](index.html) module"]
pub struct CRS_CR_SPEC;
impl crate::RegisterSpec for CRS_CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [crs_cr::R](R) reader structure"]
impl crate::Readable for CRS_CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [crs_cr::W](W) writer structure"]
impl crate::Writable for CRS_CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CRS_CR to value 0x2000"]
impl crate::Resettable for CRS_CR_SPEC {
