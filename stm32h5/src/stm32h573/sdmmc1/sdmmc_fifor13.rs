#[doc = "Register `SDMMC_FIFOR13` reader"]
...
#[doc = "Register `SDMMC_FIFOR13` writer"]
...
#[doc = "`read()` method returns [sdmmc_fifor13::R](R) reader structure"]
impl crate::Readable for SDMMC_FIFOR13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sdmmc_fifor13::W](W) writer structure"]
impl crate::Writable for SDMMC_FIFOR13_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SDMMC_FIFOR13 to value 0"]
