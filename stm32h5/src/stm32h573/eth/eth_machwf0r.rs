#[doc = "Register `ETH_MACHWF0R` reader"]
pub struct R(crate::R<ETH_MACHWF0R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MACHWF0R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MACHWF0R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MACHWF0R_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HW feature 0 register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_machwf0r](index.html) module"]
pub struct ETH_MACHWF0R_SPEC;
impl crate::RegisterSpec for ETH_MACHWF0R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_machwf0r::R](R) reader structure"]
impl crate::Readable for ETH_MACHWF0R_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets ETH_MACHWF0R to value 0x0a0d_73f7"]
impl crate::Resettable for ETH_MACHWF0R_SPEC {
