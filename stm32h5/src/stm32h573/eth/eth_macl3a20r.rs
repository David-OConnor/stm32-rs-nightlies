#[doc = "Register `ETH_MACL3A20R` reader"]
pub struct R(crate::R<ETH_MACL3A20R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MACL3A20R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MACL3A20R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MACL3A20R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ETH_MACL3A20R` writer"]
pub struct W(crate::W<ETH_MACL3A20R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_MACL3A20R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_MACL3A20R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_MACL3A20R_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L3A20_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ETH_MACL3A20R_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "Layer3 Address 2 filter 0 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_macl3a20r](index.html) module"]
pub struct ETH_MACL3A20R_SPEC;
impl crate::RegisterSpec for ETH_MACL3A20R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_macl3a20r::R](R) reader structure"]
impl crate::Readable for ETH_MACL3A20R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_macl3a20r::W](W) writer structure"]
impl crate::Writable for ETH_MACL3A20R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ETH_MACL3A20R to value 0"]
impl crate::Resettable for ETH_MACL3A20R_SPEC {
