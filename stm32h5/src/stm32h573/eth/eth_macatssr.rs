...
#[doc = "Field `AUXTSHI` reader - Auxiliary Timestamp Contains the lower 32 bits of the Seconds field of the auxiliary timestamp."]
pub type AUXTSHI_R = crate::FieldReader<u32, u32>;
impl R {
    #[doc = "Bits 0:31 - Auxiliary Timestamp Contains the lower 32 bits of the Seconds field of the auxiliary timestamp."]
    #[inline(always)]
