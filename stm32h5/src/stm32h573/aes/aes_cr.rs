...
pub struct R(crate::R<AES_CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AES_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AES_CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AES_CR_SPEC>) -> Self {
        R(reader)
    }
}
...
other than 00, use the IPRST bit rather than the bit EN."]
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AES_CR_SPEC, bool, O>;
...
pub type DATATYPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AES_CR_SPEC, u8, u8, 2, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AES_CR_SPEC, u8, u8, 2, O>;
...
pub type CHMOD1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AES_CR_SPEC, u8, u8, 2, O>;
...
bitfield. It is not effective for Mode 2 (key derivation)."]
pub type DMAINEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AES_CR_SPEC, bool, O>;
...
bitfield. It is not effective for Mode 2 (key derivation)."]
pub type DMAOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AES_CR_SPEC, bool, O>;
...
pub type GCMPH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AES_CR_SPEC, u8, u8, 2, O>;
...
pub type CHMOD2_W<'a, const O: u8> = crate::BitWriter<'a, u32, AES_CR_SPEC, bool, O>;
...
pub type KEYSIZE_W<'a, const O: u8> = crate::BitWriter<'a, u32, AES_CR_SPEC, bool, O>;
...
pub type NPBLB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AES_CR_SPEC, u8, u8, 4, O>;
...
pub type KMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AES_CR_SPEC, u8, u8, 2, O>;
...
pub type IPRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, AES_CR_SPEC, bool, O>;
impl R {
...
impl crate::Readable for AES_CR_SPEC {
    type Reader = R;
}
