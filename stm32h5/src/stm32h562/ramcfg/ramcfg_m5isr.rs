#[doc = "Register `RAMCFG_M5ISR` reader"]
pub struct R(crate::R<RAMCFG_M5ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAMCFG_M5ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAMCFG_M5ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAMCFG_M5ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "RAMCFG memory interrupt status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ramcfg_m5isr](index.html) module"]
pub struct RAMCFG_M5ISR_SPEC;
impl crate::RegisterSpec for RAMCFG_M5ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ramcfg_m5isr::R](R) reader structure"]
impl crate::Readable for RAMCFG_M5ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RAMCFG_M5ISR to value 0"]
impl crate::Resettable for RAMCFG_M5ISR_SPEC {
