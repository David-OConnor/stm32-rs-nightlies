...
pub struct R(crate::R<TAMP_BKP0R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TAMP_BKP0R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TAMP_BKP0R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TAMP_BKP0R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TAMP_BKP0R` writer"]
pub struct W(crate::W<TAMP_BKP0R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TAMP_BKP0R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TAMP_BKP0R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TAMP_BKP0R_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BKP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TAMP_BKP0R_SPEC, u32, u32, 32, O>;
impl R {
