#[doc = "Register `TAMP_ATCR2` reader"]
...
#[doc = "Register `TAMP_ATCR2` writer"]
...
#[doc = "`read()` method returns [tamp_atcr2::R](R) reader structure"]
impl crate::Readable for TAMP_ATCR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tamp_atcr2::W](W) writer structure"]
impl crate::Writable for TAMP_ATCR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TAMP_ATCR2 to value 0"]
