#[doc = "Register `TAMP_BKP13R` reader"]
...
#[doc = "Register `TAMP_BKP13R` writer"]
...
#[doc = "`read()` method returns [tamp_bkp13r::R](R) reader structure"]
impl crate::Readable for TAMP_BKP13R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tamp_bkp13r::W](W) writer structure"]
impl crate::Writable for TAMP_BKP13R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TAMP_BKP13R to value 0"]
