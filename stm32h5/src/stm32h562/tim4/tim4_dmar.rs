...
#[doc = "`read()` method returns [tim4_dmar::R](R) reader structure"]
impl crate::Readable for TIM4_DMAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim4_dmar::W](W) writer structure"]
impl crate::Writable for TIM4_DMAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM4_DMAR to value 0"]
