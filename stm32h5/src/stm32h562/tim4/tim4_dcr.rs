...
pub type DBA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_DCR_SPEC, u8, u8, 5, O>;
...
pub type DBL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_DCR_SPEC, u8, u8, 5, O>;
...
pub type DBSS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM4_DCR_SPEC, u8, u8, 4, O>;
impl R {
