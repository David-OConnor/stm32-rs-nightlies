...
pub struct R(crate::R<USB_DADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB_DADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB_DADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB_DADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USB_DADDR` writer"]
pub struct W(crate::W<USB_DADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USB_DADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USB_DADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USB_DADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, USB_DADDR_SPEC, u8, u8, 7, O>;
...
bits. If this bit is at 0 no transactions are handled, irrespective of the settings of USB_CHEPnR registers."]
pub type EF_W<'a, const O: u8> = crate::BitWriter<'a, u32, USB_DADDR_SPEC, bool, O>;
impl R {
...
#[doc = "USB_DADDR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usb_daddr](index.html) module"]
