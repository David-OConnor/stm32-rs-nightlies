...
pub type ARDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, RNG_CR_SPEC, bool, O>;
...
pub type RNG_CONFIG3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RNG_CR_SPEC, u8, u8, 4, O>;
...
pub type NISTC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RNG_CR_SPEC, bool, O>;
...
pub type RNG_CONFIG2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RNG_CR_SPEC, u8, u8, 3, O>;
...
pub type CLKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RNG_CR_SPEC, u8, u8, 4, O>;
...
pub type RNG_CONFIG1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RNG_CR_SPEC, u8, u8, 6, O>;
...
must also be written. When CONDRST is set to 0 by software its value goes to 0 when the reset process is done. It takes about 2 AHB clock cycles + 2 RNG clock cycles."]
pub type CONDRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, RNG_CR_SPEC, bool, O>;
...
pub type CONFIGLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, RNG_CR_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets RNG_CR to value 0x0087_1f00"]
impl crate::Resettable for RNG_CR_SPEC {
    const RESET_VALUE: Self::Ux = 0x0087_1f00;
}
