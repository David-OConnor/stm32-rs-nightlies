...
pub struct R(crate::R<I3C_TIMINGR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I3C_TIMINGR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I3C_TIMINGR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I3C_TIMINGR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I3C_TIMINGR1` writer"]
pub struct W(crate::W<I3C_TIMINGR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I3C_TIMINGR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I3C_TIMINGR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I3C_TIMINGR1_SPEC>) -> Self {
        W(writer)
    }
}
...
+ 1) x 2000 x tI3CCLK If ASNCR\\[1:0\\]=11: tNEWCRLock = (AVAL\\[7:0\\]
+ 1) x 50000 x tI3CCLK"]
pub type AVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, I3C_TIMINGR1_SPEC, u8, u8, 8, O>;
...
pub type ASNCR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, I3C_TIMINGR1_SPEC, u8, u8, 2, O>;
...
+ 1) x tI3CCLK for I3C repeated start timing (T-bit when controller ends read with repeated start followed by stop): it must wait for time to be elapsed after that the SCL clock is driven high and before the repeated start condition (i.e. SDA is de-asserted). This timing is defined by: tCBSr = (FREE\\[6:0\\]
+ 1) x tI3CCLK"]
pub type FREE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, I3C_TIMINGR1_SPEC, u8, u8, 7, O>;
...
pub type SDA_HD_W<'a, const O: u8> = crate::BitWriter<'a, u32, I3C_TIMINGR1_SPEC, bool, O>;
impl R {
...
#[doc = "I3C timing register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i3c_timingr1](index.html) module"]
pub struct I3C_TIMINGR1_SPEC;
impl crate::RegisterSpec for I3C_TIMINGR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i3c_timingr1::R](R) reader structure"]
impl crate::Readable for I3C_TIMINGR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i3c_timingr1::W](W) writer structure"]
impl crate::Writable for I3C_TIMINGR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets I3C_TIMINGR1 to value 0"]
impl crate::Resettable for I3C_TIMINGR1_SPEC {
