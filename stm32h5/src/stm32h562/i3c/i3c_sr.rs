...
pub struct R(crate::R<I3C_SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I3C_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I3C_SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I3C_SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "I3C status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i3c_sr](index.html) module"]
pub struct I3C_SR_SPEC;
impl crate::RegisterSpec for I3C_SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i3c_sr::R](R) reader structure"]
impl crate::Readable for I3C_SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets I3C_SR to value 0"]
impl crate::Resettable for I3C_SR_SPEC {
