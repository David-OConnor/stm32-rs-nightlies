#[doc = "Register `C3SR` reader"]
pub struct R(crate::R<C3SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C3SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C3SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C3SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPDMA channel 3 status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c3sr](index.html) module"]
pub struct C3SR_SPEC;
impl crate::RegisterSpec for C3SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c3sr::R](R) reader structure"]
impl crate::Readable for C3SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets C3SR to value 0x01"]
impl crate::Resettable for C3SR_SPEC {
