...
pub struct W(crate::W<LPUART_RQR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LPUART_RQR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<LPUART_RQR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LPUART_RQR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SBKRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_RQR_SPEC, bool, O>;
#[doc = "Field `MMRQ` writer - Mute mode request Writing 1 to this bit puts the LPUART in Mute mode and resets the RWU flag."]
pub type MMRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_RQR_SPEC, bool, O>;
...
pub type RXFRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_RQR_SPEC, bool, O>;
...
pub type TXFRQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPUART_RQR_SPEC, bool, O>;
impl W {
...
#[doc = "LPUART request register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lpuart_rqr](index.html) module"]
pub struct LPUART_RQR_SPEC;
impl crate::RegisterSpec for LPUART_RQR_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [lpuart_rqr::W](W) writer structure"]
impl crate::Writable for LPUART_RQR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LPUART_RQR to value 0"]
impl crate::Resettable for LPUART_RQR_SPEC {
