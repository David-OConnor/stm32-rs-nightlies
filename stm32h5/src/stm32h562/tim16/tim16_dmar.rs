#[doc = "Register `TIM16_DMAR` reader"]
...
#[doc = "Register `TIM16_DMAR` writer"]
...
#[doc = "`read()` method returns [tim16_dmar::R](R) reader structure"]
impl crate::Readable for TIM16_DMAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim16_dmar::W](W) writer structure"]
impl crate::Writable for TIM16_DMAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM16_DMAR to value 0"]
