...
pub struct R(crate::R<CRS_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CRS_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CRS_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CRS_ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CRS interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [crs_isr](index.html) module"]
pub struct CRS_ISR_SPEC;
impl crate::RegisterSpec for CRS_ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [crs_isr::R](R) reader structure"]
impl crate::Readable for CRS_ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CRS_ISR to value 0"]
impl crate::Resettable for CRS_ISR_SPEC {
