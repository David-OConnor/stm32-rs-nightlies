#[doc = "Register `TIM1_ECR` reader"]
pub struct R(crate::R<TIM1_ECR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM1_ECR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM1_ECR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM1_ECR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM1_ECR` writer"]
pub struct W(crate::W<TIM1_ECR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM1_ECR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM1_ECR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM1_ECR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_ECR_SPEC, bool, O>;
...
bitfield must be written when IE bit is reset (index disabled)."]
pub type IDIR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_ECR_SPEC, u8, u8, 2, O>;
...
pub type IBLK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_ECR_SPEC, u8, u8, 2, O>;
...
pub type FIDX_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_ECR_SPEC, bool, O>;
...
= 1010, 1011, 1100, 1101), these bits indicates on which level the Index event resets the counter. In bidirectional clock mode, this applies for both clock inputs. x0: Index resets the counter when clock is 0 x1: Index resets the counter when clock is 1 Note: IPOS\\[1\\]
bit is not significant"]
pub type IPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_ECR_SPEC, u8, u8, 2, O>;
#[doc = "Field `PW` reader - Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW\\[7:0\\]
x t<sub>PWG</sub>"]
pub type PW_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PW` writer - Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW\\[7:0\\]
x t<sub>PWG</sub>"]
pub type PW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_ECR_SPEC, u8, u8, 8, O>;
#[doc = "Field `PWPRSC` reader - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t<sub>PWG</sub> = (2<sup>(PWPRSC\\[2:0\\])</sup>) x t<sub>tim_ker_ck</sub>"]
pub type PWPRSC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PWPRSC` writer - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t<sub>PWG</sub> = (2<sup>(PWPRSC\\[2:0\\])</sup>) x t<sub>tim_ker_ck</sub>"]
pub type PWPRSC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_ECR_SPEC, u8, u8, 3, O>;
impl R {
...
bit is not significant"]
    ...
    #[doc = "Bits 16:23 - Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW\\[7:0\\]
x t<sub>PWG</sub>"]
    #[inline(always)]
    pub fn pw(&self) -> PW_R {
        PW_R::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:26 - Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t<sub>PWG</sub> = (2<sup>(PWPRSC\\[2:0\\])</sup>) x t<sub>tim_ker_ck</sub>"]
    #[inline(always)]
...
#[doc = "TIM1 timer encoder control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim1_ecr](index.html) module"]
pub struct TIM1_ECR_SPEC;
impl crate::RegisterSpec for TIM1_ECR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim1_ecr::R](R) reader structure"]
impl crate::Readable for TIM1_ECR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim1_ecr::W](W) writer structure"]
impl crate::Writable for TIM1_ECR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM1_ECR to value 0"]
impl crate::Resettable for TIM1_ECR_SPEC {
