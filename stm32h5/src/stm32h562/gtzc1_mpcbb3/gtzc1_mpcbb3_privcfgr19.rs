#[doc = "Register `GTZC1_MPCBB3_PRIVCFGR19` reader"]
...
#[doc = "Register `GTZC1_MPCBB3_PRIVCFGR19` writer"]
...
#[doc = "`read()` method returns [gtzc1_mpcbb3_privcfgr19::R](R) reader structure"]
impl crate::Readable for GTZC1_MPCBB3_PRIVCFGR19_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gtzc1_mpcbb3_privcfgr19::W](W) writer structure"]
impl crate::Writable for GTZC1_MPCBB3_PRIVCFGR19_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GTZC1_MPCBB3_PRIVCFGR19 to value 0xffff_ffff"]
