#[doc = "Register `TIM2_CCR3` reader"]
pub struct R(crate::R<TIM2_CCR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM2_CCR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM2_CCR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM2_CCR3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM2_CCR3` writer"]
pub struct W(crate::W<TIM2_CCR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM2_CCR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM2_CCR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM2_CCR3_SPEC>) -> Self {
        W(writer)
    }
}
...
bitfield contains the dithered part. If channel CC3 is configured as input: CCR3 is the counter value transferred by the last input capture 3 event (tim_ic3). The TIMx_CCR3 register is read-only and cannot be programmed. Non-dithering mode (DITHEN = 0) The register holds the capture value. Dithering mode (DITHEN = 1) The register holds the capture in CCR3\\[31:0\\]. The CCR3\\[3:0\\]
bits are reset."]
pub type CCR3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_CCR3_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "TIM2 capture/compare register 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim2_ccr3](index.html) module"]
pub struct TIM2_CCR3_SPEC;
impl crate::RegisterSpec for TIM2_CCR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim2_ccr3::R](R) reader structure"]
impl crate::Readable for TIM2_CCR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim2_ccr3::W](W) writer structure"]
impl crate::Writable for TIM2_CCR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM2_CCR3 to value 0"]
impl crate::Resettable for TIM2_CCR3_SPEC {
