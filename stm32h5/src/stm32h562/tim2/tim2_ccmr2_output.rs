#[doc = "Register `TIM2_CCMR2_Output` reader"]
pub struct R(crate::R<TIM2_CCMR2_OUTPUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM2_CCMR2_OUTPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM2_CCMR2_OUTPUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM2_CCMR2_OUTPUT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM2_CCMR2_Output` writer"]
pub struct W(crate::W<TIM2_CCMR2_OUTPUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM2_CCMR2_OUTPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM2_CCMR2_OUTPUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM2_CCMR2_OUTPUT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CC3S_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, u8, u8, 2, O>;
...
pub type OC3FE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC3PE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC3M1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, u8, u8, 3, O>;
...
pub type OC3CE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC4FE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC4PE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC4CE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC3M2_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
...
pub type OC4M2_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR2_OUTPUT_SPEC, bool, O>;
impl R {
...
#[doc = "TIM2 capture/compare mode register 2 \\[alternate\\]\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim2_ccmr2_output](index.html) module"]
pub struct TIM2_CCMR2_OUTPUT_SPEC;
impl crate::RegisterSpec for TIM2_CCMR2_OUTPUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim2_ccmr2_output::R](R) reader structure"]
impl crate::Readable for TIM2_CCMR2_OUTPUT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim2_ccmr2_output::W](W) writer structure"]
impl crate::Writable for TIM2_CCMR2_OUTPUT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM2_CCMR2_Output to value 0"]
impl crate::Resettable for TIM2_CCMR2_OUTPUT_SPEC {
