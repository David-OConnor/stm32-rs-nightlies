#[doc = "Register `LPTIM_ISR_output` reader"]
pub struct R(crate::R<LPTIM_ISR_OUTPUT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPTIM_ISR_OUTPUT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPTIM_ISR_OUTPUT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPTIM_ISR_OUTPUT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "LPTIM interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lptim_isr_output](index.html) module"]
pub struct LPTIM_ISR_OUTPUT_SPEC;
impl crate::RegisterSpec for LPTIM_ISR_OUTPUT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lptim_isr_output::R](R) reader structure"]
impl crate::Readable for LPTIM_ISR_OUTPUT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets LPTIM_ISR_output to value 0"]
impl crate::Resettable for LPTIM_ISR_OUTPUT_SPEC {
