...
#[doc = "Field `CLR_OBKERR` writer - OBKERR flag clear bit. Setting this bit to 1 resets to 0 OBKERR flag in FLASH_NSSR register."]
pub type CLR_OBKERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, NSCCR_SPEC, bool, O>;
#[doc = "Field `CLR_OBKWERR` writer - OBKWERR flag clear bit. Setting this bit to 1 resets to 0 OBKWERR flag in FLASH_NSSR register."]
...
impl W {
    ...
    #[doc = "Bit 21 - OBKERR flag clear bit. Setting this bit to 1 resets to 0 OBKERR flag in FLASH_NSSR register."]
    #[inline(always)]
    #[must_use]
    pub fn clr_obkerr(&mut self) -> CLR_OBKERR_W<21> {
        CLR_OBKERR_W::new(self)
    }
    #[doc = "Bit 22 - OBKWERR flag clear bit. Setting this bit to 1 resets to 0 OBKWERR flag in FLASH_NSSR register."]
    #[inline(always)]
    #[must_use]
