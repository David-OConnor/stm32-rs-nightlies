...
#[doc = "`read()` method returns [privbb1r2::R](R) reader structure"]
impl crate::Readable for PRIVBB1R2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [privbb1r2::W](W) writer structure"]
impl crate::Writable for PRIVBB1R2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PRIVBB1R2 to value 0"]
