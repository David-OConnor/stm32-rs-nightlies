...
#[doc = "`read()` method returns [privbb2r3::R](R) reader structure"]
impl crate::Readable for PRIVBB2R3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [privbb2r3::W](W) writer structure"]
impl crate::Writable for PRIVBB2R3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PRIVBB2R3 to value 0"]
