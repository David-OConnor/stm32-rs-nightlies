...
#[doc = "Field `OBK_ECC` reader - Single ECC error corrected in flash OB Keys storage area. It indicates the OBK storage concerned by ECC error."]
pub type OBK_ECC_R = crate::BitReader<bool>;
#[doc = "Field `EDATA_ECC` reader - ECC fail for corrected ECC error in flash high-cycle data area It indicates if flash high-cycle data area is concerned by ECC error."]
pub type EDATA_ECC_R = crate::BitReader<bool>;
#[doc = "Field `BK_ECC` reader - ECC fail bank for corrected ECC error It indicates which bank is concerned by ECC error"]
pub type BK_ECC_R = crate::BitReader<bool>;
#[doc = "Field `SYSF_ECC` reader - ECC fail for corrected ECC error in system flash memory It indicates if system flash memory is concerned by ECC error."]
...
impl R {
    ...
    #[doc = "Bit 20 - Single ECC error corrected in flash OB Keys storage area. It indicates the OBK storage concerned by ECC error."]
    #[inline(always)]
    pub fn obk_ecc(&self) -> OBK_ECC_R {
        OBK_ECC_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - ECC fail for corrected ECC error in flash high-cycle data area It indicates if flash high-cycle data area is concerned by ECC error."]
    #[inline(always)]
    pub fn edata_ecc(&self) -> EDATA_ECC_R {
        EDATA_ECC_R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - ECC fail bank for corrected ECC error It indicates which bank is concerned by ECC error"]
    #[inline(always)]
    pub fn bk_ecc(&self) -> BK_ECC_R {
        BK_ECC_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - ECC fail for corrected ECC error in system flash memory It indicates if system flash memory is concerned by ECC error."]
    #[inline(always)]
