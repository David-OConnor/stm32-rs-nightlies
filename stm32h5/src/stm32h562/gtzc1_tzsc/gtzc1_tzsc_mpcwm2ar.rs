#[doc = "Register `GTZC1_TZSC_MPCWM2AR` reader"]
pub struct R(crate::R<GTZC1_TZSC_MPCWM2AR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GTZC1_TZSC_MPCWM2AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GTZC1_TZSC_MPCWM2AR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GTZC1_TZSC_MPCWM2AR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GTZC1_TZSC_MPCWM2AR` writer"]
pub struct W(crate::W<GTZC1_TZSC_MPCWM2AR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GTZC1_TZSC_MPCWM2AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GTZC1_TZSC_MPCWM2AR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GTZC1_TZSC_MPCWM2AR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SUBA_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GTZC1_TZSC_MPCWM2AR_SPEC, u16, u16, 11, O>;
...
pub type SUBA_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GTZC1_TZSC_MPCWM2AR_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bits 0:10 - Start of sub-region A in region x This field defines the address offset of the sub-region A, to be multiplied by the granularity defined in Table�30, versus the start of the region x. External memories that are watermark controlled, start fully non-secure at reset when TZEN�=�0xC3. When TZEN�=�0xB4, external memories start fully secure (inverted reset value)."]
    #[inline(always)]
...
#[doc = "GTZC1 TZSC memory 2 sub-region A watermark register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gtzc1_tzsc_mpcwm2ar](index.html) module"]
pub struct GTZC1_TZSC_MPCWM2AR_SPEC;
impl crate::RegisterSpec for GTZC1_TZSC_MPCWM2AR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gtzc1_tzsc_mpcwm2ar::R](R) reader structure"]
impl crate::Readable for GTZC1_TZSC_MPCWM2AR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gtzc1_tzsc_mpcwm2ar::W](W) writer structure"]
impl crate::Writable for GTZC1_TZSC_MPCWM2AR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GTZC1_TZSC_MPCWM2AR to value 0"]
impl crate::Resettable for GTZC1_TZSC_MPCWM2AR_SPEC {
