#[doc = "Register `UCPD_TX_ORDSETR` reader"]
...
#[doc = "Register `UCPD_TX_ORDSETR` writer"]
...
#[doc = "`read()` method returns [ucpd_tx_ordsetr::R](R) reader structure"]
impl crate::Readable for UCPD_TX_ORDSETR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucpd_tx_ordsetr::W](W) writer structure"]
impl crate::Writable for UCPD_TX_ORDSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCPD_TX_ORDSETR to value 0"]
