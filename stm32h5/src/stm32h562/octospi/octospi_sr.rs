#[doc = "Register `OCTOSPI_SR` reader"]
pub struct R(crate::R<OCTOSPI_SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OCTOSPI_SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OCTOSPI_SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OCTOSPI_SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `SMF` reader - Status match flag This bit is set in Automatic status-polling mode when the unmasked received data matches the corresponding bits in the match register (OCTOSPI_PSMAR). It is cleared by writing 1 to CSMF."]
...
#[doc = "Field `BUSY` reader - Busy This bit is set when an operation is ongoing. It is cleared automatically when the operation with the external device is finished and the FIFO is empty."]
pub type BUSY_R = crate::BitReader<bool>;
#[doc = "Field `FLEVEL` reader - FIFO level This field gives the number of valid bytes that are being held in the FIFO. FLEVEL = 0 when the FIFO is empty, and 32 when it is full. In Automatic status-polling mode, FLEVEL is zero."]
...
impl R {
    ...
    #[doc = "Bit 3 - Status match flag This bit is set in Automatic status-polling mode when the unmasked received data matches the corresponding bits in the match register (OCTOSPI_PSMAR). It is cleared by writing 1 to CSMF."]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Busy This bit is set when an operation is ongoing. It is cleared automatically when the operation with the external device is finished and the FIFO is empty."]
    #[inline(always)]
    pub fn busy(&self) -> BUSY_R {
        BUSY_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bits 8:13 - FIFO level This field gives the number of valid bytes that are being held in the FIFO. FLEVEL = 0 when the FIFO is empty, and 32 when it is full. In Automatic status-polling mode, FLEVEL is zero."]
    #[inline(always)]
    pub fn flevel(&self) -> FLEVEL_R {
        FLEVEL_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
}
#[doc = "OCTOSPI status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [octospi_sr](index.html) module"]
pub struct OCTOSPI_SR_SPEC;
impl crate::RegisterSpec for OCTOSPI_SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [octospi_sr::R](R) reader structure"]
impl crate::Readable for OCTOSPI_SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets OCTOSPI_SR to value 0"]
impl crate::Resettable for OCTOSPI_SR_SPEC {
