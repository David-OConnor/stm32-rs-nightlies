#[doc = "Register `OCTOSPI_WPTCR` reader"]
pub struct R(crate::R<OCTOSPI_WPTCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OCTOSPI_WPTCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OCTOSPI_WPTCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OCTOSPI_WPTCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OCTOSPI_WPTCR` writer"]
pub struct W(crate::W<OCTOSPI_WPTCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OCTOSPI_WPTCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OCTOSPI_WPTCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OCTOSPI_WPTCR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCYC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OCTOSPI_WPTCR_SPEC, u8, u8, 5, O>;
...
pub type DHQC_W<'a, const O: u8> = crate::BitWriter<'a, u32, OCTOSPI_WPTCR_SPEC, bool, O>;
...
pub type SSHIFT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OCTOSPI_WPTCR_SPEC, bool, O>;
impl R {
...
#[doc = "OCTOSPI wrap timing configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [octospi_wptcr](index.html) module"]
pub struct OCTOSPI_WPTCR_SPEC;
impl crate::RegisterSpec for OCTOSPI_WPTCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [octospi_wptcr::R](R) reader structure"]
impl crate::Readable for OCTOSPI_WPTCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [octospi_wptcr::W](W) writer structure"]
impl crate::Writable for OCTOSPI_WPTCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OCTOSPI_WPTCR to value 0"]
impl crate::Resettable for OCTOSPI_WPTCR_SPEC {
