...
#[doc = "Field `UIFCPY` reader - UIF Copy This bit is a read-only copy of the UIF bit in the TIM15_ISR register."]
...
impl R {
    ...
    #[doc = "Bit 31 - UIF Copy This bit is a read-only copy of the UIF bit in the TIM15_ISR register."]
    #[inline(always)]
