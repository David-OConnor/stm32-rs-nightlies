...
pub type COVRUDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_ACLRFR_SPEC, COVRUDRW_AW, O>;
...
pub type CMUTEDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_ACLRFR_SPEC, CMUTEDETW_AW, O>;
...
= 0) and NODIV = 0 in the SAI_xCR1 register. Reading this bit always returns the value 0."]
pub type CWCKCFG_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_ACLRFR_SPEC, CWCKCFGW_AW, O>;
...
pub type CCNRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_ACLRFR_SPEC, CCNRDYW_AW, O>;
...
#[doc = "Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC’97 or SPDIF mode. Reading this bit always returns the value 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CAFSDET` writer - Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC’97 or SPDIF mode. Reading this bit always returns the value 0."]
pub type CAFSDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_ACLRFR_SPEC, CAFSDETW_AW, O>;
...
#[doc = "Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC’97 or SPDIF mode Reading this bit always returns the value 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `CLFSDET` writer - Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC’97 or SPDIF mode Reading this bit always returns the value 0."]
pub type CLFSDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_ACLRFR_SPEC, CLFSDETW_AW, O>;
...
= 0) and NODIV = 0 in the SAI_xCR1 register. Reading this bit always returns the value 0."]
    ...
    #[doc = "Bit 5 - Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC’97 or SPDIF mode. Reading this bit always returns the value 0."]
    #[inline(always)]
    #[must_use]
    pub fn cafsdet(&mut self) -> CAFSDET_W<5> {
        CAFSDET_W::new(self)
    }
    #[doc = "Bit 6 - Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC’97 or SPDIF mode Reading this bit always returns the value 0."]
    #[inline(always)]
    #[must_use]
