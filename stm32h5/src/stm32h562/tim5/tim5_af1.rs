...
#[doc = "`read()` method returns [tim5_af1::R](R) reader structure"]
impl crate::Readable for TIM5_AF1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim5_af1::W](W) writer structure"]
impl crate::Writable for TIM5_AF1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM5_AF1 to value 0"]
