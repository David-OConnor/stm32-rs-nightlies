...
bitfield contains the dithered part."]
pub type ARR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM5_ARR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null. Non-dithering mode (DITHEN = 0) The register holds the auto-reload value. Dithering mode (DITHEN = 1) The register holds the integer part in ARR\\[31:4\\]. The ARR\\[3:0\\]
bitfield contains the dithered part."]
    #[inline(always)]
...
#[doc = "`reset()` method sets TIM5_ARR to value 0xffff_ffff"]
