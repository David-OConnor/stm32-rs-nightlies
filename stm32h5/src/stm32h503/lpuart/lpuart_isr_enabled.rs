#[doc = "Register `LPUART_ISR_enabled` reader"]
pub struct R(crate::R<LPUART_ISR_ENABLED_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LPUART_ISR_ENABLED_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LPUART_ISR_ENABLED_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LPUART_ISR_ENABLED_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "LPUART interrupt and status register \\[alternate\\]\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lpuart_isr_enabled](index.html) module"]
pub struct LPUART_ISR_ENABLED_SPEC;
impl crate::RegisterSpec for LPUART_ISR_ENABLED_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lpuart_isr_enabled::R](R) reader structure"]
impl crate::Readable for LPUART_ISR_ENABLED_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets LPUART_ISR_enabled to value 0x0080_00c0"]
impl crate::Resettable for LPUART_ISR_ENABLED_SPEC {
