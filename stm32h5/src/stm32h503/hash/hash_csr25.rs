...
pub type CS25_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CS25` writer - Context swap x Refer to Section 24.7.7: HASH context swap registers introduction."]
pub type CS25_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HASH_CSR25_SPEC, u32, u32, 32, O>;
impl R {
