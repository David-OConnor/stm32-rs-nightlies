...
pub struct R(crate::R<TAMP_BKP4R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TAMP_BKP4R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TAMP_BKP4R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TAMP_BKP4R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TAMP_BKP4R` writer"]
pub struct W(crate::W<TAMP_BKP4R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TAMP_BKP4R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TAMP_BKP4R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TAMP_BKP4R_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BKP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TAMP_BKP4R_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "TAMP backup 4 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tamp_bkp4r](index.html) module"]
pub struct TAMP_BKP4R_SPEC;
impl crate::RegisterSpec for TAMP_BKP4R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tamp_bkp4r::R](R) reader structure"]
impl crate::Readable for TAMP_BKP4R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tamp_bkp4r::W](W) writer structure"]
impl crate::Writable for TAMP_BKP4R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TAMP_BKP4R to value 0"]
impl crate::Resettable for TAMP_BKP4R_SPEC {
