...
pub type OC1CE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC2FE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC2PE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC2CE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR1_OUTPUT_SPEC, bool, O>;
...
pub type OC2M2_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CCMR1_OUTPUT_SPEC, bool, O>;
impl R {
