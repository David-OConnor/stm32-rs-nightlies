...
#[doc = "`read()` method returns [i3c_devr4::R](R) reader structure"]
impl crate::Readable for I3C_DEVR4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i3c_devr4::W](W) writer structure"]
impl crate::Writable for I3C_DEVR4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets I3C_DEVR4 to value 0"]
