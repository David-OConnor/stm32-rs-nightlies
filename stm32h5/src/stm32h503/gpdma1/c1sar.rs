#[doc = "Register `C1SAR` reader"]
pub struct R(crate::R<C1SAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C1SAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C1SAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C1SAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C1SAR` writer"]
pub struct W(crate::W<C1SAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C1SAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C1SAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C1SAR_SPEC>) -> Self {
        W(writer)
    }
}
...
versus GPDMA_CxTR1.SDW_LOG2\\[1:0\\]). Else, a user setting error is reported and no transfer is issued. Note: When the source block size is not a multiple of the source burst size and is a multiple of the source data width, the last programmed source burst is not completed and is internally shorten to match the block size. In this case, the additional GPDMA_CxTR3.SAO\\[12:0\\]
is not applied."]
pub type SA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C1SAR_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "GPDMA channel 1 source address register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c1sar](index.html) module"]
pub struct C1SAR_SPEC;
impl crate::RegisterSpec for C1SAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c1sar::R](R) reader structure"]
impl crate::Readable for C1SAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c1sar::W](W) writer structure"]
impl crate::Writable for C1SAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C1SAR to value 0"]
impl crate::Resettable for C1SAR_SPEC {
