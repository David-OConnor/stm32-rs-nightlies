...
pub struct W(crate::W<C3FCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C3FCR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<C3FCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C3FCR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TCF` writer - transfer complete flag clear"]
pub type TCF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
#[doc = "Field `HTF` writer - half transfer flag clear"]
pub type HTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
#[doc = "Field `DTEF` writer - data transfer error flag clear"]
pub type DTEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
#[doc = "Field `ULEF` writer - update link transfer error flag clear"]
pub type ULEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
#[doc = "Field `USEF` writer - user setting error flag clear"]
pub type USEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
#[doc = "Field `SUSPF` writer - completed suspension flag clear"]
pub type SUSPF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
#[doc = "Field `TOF` writer - trigger overrun flag clear"]
pub type TOF_W<'a, const O: u8> = crate::BitWriter<'a, u32, C3FCR_SPEC, bool, O>;
impl W {
