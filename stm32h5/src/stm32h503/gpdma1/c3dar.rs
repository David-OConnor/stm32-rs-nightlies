...
#[doc = "`read()` method returns [c3dar::R](R) reader structure"]
impl crate::Readable for C3DAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c3dar::W](W) writer structure"]
impl crate::Writable for C3DAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C3DAR to value 0"]
