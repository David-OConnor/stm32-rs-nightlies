#[doc = "Register `C4DAR` reader"]
pub struct R(crate::R<C4DAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C4DAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C4DAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C4DAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C4DAR` writer"]
pub struct W(crate::W<C4DAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C4DAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C4DAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C4DAR_SPEC>) -> Self {
        W(writer)
    }
}
...
In linked-list mode, after a LLI data transfer is completed, this register is automatically updated by the GPDMA from the memory, provided the LLI is set with GPDMA_CxLLR.UDA = 1. Note: A destination address must be aligned with the programmed data width of a destination burst (DA\\[2:0\\]
versus GPDMA_CxTR1.DDW_LOG2\\[1:0\\]). Else, a user setting error is reported and no transfer is issued."]
pub type DA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C4DAR_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "GPDMA channel 4 destination address register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c4dar](index.html) module"]
pub struct C4DAR_SPEC;
impl crate::RegisterSpec for C4DAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c4dar::R](R) reader structure"]
impl crate::Readable for C4DAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c4dar::W](W) writer structure"]
impl crate::Writable for C4DAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C4DAR to value 0"]
impl crate::Resettable for C4DAR_SPEC {
