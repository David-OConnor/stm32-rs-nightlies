...
pub struct R(crate::R<C5BR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C5BR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C5BR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C5BR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C5BR1` writer"]
pub struct W(crate::W<C5BR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C5BR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C5BR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C5BR1_SPEC>) -> Self {
        W(writer)
    }
}
...
= 1 and destination data width different from source data width), a non-null source block size must be a multiple of the destination data width (BNDT\\[2:0\\]
versus GPDMA_CxTR1.DDW_LOG2\\[1:0\\]). Else a user setting error is reported and no transfer is issued."]
pub type BNDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C5BR1_SPEC, u16, u16, 16, O>;
impl R {
