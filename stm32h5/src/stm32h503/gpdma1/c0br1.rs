...
#[doc = "`read()` method returns [c0br1::R](R) reader structure"]
impl crate::Readable for C0BR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c0br1::W](W) writer structure"]
impl crate::Writable for C0BR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C0BR1 to value 0"]
