#[doc = "Register `C0SR` reader"]
pub struct R(crate::R<C0SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C0SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C0SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C0SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPDMA channel 0 status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c0sr](index.html) module"]
pub struct C0SR_SPEC;
impl crate::RegisterSpec for C0SR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [c0sr::R](R) reader structure"]
impl crate::Readable for C0SR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets C0SR to value 0x01"]
impl crate::Resettable for C0SR_SPEC {
