...
pub struct R(crate::R<USB_FNR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USB_FNR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USB_FNR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USB_FNR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "USB frame number register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [usb_fnr](index.html) module"]
pub struct USB_FNR_SPEC;
impl crate::RegisterSpec for USB_FNR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usb_fnr::R](R) reader structure"]
impl crate::Readable for USB_FNR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets USB_FNR to value 0"]
impl crate::Resettable for USB_FNR_SPEC {
