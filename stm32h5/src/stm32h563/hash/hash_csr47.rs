...
#[doc = "Field `CSx` reader - Context swap 47 Refer to introduction."]
pub type CSX_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSx` writer - Context swap 47 Refer to introduction."]
pub type CSX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HASH_CSR47_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Context swap 47 Refer to introduction."]
    #[inline(always)]
...
#[doc = "`reset()` method sets HASH_CSR47 to value 0x0022_0002"]
