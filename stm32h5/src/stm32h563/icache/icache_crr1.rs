#[doc = "Register `ICACHE_CRR1` reader"]
pub struct R(crate::R<ICACHE_CRR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ICACHE_CRR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ICACHE_CRR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ICACHE_CRR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ICACHE_CRR1` writer"]
pub struct W(crate::W<ICACHE_CRR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ICACHE_CRR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ICACHE_CRR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ICACHE_CRR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BASEADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ICACHE_CRR1_SPEC, u8, u8, 8, O>;
#[doc = "Field `RSIZE` reader - size for region x"]
pub type RSIZE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RSIZE` writer - size for region x"]
pub type RSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ICACHE_CRR1_SPEC, u8, u8, 3, O>;
#[doc = "Field `REN` reader - enable for region x"]
pub type REN_R = crate::BitReader<bool>;
#[doc = "Field `REN` writer - enable for region x"]
pub type REN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICACHE_CRR1_SPEC, bool, O>;
...
pub type REMAPADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ICACHE_CRR1_SPEC, u16, u16, 11, O>;
...
pub type MSTSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICACHE_CRR1_SPEC, bool, O>;
...
pub type HBURST_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICACHE_CRR1_SPEC, bool, O>;
impl R {
...
#[doc = "ICACHE region 1 configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [icache_crr1](index.html) module"]
pub struct ICACHE_CRR1_SPEC;
impl crate::RegisterSpec for ICACHE_CRR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [icache_crr1::R](R) reader structure"]
impl crate::Readable for ICACHE_CRR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [icache_crr1::W](W) writer structure"]
impl crate::Writable for ICACHE_CRR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ICACHE_CRR1 to value 0x0200"]
impl crate::Resettable for ICACHE_CRR1_SPEC {
