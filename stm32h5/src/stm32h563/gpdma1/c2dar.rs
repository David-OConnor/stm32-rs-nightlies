...
pub struct R(crate::R<C2DAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C2DAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C2DAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C2DAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C2DAR` writer"]
pub struct W(crate::W<C2DAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C2DAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C2DAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C2DAR_SPEC>) -> Self {
        W(writer)
    }
}
...
In linked-list mode, after a LLI data transfer is completed, this register is automatically updated by the GPDMA from the memory, provided the LLI is set with GPDMA_CxLLR.UDA = 1. Note: A destination address must be aligned with the programmed data width of a destination burst (DA\\[2:0\\]
versus GPDMA_CxTR1.DDW_LOG2\\[1:0\\]). Else, a user setting error is reported and no transfer is issued."]
pub type DA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C2DAR_SPEC, u32, u32, 32, O>;
impl R {
