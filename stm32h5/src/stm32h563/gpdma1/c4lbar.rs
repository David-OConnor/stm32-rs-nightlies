...
pub struct R(crate::R<C4LBAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C4LBAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C4LBAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C4LBAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C4LBAR` writer"]
pub struct W(crate::W<C4LBAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C4LBAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C4LBAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C4LBAR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LBA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C4LBAR_SPEC, u16, u16, 16, O>;
impl R {
