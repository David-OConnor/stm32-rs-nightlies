...
pub struct R(crate::R<C1SR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C1SR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C1SR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C1SR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPDMA channel 1 status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c1sr](index.html) module"]
