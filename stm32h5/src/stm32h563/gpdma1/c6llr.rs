...
pub struct R(crate::R<C6LLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C6LLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C6LLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C6LLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C6LLR` writer"]
pub struct W(crate::W<C6LLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C6LLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C6LLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C6LLR_SPEC>) -> Self {
        W(writer)
    }
}
...
= 0, the current LLI is the last one. The channel transfer is completed without any update of the linked-list GPDMA register file. Else, this field is the pointer to the memory address offset from which the next linked-list data structure is automatically fetched from, once the data transfer is completed, in order to conditionally update the linked-list GPDMA internal register file (GPDMA_CxCTR1, GPDMA_CxTR2, GPDMA_CxBR1, GPDMA_CxSAR, GPDMA_CxDAR and GPDMA_CxLLR). Note: The user must program the pointer to be 32-bit aligned. The two low-significant bits are write ignored."]
pub type LA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C6LLR_SPEC, u16, u16, 14, O>;
...
pub type ULL_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
pub type UB2_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
pub type UT3_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
pub type UDA_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
pub type USA_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
is then restored to the programmed value after data transfer is completed and before the link transfer."]
pub type UB1_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
pub type UT2_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
...
pub type UT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, C6LLR_SPEC, bool, O>;
impl R {
