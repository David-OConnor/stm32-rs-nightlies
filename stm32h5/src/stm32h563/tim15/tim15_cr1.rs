#[doc = "Register `TIM15_CR1` reader"]
pub struct R(crate::R<TIM15_CR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM15_CR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM15_CR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM15_CR1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM15_CR1` writer"]
pub struct W(crate::W<TIM15_CR1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM15_CR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM15_CR1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM15_CR1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
...
pub type UDIS_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
...
pub type URS_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
#[doc = "Field `OPM` reader - One-pulse mode"]
pub type OPM_R = crate::BitReader<bool>;
#[doc = "Field `OPM` writer - One-pulse mode"]
pub type OPM_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
...
pub type ARPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
#[doc = "Field `CKD` reader - Clock division This bitfield indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tDTS) used by the dead-time generators and the digital filters (tim_tix)"]
pub type CKD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CKD` writer - Clock division This bitfield indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tDTS) used by the dead-time generators and the digital filters (tim_tix)"]
pub type CKD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TIM15_CR1_SPEC, u8, u8, 2, O>;
...
pub type UIFREMAP_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
...
pub type DITHEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM15_CR1_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bits 8:9 - Clock division This bitfield indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tDTS) used by the dead-time generators and the digital filters (tim_tix)"]
    #[inline(always)]
...
#[doc = "TIM15 control register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim15_cr1](index.html) module"]
pub struct TIM15_CR1_SPEC;
impl crate::RegisterSpec for TIM15_CR1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [tim15_cr1::R](R) reader structure"]
impl crate::Readable for TIM15_CR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim15_cr1::W](W) writer structure"]
impl crate::Writable for TIM15_CR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM15_CR1 to value 0"]
impl crate::Resettable for TIM15_CR1_SPEC {
