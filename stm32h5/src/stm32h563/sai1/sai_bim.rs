...
pub type OVRUDRIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
...
pub type MUTEDETIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
...
= 0) and NODIV = 0. It generates an interrupt if the WCKCFG flag in the SAI_xSR register is set. Note: This bit is used only in Free protocol mode and is meaningless in other modes."]
pub type WCKCFGIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
...
pub type FREQIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
...
bits and the audio block is operates as a receiver."]
pub type CNRDYIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
...
pub type AFSDETIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
...
pub type LFSDETIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SAI_BIM_SPEC, bool, O>;
impl R {
