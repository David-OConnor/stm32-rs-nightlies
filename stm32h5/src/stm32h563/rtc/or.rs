...
#[doc = "Field `OUT2_RMP` reader - RTC_OUT2 mapping"]
pub type OUT2_RMP_R = crate::BitReader<bool>;
#[doc = "Field `OUT2_RMP` writer - RTC_OUT2 mapping"]
pub type OUT2_RMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - RTC_OUT2 mapping"]
    #[inline(always)]
