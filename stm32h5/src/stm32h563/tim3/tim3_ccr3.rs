...
pub struct R(crate::R<TIM3_CCR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM3_CCR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM3_CCR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM3_CCR3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM3_CCR3` writer"]
pub struct W(crate::W<TIM3_CCR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM3_CCR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM3_CCR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM3_CCR3_SPEC>) -> Self {
        W(writer)
    }
}
...
bits are reserved. Dithering mode (DITHEN = 1) The register holds the capture in CCR3\\[19:0\\]. The CCR3\\[3:0\\]
bits are reset."]
pub type CCR3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM3_CCR3_SPEC, u32, u32, 20, O>;
impl R {
...
#[doc = "TIM3 capture/compare register 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim3_ccr3](index.html) module"]
pub struct TIM3_CCR3_SPEC;
impl crate::RegisterSpec for TIM3_CCR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim3_ccr3::R](R) reader structure"]
impl crate::Readable for TIM3_CCR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim3_ccr3::W](W) writer structure"]
impl crate::Writable for TIM3_CCR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM3_CCR3 to value 0"]
impl crate::Resettable for TIM3_CCR3_SPEC {
