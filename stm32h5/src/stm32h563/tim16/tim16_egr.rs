#[doc = "Register `TIM16_EGR` writer"]
pub struct W(crate::W<TIM16_EGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM16_EGR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<TIM16_EGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM16_EGR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UG` writer - Update generation This bit can be set by software, it is automatically cleared by hardware."]
pub type UG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM16_EGR_SPEC, bool, O>;
...
pub type CC1G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM16_EGR_SPEC, bool, O>;
...
pub type COMG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM16_EGR_SPEC, bool, O>;
...
pub type BG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM16_EGR_SPEC, bool, O>;
impl W {
...
#[doc = "TIM16 event generation register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim16_egr](index.html) module"]
pub struct TIM16_EGR_SPEC;
impl crate::RegisterSpec for TIM16_EGR_SPEC {
    type Ux = u16;
}
#[doc = "`write(|w| ..)` method takes [tim16_egr::W](W) writer structure"]
impl crate::Writable for TIM16_EGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM16_EGR to value 0"]
impl crate::Resettable for TIM16_EGR_SPEC {
