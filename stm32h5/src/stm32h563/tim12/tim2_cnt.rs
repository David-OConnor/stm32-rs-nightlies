...
#[doc = "Field `CNT` reader - or UIFCPY: Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 nullMost significant bit of counter value If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register nullLeast significant part of counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register holds the non-dithered part in CNT\\[30:0\\]. The fractional part is not available."]
pub type CNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CNT` writer - or UIFCPY: Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 nullMost significant bit of counter value If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register nullLeast significant part of counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register holds the non-dithered part in CNT\\[30:0\\]. The fractional part is not available."]
pub type CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM2_CNT_SPEC, u16, u16, 16, O>;
#[doc = "Field `UIFCPY` reader - UIF Copy"]
pub type UIFCPY_R = crate::BitReader<bool>;
#[doc = "Field `UIFCPY` writer - UIF Copy"]
pub type UIFCPY_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM2_CNT_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:15 - or UIFCPY: Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 nullMost significant bit of counter value If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register nullLeast significant part of counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register holds the non-dithered part in CNT\\[30:0\\]. The fractional part is not available."]
    #[inline(always)]
...
#[doc = "`read()` method returns [tim2_cnt::R](R) reader structure"]
impl crate::Readable for TIM2_CNT_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim2_cnt::W](W) writer structure"]
impl crate::Writable for TIM2_CNT_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM2_CNT to value 0"]
