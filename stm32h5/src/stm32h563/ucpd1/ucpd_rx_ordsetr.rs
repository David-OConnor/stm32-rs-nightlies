#[doc = "Register `UCPD_RX_ORDSETR` reader"]
pub struct R(crate::R<UCPD_RX_ORDSETR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCPD_RX_ORDSETR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCPD_RX_ORDSETR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCPD_RX_ORDSETR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "UCPD Rx ordered set register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ucpd_rx_ordsetr](index.html) module"]
pub struct UCPD_RX_ORDSETR_SPEC;
impl crate::RegisterSpec for UCPD_RX_ORDSETR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ucpd_rx_ordsetr::R](R) reader structure"]
impl crate::Readable for UCPD_RX_ORDSETR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UCPD_RX_ORDSETR to value 0"]
impl crate::Resettable for UCPD_RX_ORDSETR_SPEC {
