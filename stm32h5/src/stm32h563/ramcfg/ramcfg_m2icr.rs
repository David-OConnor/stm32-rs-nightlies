#[doc = "Register `RAMCFG_M2ICR` reader"]
pub struct R(crate::R<RAMCFG_M2ICR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAMCFG_M2ICR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAMCFG_M2ICR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAMCFG_M2ICR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RAMCFG_M2ICR` writer"]
pub struct W(crate::W<RAMCFG_M2ICR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAMCFG_M2ICR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAMCFG_M2ICR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAMCFG_M2ICR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CSEDC_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAMCFG_M2ICR_SPEC, bool, O>;
...
pub type CDED_W<'a, const O: u8> = crate::BitWriter<'a, u32, RAMCFG_M2ICR_SPEC, bool, O>;
impl R {
...
#[doc = "RAMCFG memory 2 interrupt clear register 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ramcfg_m2icr](index.html) module"]
pub struct RAMCFG_M2ICR_SPEC;
impl crate::RegisterSpec for RAMCFG_M2ICR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ramcfg_m2icr::R](R) reader structure"]
impl crate::Readable for RAMCFG_M2ICR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ramcfg_m2icr::W](W) writer structure"]
impl crate::Writable for RAMCFG_M2ICR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RAMCFG_M2ICR to value 0"]
impl crate::Resettable for RAMCFG_M2ICR_SPEC {
