...
pub struct R(crate::R<TIM1_SMCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM1_SMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM1_SMCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM1_SMCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM1_SMCR` writer"]
pub struct W(crate::W<TIM1_SMCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM1_SMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM1_SMCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM1_SMCR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SMS` reader - SMS\\[2:0\\]: Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo or the tim_trgo2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer."]
pub type SMS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SMS` writer - SMS\\[2:0\\]: Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo or the tim_trgo2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer."]
pub type SMS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_SMCR_SPEC, u8, u8, 3, O>;
...
pub type OCCS_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
#[doc = "Field `TS` reader - TS\\[2:0\\]: Trigger selection This bitfield is combined with TS\\[4:3\\]
...
#[doc = "Field `TS` writer - TS\\[2:0\\]: Trigger selection This bitfield is combined with TS\\[4:3\\]
bits. This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See Table 605: TIMx internal trigger connection for more details on tim_itrx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition."]
pub type TS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_SMCR_SPEC, u8, u8, 3, O>;
#[doc = "Field `MSM` reader - Master/slave mode"]
pub type MSM_R = crate::BitReader<bool>;
#[doc = "Field `MSM` writer - Master/slave mode"]
pub type MSM_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
...
pub type ETF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_SMCR_SPEC, u8, u8, 4, O>;
...
pub type ETPS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_SMCR_SPEC, u8, u8, 2, O>;
...
pub type ECE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
...
pub type ETP_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
#[doc = "Field `SMS_1` reader - SMS\\[3\\]"]
pub type SMS_1_R = crate::BitReader<bool>;
#[doc = "Field `SMS_1` writer - SMS\\[3\\]"]
pub type SMS_1_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
#[doc = "Field `TS_1` reader - TS\\[4:3\\]"]
pub type TS_1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TS_1` writer - TS\\[4:3\\]"]
pub type TS_1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM1_SMCR_SPEC, u8, u8, 2, O>;
...
bitfield is preloaded"]
pub type SMSPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
...
bitfield transfer from preload to active"]
pub type SMSPS_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM1_SMCR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:2 - SMS\\[2:0\\]: Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo or the tim_trgo2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer."]
    #[inline(always)]
    ...
    #[doc = "Bits 4:6 - TS\\[2:0\\]: Trigger selection This bitfield is combined with TS\\[4:3\\]
bits. This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See Table 605: TIMx internal trigger connection for more details on tim_itrx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition."]
    #[inline(always)]
    pub fn ts(&self) -> TS_R {
