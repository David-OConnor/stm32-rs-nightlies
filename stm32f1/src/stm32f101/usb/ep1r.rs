...
pub type EA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, EP1R_SPEC, u8, u8, 4, O>;
...
pub type STAT_TX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EP1R_SPEC, u8, STAT_TXR_A, 2, O>;
...
pub type DTOG_TX_W<'a, const O: u8> = crate::BitWriter1T<'a, u32, EP1R_SPEC, bool, O>;
...
pub type CTR_TX_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, EP1R_SPEC, bool, O>;
...
pub type EP_TYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EP1R_SPEC, u8, EP_TYPE_A, 2, O>;
...
pub type STAT_RX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EP1R_SPEC, u8, STAT_RXR_A, 2, O>;
...
pub type DTOG_RX_W<'a, const O: u8> = crate::BitWriter1T<'a, u32, EP1R_SPEC, bool, O>;
...
pub type CTR_RX_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, EP1R_SPEC, bool, O>;
impl R {
