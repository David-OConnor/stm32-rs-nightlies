...
pub type PINRSTF_R = crate::BitReader<PINRSTFR_A>;
#[doc = "PIN reset flag\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum PINRSTFR_A {
...
impl From<PINRSTFR_A> for bool {
    #[inline(always)]
    fn from(variant: PINRSTFR_A) -> Self {
        variant as u8 != 0
    }
}
impl PINRSTF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PINRSTFR_A {
        match self.bits {
            false => PINRSTFR_A::NoReset,
            true => PINRSTFR_A::Reset,
        }
    }
    #[doc = "Checks if the value of the field is `NoReset`"]
    #[inline(always)]
    pub fn is_no_reset(&self) -> bool {
        *self == PINRSTFR_A::NoReset
    }
    #[doc = "Checks if the value of the field is `Reset`"]
    #[inline(always)]
    pub fn is_reset(&self) -> bool {
        *self == PINRSTFR_A::Reset
    }
}
#[doc = "Field `PINRSTF` writer - PIN reset flag"]
pub type PINRSTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, PINRSTFR_A, O>;
impl<'a, const O: u8> PINRSTF_W<'a, O> {
    #[doc = "No reset has occured"]
    #[inline(always)]
    pub fn no_reset(self) -> &'a mut W {
        self.variant(PINRSTFR_A::NoReset)
    }
    #[doc = "A reset has occured"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(PINRSTFR_A::Reset)
    }
}
