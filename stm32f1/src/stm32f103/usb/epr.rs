...
pub type EA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, EPR_SPEC, u8, u8, 4, O>;
...
pub type STAT_TX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPR_SPEC, u8, STAT_TXR_A, 2, O>;
...
pub type DTOG_TX_W<'a, const O: u8> = crate::BitWriter1T<'a, u32, EPR_SPEC, bool, O>;
...
pub type CTR_TX_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, EPR_SPEC, bool, O>;
#[doc = "Field `EP_KIND` reader - Endpoint kind"]
pub type EP_KIND_R = crate::BitReader<bool>;
#[doc = "Field `EP_KIND` writer - Endpoint kind"]
pub type EP_KIND_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPR_SPEC, bool, O>;
...
pub type EP_TYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPR_SPEC, u8, EP_TYPE_A, 2, O>;
...
pub type SETUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, EPR_SPEC, bool, O>;
...
pub type STAT_RX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EPR_SPEC, u8, STAT_RXR_A, 2, O>;
...
pub type DTOG_RX_W<'a, const O: u8> = crate::BitWriter1T<'a, u32, EPR_SPEC, bool, O>;
...
pub type CTR_RX_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, EPR_SPEC, bool, O>;
impl R {
