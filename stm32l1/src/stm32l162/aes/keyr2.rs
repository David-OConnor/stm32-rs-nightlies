...
#[doc = "Field `KEYR2` reader - AES key"]
pub type KEYR2_R = crate::FieldReader<u32, u32>;
#[doc = "Field `KEYR2` writer - AES key"]
pub type KEYR2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, KEYR2_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn keyr2(&mut self) -> KEYR2_W<0> {
        KEYR2_W::new(self)
    }
