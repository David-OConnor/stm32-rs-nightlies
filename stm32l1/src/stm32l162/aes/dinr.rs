...
#[doc = "Field `DINR` reader - Data input"]
pub type DINR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DINR` writer - Data input"]
pub type DINR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DINR_SPEC, u32, u32, 32, O>;
impl R {
