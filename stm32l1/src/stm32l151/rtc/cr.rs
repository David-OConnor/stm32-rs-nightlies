...
#[doc = "Field `REFCKON` reader - Reference clock detection enable"]
pub type REFCKON_R = crate::BitReader<bool>;
#[doc = "Field `REFCKON` writer - Reference clock detection enable"]
...
#[doc = "Field `SUB1H` reader - Subtract 1 hour"]
pub type SUB1H_R = crate::BitReader<bool>;
#[doc = "Field `SUB1H` writer - Subtract 1 hour"]
