...
pub struct R(crate::R<SQR5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SQR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SQR5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SQR5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SQR5` writer"]
pub struct W(crate::W<SQR5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SQR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SQR5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SQR5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SQ1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR5_SPEC, u8, u8, 5, O>;
...
pub type SQ2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR5_SPEC, u8, u8, 5, O>;
...
pub type SQ3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR5_SPEC, u8, u8, 5, O>;
...
pub type SQ4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR5_SPEC, u8, u8, 5, O>;
...
pub type SQ5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR5_SPEC, u8, u8, 5, O>;
...
pub type SQ6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR5_SPEC, u8, u8, 5, O>;
impl R {
