...
pub type SQ7_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
...
pub type SQ8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
...
pub type SQ9_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
...
pub type SQ10_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
...
pub type SQ11_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
...
pub type SQ12_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SQR4_SPEC, u8, u8, 5, O>;
impl R {
