...
pub type KEYR1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `KEYR1` writer - AES key"]
pub type KEYR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, KEYR1_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn keyr1(&mut self) -> KEYR1_W<0> {
        KEYR1_W::new(self)
    }
