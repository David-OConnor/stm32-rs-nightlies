#[doc = "Register `RAM_COM5` reader"]
pub struct R(crate::R<RAM_COM5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAM_COM5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAM_COM5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAM_COM5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RAM_COM5` writer"]
pub struct W(crate::W<RAM_COM5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RAM_COM5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RAM_COM5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RAM_COM5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "display memory\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ram_com5](index.html) module"]
pub struct RAM_COM5_SPEC;
impl crate::RegisterSpec for RAM_COM5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ram_com5::R](R) reader structure"]
impl crate::Readable for RAM_COM5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ram_com5::W](W) writer structure"]
impl crate::Writable for RAM_COM5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RAM_COM5 to value 0"]
impl crate::Resettable for RAM_COM5_SPEC {
