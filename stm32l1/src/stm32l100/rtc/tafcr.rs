...
#[doc = "Field `TAMP1ETRG` reader - Active level for tamper 1"]
pub type TAMP1ETRG_R = crate::BitReader<bool>;
#[doc = "Field `TAMP1ETRG` writer - Active level for tamper 1"]
...
#[doc = "Field `TAMP3E` reader - TIMESTAMP mapping"]
pub type TAMP3E_R = crate::BitReader<bool>;
#[doc = "Field `TAMP3E` writer - TIMESTAMP mapping"]
pub type TAMP3E_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAFCR_SPEC, bool, O>;
#[doc = "Field `TAMP3TRG` reader - TAMPER1 mapping"]
pub type TAMP3TRG_R = crate::BitReader<bool>;
#[doc = "Field `TAMP3TRG` writer - TAMPER1 mapping"]
