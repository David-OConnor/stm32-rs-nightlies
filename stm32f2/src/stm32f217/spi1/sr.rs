...
pub type TIFRFE_R = crate::BitReader<TIFRFER_A>;
...
impl From<TIFRFER_A> for bool {
    #[inline(always)]
    fn from(variant: TIFRFER_A) -> Self {
        variant as u8 != 0
    }
}
impl TIFRFE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TIFRFER_A {
        match self.bits {
            false => TIFRFER_A::NoError,
            true => TIFRFER_A::Error,
        }
    }
    #[doc = "Checks if the value of the field is `NoError`"]
    #[inline(always)]
    pub fn is_no_error(&self) -> bool {
        *self == TIFRFER_A::NoError
    }
    #[doc = "Checks if the value of the field is `Error`"]
    #[inline(always)]
    pub fn is_error(&self) -> bool {
        *self == TIFRFER_A::Error
    }
}
impl R {
