...
pub type PREDIV_S_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PRER_SPEC, u16, u16, 13, O>;
...
impl R {
    #[doc = "Bits 0:12 - Synchronous prescaler factor"]
    #[inline(always)]
    pub fn prediv_s(&self) -> PREDIV_S_R {
        PREDIV_S_R::new((self.bits & 0x1fff) as u16)
    }
