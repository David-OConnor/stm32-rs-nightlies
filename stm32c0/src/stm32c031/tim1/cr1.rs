...
pub type CEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
...
pub type UDIS_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
...
pub type URS_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
#[doc = "Field `OPM` reader - One pulse mode"]
pub type OPM_R = crate::BitReader<bool>;
#[doc = "Field `OPM` writer - One pulse mode"]
pub type OPM_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
...
pub type CMS_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CR1_SPEC, u8, u8, 2, O>;
...
pub type ARPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
#[doc = "Field `CKD` reader - Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (ETR, TIx): Note: tDTS = 1/fDTS, tCK_INT = 1/fCK_INT."]
pub type CKD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CKD` writer - Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (ETR, TIx): Note: tDTS = 1/fDTS, tCK_INT = 1/fCK_INT."]
pub type CKD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CR1_SPEC, u8, u8, 2, O>;
...
pub type UIFREMAP_W<'a, const O: u8> = crate::BitWriter<'a, u16, CR1_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bits 8:9 - Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (ETR, TIx): Note: tDTS = 1/fDTS, tCK_INT = 1/fCK_INT."]
    #[inline(always)]
