...
= 0 or I2SDIV \\[7:0\\]
= 1 are forbidden values. Refer to . Note: These bits should be configured when the I2S is disabled. They are used only when the I2S is in master mode. They are not used in SPI mode."]
pub type I2SDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u16, I2SPR_SPEC, u8, u8, 8, O>;
...
pub type ODD_W<'a, const O: u8> = crate::BitWriter<'a, u16, I2SPR_SPEC, bool, O>;
...
pub type MCKOE_W<'a, const O: u8> = crate::BitWriter<'a, u16, I2SPR_SPEC, bool, O>;
impl R {
