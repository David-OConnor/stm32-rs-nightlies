...
#[doc = "Field `SYSCFGEN` reader - SYSCFG clock enable Set and cleared by software."]
pub type SYSCFGEN_R = crate::BitReader<bool>;
#[doc = "Field `SYSCFGEN` writer - SYSCFG clock enable Set and cleared by software."]
...
#[doc = "Field `TIM14EN` reader - TIM14 timer clock enable Set and cleared by software."]
pub type TIM14EN_R = crate::BitReader<bool>;
#[doc = "Field `TIM14EN` writer - TIM14 timer clock enable Set and cleared by software."]
...
#[doc = "Field `TIM17EN` reader - TIM16 timer clock enable Set and cleared by software."]
pub type TIM17EN_R = crate::BitReader<bool>;
#[doc = "Field `TIM17EN` writer - TIM16 timer clock enable Set and cleared by software."]
...
impl R {
    #[doc = "Bit 0 - SYSCFG clock enable Set and cleared by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - TIM14 timer clock enable Set and cleared by software."]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - TIM16 timer clock enable Set and cleared by software."]
    #[inline(always)]
