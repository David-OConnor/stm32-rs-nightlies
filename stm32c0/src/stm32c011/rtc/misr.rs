...
#[doc = "Field `TSMF` reader - Timestamp masked flag This flag is set by hardware when a timestamp interrupt occurs."]
...
impl R {
    ...
    #[doc = "Bit 3 - Timestamp masked flag This flag is set by hardware when a timestamp interrupt occurs."]
    #[inline(always)]
