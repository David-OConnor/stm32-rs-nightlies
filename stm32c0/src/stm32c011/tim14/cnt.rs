...
#[doc = "Field `UIFCPY` reader - UIF Copy This bit is a read-only copy of the UIF bit in the TIMx_ISR register."]
pub type UIFCPY_R = crate::BitReader<bool>;
#[doc = "Field `UIFCPY` writer - UIF Copy This bit is a read-only copy of the UIF bit in the TIMx_ISR register."]
...
impl R {
    ...
    #[doc = "Bit 31 - UIF Copy This bit is a read-only copy of the UIF bit in the TIMx_ISR register."]
    #[inline(always)]
