...
#[doc = "Field `I2S1SEL` reader - I2S1 clock source selection This bitfield is controlled by software to select I2S1 clock source as follows:"]
pub type I2S1SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `I2S1SEL` writer - I2S1 clock source selection This bitfield is controlled by software to select I2S1 clock source as follows:"]
...
impl R {
    ...
    #[doc = "Bits 14:15 - I2S1 clock source selection This bitfield is controlled by software to select I2S1 clock source as follows:"]
    #[inline(always)]
    pub fn i2s1sel(&self) -> I2S1SEL_R {
        I2S1SEL_R::new(((self.bits >> 14) & 3) as u8)
    }
    #[doc = "Bits 30:31 - ADCs clock source selection This bitfield is controlled by software to select the clock source for ADC:"]
    #[inline(always)]
