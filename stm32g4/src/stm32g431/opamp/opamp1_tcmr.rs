...
pub type VMS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_TCMR_SPEC, bool, O>;
...
pub type VPS_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPAMP1_TCMR_SPEC, u8, VPS_SEL_A, 2, O>;
...
pub type T1CM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_TCMR_SPEC, T1CM_EN_A, O>;
...
pub type T8CM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_TCMR_SPEC, T8CM_EN_A, O>;
...
pub type T20CM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_TCMR_SPEC, T20CM_EN_A, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_TCMR_SPEC, LOCK_A, O>;
