...
#[doc = "Field `CRSEN` reader - CRSclock enable"]
...
#[doc = "Field `USBEN` reader - USB device clock enable"]
pub use TIM2EN_R as USBEN_R;
#[doc = "Field `FDCANEN` reader - FDCAN clock enable"]
...
#[doc = "Field `CRSEN` writer - CRSclock enable"]
...
#[doc = "Field `USBEN` writer - USB device clock enable"]
pub use TIM2EN_W as USBEN_W;
#[doc = "Field `FDCANEN` writer - FDCAN clock enable"]
...
impl R {
    ...
    #[doc = "Bit 23 - USB device clock enable"]
    #[inline(always)]
    pub fn usben(&self) -> USBEN_R {
        USBEN_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 25 - FDCAN clock enable"]
    #[inline(always)]
