...
#[doc = "Field `CRSSMEN` reader - CRS clock enable during sleep mode"]
pub type CRSSMEN_R = crate::BitReader<bool>;
#[doc = "Field `CRSSMEN` writer - CRS clock enable during sleep mode"]
pub type CRSSMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1SMENR1_SPEC, bool, O>;
...
#[doc = "Field `USBSMEN` reader - USB device clocks enable during Sleep and Stop modes"]
pub type USBSMEN_R = crate::BitReader<bool>;
#[doc = "Field `USBSMEN` writer - USB device clocks enable during Sleep and Stop modes"]
pub type USBSMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1SMENR1_SPEC, bool, O>;
...
pub type FDCANSMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1SMENR1_SPEC, bool, O>;
...
#[doc = "Field `LPTIM1SMEN` reader - Low Power Timer1 clock enable during sleep mode"]
pub type LPTIM1SMEN_R = crate::BitReader<bool>;
#[doc = "Field `LPTIM1SMEN` writer - Low Power Timer1 clock enable during sleep mode"]
...
#[doc = "`reset()` method sets APB1SMENR1 to value 0xd2fe_cd3f"]
