...
pub struct R(crate::R<C5CSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C5CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C5CSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C5CSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `C5CSR` writer"]
pub struct W(crate::W<C5CSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C5CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C5CSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C5CSR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, C5CSR_SPEC, bool, O>;
