...
pub type VMS_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP3_TCMR_SPEC, bool, O>;
...
impl VPS_SEL_R {
    ...
    pub fn is_dac3_ch2(&self) -> bool {
        *self == VPS_SEL_A::Dac3Ch2
    }
}
#[doc = "Field `VPS_SEL` writer - VPS_SEL"]
pub type VPS_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPAMP3_TCMR_SPEC, u8, VPS_SEL_A, 2, O>;
impl<'a, const O: u8> VPS_SEL_W<'a, O> {
    ...
    pub fn dac3_ch2(self) -> &'a mut W {
        self.variant(VPS_SEL_A::Dac3Ch2)
    }
}
...
pub type T1CM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP3_TCMR_SPEC, T1CM_EN_A, O>;
...
pub type T8CM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP3_TCMR_SPEC, T8CM_EN_A, O>;
...
pub type T20CM_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP3_TCMR_SPEC, T20CM_EN_A, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP3_TCMR_SPEC, LOCK_A, O>;
