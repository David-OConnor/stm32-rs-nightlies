...
pub type ADDSET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BTR1_SPEC, u8, u8, 4, O>;
...
pub type BUSTURN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BTR1_SPEC, u8, u8, 4, O>;
...
pub type DATLAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BTR1_SPEC, u8, u8, 4, O>;
#[doc = "Field `ACCMOD` reader - ACCMOD"]
pub type ACCMOD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ACCMOD` writer - ACCMOD"]
pub type ACCMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BTR1_SPEC, u8, u8, 2, O>;
#[doc = "Field `DATAHLD` reader - DATAHLD"]
pub type DATAHLD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATAHLD` writer - DATAHLD"]
pub type DATAHLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BTR1_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:3 - ADDSET"]
    #[inline(always)]
