...
pub type FORCE_VP_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_CSR_SPEC, FORCE_VP_A, O>;
...
pub type VP_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPAMP1_CSR_SPEC, u8, VP_SEL_A, 2, O>;
...
pub type VM_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPAMP1_CSR_SPEC, u8, VM_SEL_A, 2, O>;
...
pub type OPAHSM_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_CSR_SPEC, OPAHSM_A, O>;
...
pub type OPAINTOEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_CSR_SPEC, OPAINTOEN_A, O>;
...
pub type CALSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPAMP1_CSR_SPEC, u8, CALSEL_A, 2, O>;
...
pub type PGA_GAIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OPAMP1_CSR_SPEC, u8, PGA_GAIN_A, 5, O>;
...
pub type TRIMOFFSETP_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, OPAMP1_CSR_SPEC, u8, u8, 5, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPAMP1_CSR_SPEC, LOCK_A, O>;
