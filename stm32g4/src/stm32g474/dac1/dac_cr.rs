...
pub type TSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAC_CR_SPEC, u8, u8, 4, O>;
...
pub type TSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAC_CR_SPEC, u8, u8, 4, O>;
