...
pub type CK_PSCX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMCCR_SPEC, u8, u8, 3, O>;
#[doc = "Field `CONT` reader - Continuous mode"]
pub type CONT_R = crate::BitReader<bool>;
#[doc = "Field `CONT` writer - Continuous mode"]
pub type CONT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type RETRIG_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
#[doc = "Field `HALF` reader - Half mode enable"]
pub type HALF_R = crate::BitReader<bool>;
#[doc = "Field `HALF` writer - Half mode enable"]
pub type HALF_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type PSHPLL_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type INTLVD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMCCR_SPEC, u8, u8, 2, O>;
...
pub type RSYNCU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type SYNCRSTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type SYNCSTRTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type DELCMP2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMCCR_SPEC, u8, u8, 2, O>;
...
pub type DELCMP4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMCCR_SPEC, u8, u8, 2, O>;
#[doc = "Field `TFU` reader - TFU"]
pub type TFU_R = crate::BitReader<bool>;
#[doc = "Field `TFU` writer - TFU"]
pub type TFU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
...
pub type TX_REPU_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIMCCR_SPEC, bool, O>;
