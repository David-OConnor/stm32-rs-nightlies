...
pub type OIS4N_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR2_SPEC, bool, O>;
...
pub type MMS_3_R = crate::BitReader<bool>;
#[doc = "Field `MMS_3` writer - Master mode selection - bit 3"]
pub type MMS_3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR2_SPEC, bool, O>;
impl R {
