...
pub type WRP1B_STRT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRP1BR_SPEC, u8, u8, 7, O>;
...
pub type WRP1B_END_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRP1BR_SPEC, u8, u8, 7, O>;
impl R {
