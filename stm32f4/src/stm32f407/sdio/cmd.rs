...
pub type N_IEN_R = crate::BitReader<N_IEN_A>;
...
impl From<N_IEN_A> for bool {
    #[inline(always)]
    fn from(variant: N_IEN_A) -> Self {
        variant as u8 != 0
    }
}
impl N_IEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> N_IEN_A {
        match self.bits {
            false => N_IEN_A::Disabled,
            true => N_IEN_A::Enabled,
        }
    }
    #[doc = "Checks if the value of the field is `Disabled`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == N_IEN_A::Disabled
    }
    #[doc = "Checks if the value of the field is `Enabled`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == N_IEN_A::Enabled
    }
}
#[doc = "Field `nIEN` writer - not Interrupt Enable"]
pub type N_IEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMD_SPEC, N_IEN_A, O>;
impl<'a, const O: u8> N_IEN_W<'a, O> {
    #[doc = "Interrupts to the CE-ATA not disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(N_IEN_A::Disabled)
    }
    #[doc = "Interrupt to the CE-ATA are disabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(N_IEN_A::Enabled)
    }
}
