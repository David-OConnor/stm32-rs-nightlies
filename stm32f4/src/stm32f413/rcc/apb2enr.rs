...
pub use TIM1EN_R as UART10EN_R;
...
pub use TIM1EN_R as DFSDM2EN_R;
...
pub use TIM1EN_W as UART10EN_W;
...
pub use TIM1EN_W as DFSDM2EN_W;
impl R {
    ...
    pub fn uart10en(&self) -> UART10EN_R {
        UART10EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    pub fn dfsdm2en(&self) -> DFSDM2EN_R {
        DFSDM2EN_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIM1 clock enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart10en(&mut self) -> UART10EN_W<7> {
        UART10EN_W::new(self)
    }
    #[doc = "Bit 8 - ADC1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dfsdm2en(&mut self) -> DFSDM2EN_W<25> {
        DFSDM2EN_W::new(self)
    }
