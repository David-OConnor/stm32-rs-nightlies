...
pub type BORRSTF_R = crate::BitReader<BORRSTFR_A>;
#[doc = "BOR reset flag\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum BORRSTFR_A {
...
impl From<BORRSTFR_A> for bool {
    #[inline(always)]
    fn from(variant: BORRSTFR_A) -> Self {
        variant as u8 != 0
    }
}
impl BORRSTF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> BORRSTFR_A {
        match self.bits {
            false => BORRSTFR_A::NoReset,
            true => BORRSTFR_A::Reset,
        }
    }
    #[doc = "Checks if the value of the field is `NoReset`"]
    #[inline(always)]
    pub fn is_no_reset(&self) -> bool {
        *self == BORRSTFR_A::NoReset
    }
    #[doc = "Checks if the value of the field is `Reset`"]
    #[inline(always)]
    pub fn is_reset(&self) -> bool {
        *self == BORRSTFR_A::Reset
    }
}
#[doc = "Field `BORRSTF` writer - BOR reset flag"]
pub type BORRSTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CSR_SPEC, BORRSTFR_A, O>;
impl<'a, const O: u8> BORRSTF_W<'a, O> {
    #[doc = "No reset has occured"]
    #[inline(always)]
    pub fn no_reset(self) -> &'a mut W {
        self.variant(BORRSTFR_A::NoReset)
    }
    #[doc = "A reset has occured"]
    #[inline(always)]
    pub fn reset(self) -> &'a mut W {
        self.variant(BORRSTFR_A::Reset)
    }
}
