...
pub type SAIEN_R = crate::BitReader<SAIAEN_A>;
...
impl From<SAIAEN_A> for bool {
    #[inline(always)]
    fn from(variant: SAIAEN_A) -> Self {
        variant as u8 != 0
    }
}
impl SAIEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SAIAEN_A {
        match self.bits {
            false => SAIAEN_A::Disabled,
            true => SAIAEN_A::Enabled,
        }
    }
    #[doc = "Checks if the value of the field is `Disabled`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == SAIAEN_A::Disabled
    }
    #[doc = "Checks if the value of the field is `Enabled`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == SAIAEN_A::Enabled
    }
}
#[doc = "Field `SAIEN` writer - Audio block enable"]
pub type SAIEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, SAIAEN_A, O>;
impl<'a, const O: u8> SAIEN_W<'a, O> {
    #[doc = "SAI audio block disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SAIAEN_A::Disabled)
    }
    #[doc = "SAI audio block enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(SAIAEN_A::Enabled)
    }
}
