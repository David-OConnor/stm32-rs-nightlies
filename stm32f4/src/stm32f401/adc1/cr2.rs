...
impl JEXTSEL_R {
    ...
    pub fn variant(&self) -> Option<JEXTSEL_A> {
        match self.bits {
            ...
            2 => Some(JEXTSEL_A::Tim2cc1),
            3 => Some(JEXTSEL_A::Tim2trgo),
            4 => Some(JEXTSEL_A::Tim3cc2),
            5 => Some(JEXTSEL_A::Tim3cc4),
            6 => Some(JEXTSEL_A::Tim4cc1),
            7 => Some(JEXTSEL_A::Tim4cc2),
            8 => Some(JEXTSEL_A::Tim4cc3),
            9 => Some(JEXTSEL_A::Tim4trgo),
...
impl EXTSEL_R {
    ...
    pub fn variant(&self) -> Option<EXTSEL_A> {
        match self.bits {
            ...
            7 => Some(EXTSEL_A::Tim3cc1),
            8 => Some(EXTSEL_A::Tim3trgo),
            9 => Some(EXTSEL_A::Tim4cc4),
