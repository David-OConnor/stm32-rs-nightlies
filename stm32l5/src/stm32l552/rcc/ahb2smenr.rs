...
pub type PKASMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2SMENR_SPEC, bool, O>;
...
pub type OTFDEC1SMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2SMENR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otfdec1smen(&mut self) -> OTFDEC1SMEN_W<21> {
...
impl crate::Resettable for AHB2SMENR_SPEC {
    const RESET_VALUE: Self::Ux = 0x006f_22ff;
}
