...
pub type TIM2SECF_R = crate::BitReader<bool>;
#[doc = "Field `TIM3SECF` reader - TIM3SECF"]
pub type TIM3SECF_R = crate::BitReader<bool>;
#[doc = "Field `TIM4SECF` reader - TIM4SECF"]
pub type TIM4SECF_R = crate::BitReader<bool>;
#[doc = "Field `TIM5SECF` reader - TIM5SECF"]
pub type TIM5SECF_R = crate::BitReader<bool>;
#[doc = "Field `TIM6SECF` reader - TIM6SECF"]
pub type TIM6SECF_R = crate::BitReader<bool>;
#[doc = "Field `TIM7SECF` reader - TIM7SECF"]
pub type TIM7SECF_R = crate::BitReader<bool>;
#[doc = "Field `RTCAPBSECF` reader - RTCAPBSECF"]
pub type RTCAPBSECF_R = crate::BitReader<bool>;
#[doc = "Field `WWDGSECF` reader - WWDGSECF"]
pub type WWDGSECF_R = crate::BitReader<bool>;
#[doc = "Field `SPI2SECF` reader - SPI2SECF"]
pub type SPI2SECF_R = crate::BitReader<bool>;
#[doc = "Field `SPI3SECF` reader - SPI3SECF"]
pub type SPI3SECF_R = crate::BitReader<bool>;
#[doc = "Field `UART2SECF` reader - UART2SECF"]
pub type UART2SECF_R = crate::BitReader<bool>;
#[doc = "Field `UART3SECF` reader - UART3SECF"]
pub type UART3SECF_R = crate::BitReader<bool>;
#[doc = "Field `UART4SECF` reader - UART4SECF"]
pub type UART4SECF_R = crate::BitReader<bool>;
#[doc = "Field `UART5SECF` reader - UART5SECF"]
pub type UART5SECF_R = crate::BitReader<bool>;
#[doc = "Field `I2C1SECF` reader - I2C1SECF"]
pub type I2C1SECF_R = crate::BitReader<bool>;
#[doc = "Field `I2C2SECF` reader - I2C2SECF"]
pub type I2C2SECF_R = crate::BitReader<bool>;
#[doc = "Field `I2C3SECF` reader - I2C3SECF"]
pub type I2C3SECF_R = crate::BitReader<bool>;
#[doc = "Field `CRSSECF` reader - CRSSECF"]
pub type CRSSECF_R = crate::BitReader<bool>;
#[doc = "Field `PWRSECF` reader - PWRSECF"]
pub type PWRSECF_R = crate::BitReader<bool>;
#[doc = "Field `DACSECF` reader - DACSECF"]
pub type DACSECF_R = crate::BitReader<bool>;
#[doc = "Field `OPAMPSECF` reader - OPAMPSECF"]
pub type OPAMPSECF_R = crate::BitReader<bool>;
#[doc = "Field `LPTIM1SECF` reader - LPTIM1SECF"]
pub type LPTIM1SECF_R = crate::BitReader<bool>;
impl R {
    #[doc = "Bit 0 - TIM2SECF"]
    #[inline(always)]
