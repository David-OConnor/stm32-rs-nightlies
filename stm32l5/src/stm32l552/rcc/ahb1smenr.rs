...
#[doc = "Field `GTZCSMEN` reader - GTZCSMEN"]
pub type GTZCSMEN_R = crate::BitReader<bool>;
#[doc = "Field `GTZCSMEN` writer - GTZCSMEN"]
pub type GTZCSMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB1SMENR_SPEC, bool, O>;
#[doc = "Field `ICACHESMEN` reader - ICACHESMEN"]
pub type ICACHESMEN_R = crate::BitReader<bool>;
#[doc = "Field `ICACHESMEN` writer - ICACHESMEN"]
pub type ICACHESMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB1SMENR_SPEC, bool, O>;
impl R {
    ...
    pub fn gtzcsmen(&self) -> GTZCSMEN_R {
        GTZCSMEN_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - ICACHESMEN"]
    #[inline(always)]
    pub fn icachesmen(&self) -> ICACHESMEN_R {
        ICACHESMEN_R::new(((self.bits >> 23) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - DMA1 clocks enable during Sleep and Stop modes"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn gtzcsmen(&mut self) -> GTZCSMEN_W<22> {
        GTZCSMEN_W::new(self)
    }
    #[doc = "Bit 23 - ICACHESMEN"]
    #[inline(always)]
    #[must_use]
    pub fn icachesmen(&mut self) -> ICACHESMEN_W<23> {
...
#[doc = "`reset()` method sets AHB1SMENR to value 0x00c1_1307"]
impl crate::Resettable for AHB1SMENR_SPEC {
    const RESET_VALUE: Self::Ux = 0x00c1_1307;
}
