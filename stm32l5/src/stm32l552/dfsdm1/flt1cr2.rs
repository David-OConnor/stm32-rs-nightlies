...
#[doc = "`read()` method returns [flt1cr2::R](R) reader structure"]
impl crate::Readable for FLT1CR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flt1cr2::W](W) writer structure"]
impl crate::Writable for FLT1CR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FLT1CR2 to value 0"]
