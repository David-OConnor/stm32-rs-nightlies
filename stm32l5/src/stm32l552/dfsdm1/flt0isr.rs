#[doc = "Register `FLT0ISR` reader"]
pub struct R(crate::R<FLT0ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLT0ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FLT0ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FLT0ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flt0isr](index.html) module"]
pub struct FLT0ISR_SPEC;
impl crate::RegisterSpec for FLT0ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flt0isr::R](R) reader structure"]
impl crate::Readable for FLT0ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets FLT0ISR to value 0x00ff_0000"]
impl crate::Resettable for FLT0ISR_SPEC {
