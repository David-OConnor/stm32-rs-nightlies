#[doc = "Register `FLT1ISR` reader"]
pub struct R(crate::R<FLT1ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLT1ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FLT1ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FLT1ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flt1isr](index.html) module"]
pub struct FLT1ISR_SPEC;
impl crate::RegisterSpec for FLT1ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [flt1isr::R](R) reader structure"]
impl crate::Readable for FLT1ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets FLT1ISR to value 0x00ff_0000"]
impl crate::Resettable for FLT1ISR_SPEC {
