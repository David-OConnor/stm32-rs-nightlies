...
#[doc = "`read()` method returns [flt3jchgr::R](R) reader structure"]
impl crate::Readable for FLT3JCHGR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flt3jchgr::W](W) writer structure"]
impl crate::Writable for FLT3JCHGR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FLT3JCHGR to value 0x01"]
