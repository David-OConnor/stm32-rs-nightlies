...
impl From<crate::R<CH5DATINR_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CH5DATINR_SPEC>> for W {
    #[inline(always)]
...
pub type INDAT0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH5DATINR_SPEC, u16, u16, 16, O>;
#[doc = "Field `INDAT1` reader - INDAT1"]
pub type INDAT1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `INDAT1` writer - INDAT1"]
pub type INDAT1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH5DATINR_SPEC, u16, u16, 16, O>;
impl R {
