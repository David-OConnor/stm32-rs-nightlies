...
#[doc = "Field `PLSSKP` reader - Pulses to skip for input data skipping function"]
pub type PLSSKP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PLSSKP` writer - Pulses to skip for input data skipping function"]
pub type PLSSKP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH0DLYR_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5 - Pulses to skip for input data skipping function"]
    #[inline(always)]
