...
impl R {
    ...
    #[doc = "Bit 15 - Output Idle state 5 (OC5 output)"]
    #[inline(always)]
    pub fn ois5(&self) -> OIS5_R {
        OIS5_R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - Output Idle state 6"]
    #[inline(always)]
    pub fn ois6(&self) -> OIS6_R {
        OIS6_R::new(((self.bits >> 16) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ois5(&mut self) -> OIS5_W<15> {
        OIS5_W::new(self)
    }
    #[doc = "Bit 16 - Output Idle state 6"]
    #[inline(always)]
    #[must_use]
    pub fn ois6(&mut self) -> OIS6_W<16> {
        OIS6_W::new(self)
    }
    #[doc = "Bits 20:23 - Master mode selection 2"]
    #[inline(always)]
