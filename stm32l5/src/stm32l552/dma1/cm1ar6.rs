...
#[doc = "`read()` method returns [cm1ar6::R](R) reader structure"]
impl crate::Readable for CM1AR6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cm1ar6::W](W) writer structure"]
impl crate::Writable for CM1AR6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CM1AR6 to value 0"]
