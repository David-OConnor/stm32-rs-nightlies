...
#[doc = "`read()` method returns [cm1ar7::R](R) reader structure"]
impl crate::Readable for CM1AR7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cm1ar7::W](W) writer structure"]
impl crate::Writable for CM1AR7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CM1AR7 to value 0"]
