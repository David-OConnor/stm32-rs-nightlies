...
pub type DMAREQ_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, C9CR_SPEC, u8, u8, 7, O>;
...
pub type SOIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, C9CR_SPEC, bool, O>;
