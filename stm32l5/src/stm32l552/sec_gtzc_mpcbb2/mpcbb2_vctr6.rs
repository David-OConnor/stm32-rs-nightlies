#[doc = "Register `MPCBB2_VCTR6` reader"]
...
#[doc = "Register `MPCBB2_VCTR6` writer"]
...
#[doc = "`read()` method returns [mpcbb2_vctr6::R](R) reader structure"]
impl crate::Readable for MPCBB2_VCTR6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mpcbb2_vctr6::W](W) writer structure"]
impl crate::Writable for MPCBB2_VCTR6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MPCBB2_VCTR6 to value 0"]
