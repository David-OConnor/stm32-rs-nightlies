...
pub type POLYNOMIALCOEFFICIENTS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `Polynomialcoefficients` writer - Programmable polynomial"]
pub type POLYNOMIALCOEFFICIENTS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, POL_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn polynomialcoefficients(&mut self) -> POLYNOMIALCOEFFICIENTS_W<0> {
        POLYNOMIALCOEFFICIENTS_W::new(self)
    }
