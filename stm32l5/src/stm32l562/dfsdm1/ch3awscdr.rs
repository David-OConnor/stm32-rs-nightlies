...
impl From<crate::R<CH3AWSCDR_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<CH3AWSCDR_SPEC>> for W {
    #[inline(always)]
...
pub type SCDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3AWSCDR_SPEC, u8, u8, 8, O>;
#[doc = "Field `BKSCD` reader - BKSCD"]
pub type BKSCD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BKSCD` writer - BKSCD"]
pub type BKSCD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3AWSCDR_SPEC, u8, u8, 4, O>;
#[doc = "Field `AWFOSR` reader - AWFOSR"]
pub type AWFOSR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `AWFOSR` writer - AWFOSR"]
pub type AWFOSR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3AWSCDR_SPEC, u8, u8, 5, O>;
#[doc = "Field `AWFORD` reader - AWFORD"]
pub type AWFORD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `AWFORD` writer - AWFORD"]
pub type AWFORD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH3AWSCDR_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:7 - SCDT"]
    #[inline(always)]
