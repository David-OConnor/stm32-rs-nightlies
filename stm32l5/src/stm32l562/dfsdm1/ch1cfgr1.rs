...
pub type CKOUTDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH1CFGR1_SPEC, u8, u8, 8, O>;
...
pub type CKOUTSRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1CFGR1_SPEC, bool, O>;
...
pub type DFSDMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH1CFGR1_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - SITP"]
    #[inline(always)]
