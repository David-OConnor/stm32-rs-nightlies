...
#[doc = "`read()` method returns [flt1fcr::R](R) reader structure"]
impl crate::Readable for FLT1FCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [flt1fcr::W](W) writer structure"]
impl crate::Writable for FLT1FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FLT1FCR to value 0"]
