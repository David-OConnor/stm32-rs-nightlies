...
pub struct R(crate::R<FLT2AWHTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FLT2AWHTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FLT2AWHTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FLT2AWHTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FLT2AWHTR` writer"]
pub struct W(crate::W<FLT2AWHTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FLT2AWHTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FLT2AWHTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FLT2AWHTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BKAWH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FLT2AWHTR_SPEC, u8, u8, 4, O>;
...
pub type AWHT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FLT2AWHTR_SPEC, u32, u32, 24, O>;
impl R {
