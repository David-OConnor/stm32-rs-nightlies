...
#[doc = "Field `SMS_bit3` reader - Slave mode selection - bit 3"]
pub type SMS_BIT3_R = crate::BitReader<bool>;
#[doc = "Field `SMS_bit3` writer - Slave mode selection - bit 3"]
pub type SMS_BIT3_W<'a, const O: u8> = crate::BitWriter<'a, u32, SMCR_SPEC, bool, O>;
impl R {
    ...
    #[inline(always)]
    pub fn sms_bit3(&self) -> SMS_BIT3_R {
        SMS_BIT3_R::new(((self.bits >> 16) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Slave mode selection"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sms_bit3(&mut self) -> SMS_BIT3_W<16> {
        SMS_BIT3_W::new(self)
    }
