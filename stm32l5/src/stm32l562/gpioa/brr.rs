...
#[doc = "Field `BR0` writer - Port x reset IO pin y"]
...
#[doc = "Field `BR1` writer - Port x reset IO pin y"]
pub use BR0_W as BR1_W;
#[doc = "Field `BR2` writer - Port x reset IO pin y"]
pub use BR0_W as BR2_W;
#[doc = "Field `BR3` writer - Port x reset IO pin y"]
pub use BR0_W as BR3_W;
#[doc = "Field `BR4` writer - Port x reset IO pin y"]
pub use BR0_W as BR4_W;
#[doc = "Field `BR5` writer - Port x reset IO pin y"]
pub use BR0_W as BR5_W;
#[doc = "Field `BR6` writer - Port x reset IO pin y"]
pub use BR0_W as BR6_W;
#[doc = "Field `BR7` writer - Port x reset IO pin y"]
pub use BR0_W as BR7_W;
#[doc = "Field `BR8` writer - Port x reset IO pin y"]
pub use BR0_W as BR8_W;
#[doc = "Field `BR9` writer - Port x reset IO pin y"]
pub use BR0_W as BR9_W;
#[doc = "Field `BR10` writer - Port x reset IO pin y"]
pub use BR0_W as BR10_W;
#[doc = "Field `BR11` writer - Port x reset IO pin y"]
pub use BR0_W as BR11_W;
#[doc = "Field `BR12` writer - Port x reset IO pin y"]
pub use BR0_W as BR12_W;
#[doc = "Field `BR13` writer - Port x reset IO pin y"]
pub use BR0_W as BR13_W;
#[doc = "Field `BR14` writer - Port x reset IO pin y"]
pub use BR0_W as BR14_W;
#[doc = "Field `BR15` writer - Port x reset IO pin y"]
pub use BR0_W as BR15_W;
impl W {
    #[doc = "Bit 0 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br0(&mut self) -> BR0_W<0> {
        BR0_W::new(self)
    }
    #[doc = "Bit 1 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br1(&mut self) -> BR1_W<1> {
        BR1_W::new(self)
    }
    #[doc = "Bit 2 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br2(&mut self) -> BR2_W<2> {
        BR2_W::new(self)
    }
    #[doc = "Bit 3 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br3(&mut self) -> BR3_W<3> {
        BR3_W::new(self)
    }
    #[doc = "Bit 4 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br4(&mut self) -> BR4_W<4> {
        BR4_W::new(self)
    }
    #[doc = "Bit 5 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br5(&mut self) -> BR5_W<5> {
        BR5_W::new(self)
    }
    #[doc = "Bit 6 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br6(&mut self) -> BR6_W<6> {
        BR6_W::new(self)
    }
    #[doc = "Bit 7 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br7(&mut self) -> BR7_W<7> {
        BR7_W::new(self)
    }
    #[doc = "Bit 8 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br8(&mut self) -> BR8_W<8> {
        BR8_W::new(self)
    }
    #[doc = "Bit 9 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br9(&mut self) -> BR9_W<9> {
        BR9_W::new(self)
    }
    #[doc = "Bit 10 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br10(&mut self) -> BR10_W<10> {
        BR10_W::new(self)
    }
    #[doc = "Bit 11 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br11(&mut self) -> BR11_W<11> {
        BR11_W::new(self)
    }
    #[doc = "Bit 12 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br12(&mut self) -> BR12_W<12> {
        BR12_W::new(self)
    }
    #[doc = "Bit 13 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br13(&mut self) -> BR13_W<13> {
        BR13_W::new(self)
    }
    #[doc = "Bit 14 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
    pub fn br14(&mut self) -> BR14_W<14> {
        BR14_W::new(self)
    }
    #[doc = "Bit 15 - Port x reset IO pin y"]
    #[inline(always)]
    #[must_use]
