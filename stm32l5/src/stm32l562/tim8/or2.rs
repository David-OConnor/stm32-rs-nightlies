...
#[doc = "Field `BKDF1BK2E` reader - BRK dfsdm1_break\\[2\\]
enable"]
pub type BKDF1BK2E_R = crate::BitReader<bool>;
#[doc = "Field `BKDF1BK2E` writer - BRK dfsdm1_break\\[2\\]
enable"]
pub type BKDF1BK2E_W<'a, const O: u8> = crate::BitWriter<'a, u32, OR2_SPEC, bool, O>;
