...
pub type PLLSAI1SRC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PLLSAI1SRC` writer - PLLSAI1SRC"]
pub type PLLSAI1SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLLSAI1CFGR_SPEC, u8, u8, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllsai1src(&mut self) -> PLLSAI1SRC_W<0> {
        PLLSAI1SRC_W::new(self)
    }
    #[doc = "Bits 4:7 - Division factor for PLLSAI1 input clock"]
    #[inline(always)]
    #[must_use]
