...
pub type PLLSAI2SRC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PLLSAI2SRC` writer - PLLSAI2SRC"]
pub type PLLSAI2SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLLSAI2CFGR_SPEC, u8, u8, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllsai2src(&mut self) -> PLLSAI2SRC_W<0> {
        PLLSAI2SRC_W::new(self)
    }
    #[doc = "Bits 4:7 - Division factor for PLLSAI2 input clock"]
    #[inline(always)]
    #[must_use]
