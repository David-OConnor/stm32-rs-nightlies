...
pub type PA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR3_SPEC, u32, u32, 32, O>;
...
pub type DBM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR3_SPEC, bool, O>;
...
pub type CT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR3_SPEC, bool, O>;
...
pub type PRIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR3_SPEC, bool, O>;
impl R {
