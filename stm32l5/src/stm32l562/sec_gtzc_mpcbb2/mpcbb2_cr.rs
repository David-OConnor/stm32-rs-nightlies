...
pub type LCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCBB2_CR_SPEC, bool, O>;
...
pub type INVSECSTATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCBB2_CR_SPEC, bool, O>;
#[doc = "Field `SRWILADIS` reader - SRWILADIS"]
pub type SRWILADIS_R = crate::BitReader<bool>;
#[doc = "Field `SRWILADIS` writer - SRWILADIS"]
pub type SRWILADIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPCBB2_CR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - LCK"]
    #[inline(always)]
