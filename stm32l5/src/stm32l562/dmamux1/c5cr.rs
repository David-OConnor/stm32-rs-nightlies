...
#[doc = "Field `OIE` reader - Synchronization Overrun Interrupt Enable"]
pub type OIE_R = crate::BitReader<bool>;
#[doc = "Field `OIE` writer - Synchronization Overrun Interrupt Enable"]
pub type OIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, C5CR_SPEC, bool, O>;
