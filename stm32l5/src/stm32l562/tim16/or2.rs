...
#[doc = "Field `BKDF1BK1E` reader - BRK dfsdm1_break\\[1\\]
enable"]
pub type BKDF1BK1E_R = crate::BitReader<bool>;
#[doc = "Field `BKDF1BK1E` writer - BRK dfsdm1_break\\[1\\]
enable"]
pub type BKDF1BK1E_W<'a, const O: u8> = crate::BitWriter<'a, u32, OR2_SPEC, bool, O>;
...
enable"]
    #[inline(always)]
    #[must_use]
    pub fn bkdf1bk1e(&mut self) -> BKDF1BK1E_W<8> {
        BKDF1BK1E_W::new(self)
    }
    #[doc = "Bit 9 - BRK BKIN input polarity"]
    #[inline(always)]
    #[must_use]
