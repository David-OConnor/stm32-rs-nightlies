#[doc = "Register `VCTR%s` reader"]
pub struct R(crate::R<VCTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<VCTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<VCTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<VCTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `VCTR%s` writer"]
pub struct W(crate::W<VCTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<VCTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<VCTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<VCTR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "MPCBBx vector register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [vctr](index.html) module"]
pub struct VCTR_SPEC;
impl crate::RegisterSpec for VCTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [vctr::R](R) reader structure"]
impl crate::Readable for VCTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [vctr::W](W) writer structure"]
impl crate::Writable for VCTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets VCTR%s to value 0xffff_ffff"]
impl crate::Resettable for VCTR_SPEC {
