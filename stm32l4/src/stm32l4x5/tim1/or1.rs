...
pub type ETR_ADC1_RMP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ETR_ADC1_RMP` writer - External trigger remap on ADC1 analog watchdog"]
pub type ETR_ADC1_RMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OR1_SPEC, u8, u8, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etr_adc1_rmp(&mut self) -> ETR_ADC1_RMP_W<0> {
        ETR_ADC1_RMP_W::new(self)
    }
    #[doc = "Bits 2:3 - External trigger remap on ADC3 analog watchdog"]
    #[inline(always)]
    #[must_use]
