#![doc = "Peripheral access API for STM32L4X5 microcontrollers (generated using svd2rust v0.28.0 (27eebb4 2022-12-25))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl USB {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb::RegisterBlock = 0x4000_6c00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
