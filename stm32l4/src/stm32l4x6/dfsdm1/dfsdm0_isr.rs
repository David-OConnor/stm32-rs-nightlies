#[doc = "Register `DFSDM0_ISR` reader"]
pub struct R(crate::R<DFSDM0_ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM0_ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM0_ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM0_ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "interrupt and status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm0_isr](index.html) module"]
pub struct DFSDM0_ISR_SPEC;
impl crate::RegisterSpec for DFSDM0_ISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm0_isr::R](R) reader structure"]
impl crate::Readable for DFSDM0_ISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM0_ISR to value 0x00ff_0000"]
impl crate::Resettable for DFSDM0_ISR_SPEC {
