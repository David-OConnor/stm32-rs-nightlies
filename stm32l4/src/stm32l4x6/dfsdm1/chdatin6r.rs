...
#[doc = "`read()` method returns [chdatin6r::R](R) reader structure"]
impl crate::Readable for CHDATIN6R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [chdatin6r::W](W) writer structure"]
impl crate::Writable for CHDATIN6R_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHDATIN6R to value 0"]
