...
pub type RSTDET_R = crate::BitReader<bool>;
#[doc = "Field `RSTDET` writer - Reset detected interrupt"]
pub type RSTDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
#[doc = "Field `LPMINT` reader - LPM interrupt"]
pub type LPMINT_R = crate::BitReader<bool>;
#[doc = "Field `LPMINT` writer - LPM interrupt"]
pub type LPMINT_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rstdet(&mut self) -> RSTDET_W<23> {
        RSTDET_W::new(self)
    }
    #[doc = "Bit 27 - LPM interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn lpmint(&mut self) -> LPMINT_W<27> {
        LPMINT_W::new(self)
    }
    #[doc = "Bit 28 - Connector ID status change"]
    #[inline(always)]
