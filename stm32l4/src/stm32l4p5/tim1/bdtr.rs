...
#[doc = "Field `DT` reader - Dead-time generator setup"]
pub type DT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DT` writer - Dead-time generator setup"]
pub type DT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BDTR_SPEC, u8, u8, 8, O>;
