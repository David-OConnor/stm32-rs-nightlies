...
#[doc = "Field `SMS3` reader - Bit 3 of Slave mode selection"]
pub type SMS3_R = crate::BitReader<bool>;
#[doc = "Field `SMS3` writer - Bit 3 of Slave mode selection"]
pub type SMS3_W<'a, const O: u8> = crate::BitWriter<'a, u32, SMCR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 16 - Bit 3 of Slave mode selection"]
    #[inline(always)]
