...
impl I2C4EN_R {
    ...
    pub fn variant(&self) -> I2C4EN_A {
        match self.bits {
            false => I2C4EN_A::Disabled,
            true => I2C4EN_A::Enabled,
        }
    }
    #[doc = "Checks if the value of the field is `Disabled`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == I2C4EN_A::Disabled
    }
    #[doc = "Checks if the value of the field is `Enabled`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == I2C4EN_A::Enabled
    }
}
#[doc = "Field `I2C4EN` writer - I2C4 clock enable"]
pub type I2C4EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1ENR2_SPEC, I2C4EN_A, O>;
