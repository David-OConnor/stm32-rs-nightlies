...
impl MCOSEL_R {
    ...
    #[doc = "Checks if the value of the field is `MainPll`"]
    #[inline(always)]
...
impl MCOPRE_R {
    ...
    #[doc = "Checks if the value of the field is `Divider1`"]
    #[inline(always)]
    pub fn is_divider1(&self) -> bool {
        *self == MCOPRE_A::Divider1
    }
    #[doc = "Checks if the value of the field is `Divider2`"]
    #[inline(always)]
    pub fn is_divider2(&self) -> bool {
        *self == MCOPRE_A::Divider2
    }
    #[doc = "Checks if the value of the field is `Divider4`"]
    #[inline(always)]
    pub fn is_divider4(&self) -> bool {
        *self == MCOPRE_A::Divider4
    }
    #[doc = "Checks if the value of the field is `Divider8`"]
    #[inline(always)]
    pub fn is_divider8(&self) -> bool {
        *self == MCOPRE_A::Divider8
    }
    #[doc = "Checks if the value of the field is `Divider16`"]
    #[inline(always)]
