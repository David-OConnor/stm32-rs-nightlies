...
pub mod pdcrh;
#[doc = "PUCRI (rw) register accessor: an alias for `Reg<PUCRI_SPEC>`"]
pub type PUCRI = crate::Reg<pucri::PUCRI_SPEC>;
#[doc = "Power Port I pull-up control register"]
pub mod pucri;
#[doc = "PDCRI (rw) register accessor: an alias for `Reg<PDCRI_SPEC>`"]
