...
#[doc = "`read()` method returns [f17r1::R](R) reader structure"]
impl crate::Readable for F17R1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [f17r1::W](W) writer structure"]
impl crate::Writable for F17R1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets F17R1 to value 0"]
