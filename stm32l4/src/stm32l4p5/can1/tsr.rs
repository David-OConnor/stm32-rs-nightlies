...
#[doc = "Field `TME` reader - Lowest priority flag for mailbox 2"]
pub type TME_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TME` writer - Lowest priority flag for mailbox 2"]
pub type TME_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TSR_SPEC, u8, u8, 3, O>;
#[doc = "Field `LOW` reader - Lowest priority flag for mailbox 2"]
pub type LOW_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LOW` writer - Lowest priority flag for mailbox 2"]
...
impl R {
    ...
    #[doc = "Bits 26:28 - Lowest priority flag for mailbox 2"]
    #[inline(always)]
    pub fn tme(&self) -> TME_R {
        TME_R::new(((self.bits >> 26) & 7) as u8)
    }
    #[doc = "Bits 29:31 - Lowest priority flag for mailbox 2"]
    #[inline(always)]
