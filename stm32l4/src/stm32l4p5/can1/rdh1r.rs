...
pub struct R(crate::R<RDH1R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RDH1R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RDH1R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RDH1R_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "mailbox data high register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rdh1r](index.html) module"]
pub struct RDH1R_SPEC;
impl crate::RegisterSpec for RDH1R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rdh1r::R](R) reader structure"]
impl crate::Readable for RDH1R_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets RDH1R to value 0"]
impl crate::Resettable for RDH1R_SPEC {
