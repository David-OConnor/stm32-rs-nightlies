...
pub struct R(crate::R<F12R1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<F12R1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<F12R1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<F12R1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `F12R1` writer"]
pub struct W(crate::W<F12R1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<F12R1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<F12R1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<F12R1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, F12R1_SPEC, u32, u32, 32, O>;
impl R {
