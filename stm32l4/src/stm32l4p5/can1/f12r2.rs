...
#[doc = "`read()` method returns [f12r2::R](R) reader structure"]
impl crate::Readable for F12R2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [f12r2::W](W) writer structure"]
impl crate::Writable for F12R2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets F12R2 to value 0"]
