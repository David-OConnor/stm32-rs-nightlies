...
pub type PCROP1_STRT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PCROP1_STRT` writer - Bank 1 PCROP area start offset"]
pub type PCROP1_STRT_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PCROP1SR_SPEC, u32, u32, 17, O>;
impl R {
    #[doc = "Bits 0:16 - Bank 1 PCROP area start offset"]
    #[inline(always)]
    pub fn pcrop1_strt(&self) -> PCROP1_STRT_R {
        PCROP1_STRT_R::new(self.bits & 0x0001_ffff)
    }
}
impl W {
    #[doc = "Bits 0:16 - Bank 1 PCROP area start offset"]
