...
pub type WRP2B_STRT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, WRP2BR_SPEC, u8, u8, 8, O>;
...
pub type WRP2B_END_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, WRP2BR_SPEC, u8, u8, 8, O>;
impl R {
