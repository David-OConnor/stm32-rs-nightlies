...
#[doc = "Field `PDKEY` writer - RUN_PD in FLASH_ACR key"]
pub type PDKEY_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PDKEYR_SPEC, u32, u32, 32, O>;
impl W {
    #[doc = "Bits 0:31 - RUN_PD in FLASH_ACR key"]
    #[inline(always)]
    #[must_use]
    pub fn pdkey(&mut self) -> PDKEY_W<0> {
        PDKEY_W::new(self)
    }
