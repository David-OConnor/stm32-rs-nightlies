...
pub type BF2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L2BFCR_SPEC, u8, BF2_A, 3, O>;
...
pub type BF1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L2BFCR_SPEC, u8, BF1_A, 3, O>;
