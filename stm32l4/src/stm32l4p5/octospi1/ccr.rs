...
pub type IMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR_SPEC, u8, IMODE_A, 3, O>;
...
pub type IDTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, IDTR_A, O>;
...
pub type ISIZE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CCR_SPEC, u8, ISIZE_A, 2, O>;
...
pub type ADMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR_SPEC, u8, ADMODE_A, 3, O>;
...
pub type ADDTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, ADDTR_A, O>;
...
pub type ADSIZE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CCR_SPEC, u8, ADSIZE_A, 2, O>;
...
pub type ABMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR_SPEC, u8, ABMODE_A, 3, O>;
...
pub type ABDTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, ABDTR_A, O>;
...
pub type ABSIZE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CCR_SPEC, u8, ABSIZE_A, 2, O>;
...
pub type DMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR_SPEC, u8, DMODE_A, 3, O>;
...
pub type DDTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, DDTR_A, O>;
...
pub type DQSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, DQSE_A, O>;
...
pub type SIOO_R = crate::BitReader<SIOO_A>;
#[doc = "Send instruction only once mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SIOO_A {
    #[doc = "0: Send instruction on every transaction"]
    SendEveryTransaction = 0,
    #[doc = "1: Send instruction only for the first command"]
    SendOnlyFirstCmd = 1,
}
impl From<SIOO_A> for bool {
    #[inline(always)]
    fn from(variant: SIOO_A) -> Self {
        variant as u8 != 0
    }
}
impl SIOO_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SIOO_A {
        match self.bits {
            false => SIOO_A::SendEveryTransaction,
            true => SIOO_A::SendOnlyFirstCmd,
        }
    }
    #[doc = "Checks if the value of the field is `SendEveryTransaction`"]
    #[inline(always)]
    pub fn is_send_every_transaction(&self) -> bool {
        *self == SIOO_A::SendEveryTransaction
    }
    #[doc = "Checks if the value of the field is `SendOnlyFirstCmd`"]
    #[inline(always)]
    pub fn is_send_only_first_cmd(&self) -> bool {
        *self == SIOO_A::SendOnlyFirstCmd
    }
}
#[doc = "Field `SIOO` writer - Send instruction only once mode"]
pub type SIOO_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR_SPEC, SIOO_A, O>;
impl<'a, const O: u8> SIOO_W<'a, O> {
    #[doc = "Send instruction on every transaction"]
    #[inline(always)]
    pub fn send_every_transaction(self) -> &'a mut W {
        self.variant(SIOO_A::SendEveryTransaction)
    }
    #[doc = "Send instruction only for the first command"]
    #[inline(always)]
    pub fn send_only_first_cmd(self) -> &'a mut W {
        self.variant(SIOO_A::SendOnlyFirstCmd)
    }
}
impl R {
