...
#[doc = "Field `PU0` reader - Port H pull-up bit y (y=0..15)"]
pub type PU0_R = crate::BitReader<PU0_A>;
#[doc = "Port H pull-up bit y (y=0..15)\n\nValue on reset: 0"]
...
#[doc = "Field `PU0` writer - Port H pull-up bit y (y=0..15)"]
pub type PU0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PUCRH_SPEC, PU0_A, O>;
...
#[doc = "Field `PU1` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU1_R;
#[doc = "Field `PU2` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU2_R;
#[doc = "Field `PU3` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU3_R;
#[doc = "Field `PU4` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU4_R;
#[doc = "Field `PU5` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU5_R;
#[doc = "Field `PU6` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU6_R;
#[doc = "Field `PU7` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU7_R;
#[doc = "Field `PU8` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU8_R;
#[doc = "Field `PU9` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU9_R;
#[doc = "Field `PU10` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU10_R;
#[doc = "Field `PU11` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU11_R;
#[doc = "Field `PU12` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU12_R;
#[doc = "Field `PU13` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU13_R;
#[doc = "Field `PU14` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU14_R;
#[doc = "Field `PU15` reader - Port H pull-up bit y (y=0..15)"]
pub use PU0_R as PU15_R;
#[doc = "Field `PU1` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU1_W;
#[doc = "Field `PU2` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU2_W;
#[doc = "Field `PU3` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU3_W;
#[doc = "Field `PU4` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU4_W;
#[doc = "Field `PU5` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU5_W;
#[doc = "Field `PU6` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU6_W;
#[doc = "Field `PU7` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU7_W;
#[doc = "Field `PU8` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU8_W;
#[doc = "Field `PU9` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU9_W;
#[doc = "Field `PU10` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU10_W;
#[doc = "Field `PU11` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU11_W;
#[doc = "Field `PU12` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU12_W;
#[doc = "Field `PU13` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU13_W;
#[doc = "Field `PU14` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU14_W;
#[doc = "Field `PU15` writer - Port H pull-up bit y (y=0..15)"]
pub use PU0_W as PU15_W;
impl R {
    #[doc = "Bit 0 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu0(&self) -> PU0_R {
        PU0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu1(&self) -> PU1_R {
        PU1_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu2(&self) -> PU2_R {
        PU2_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu3(&self) -> PU3_R {
        PU3_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu4(&self) -> PU4_R {
        PU4_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu5(&self) -> PU5_R {
        PU5_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu6(&self) -> PU6_R {
        PU6_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu7(&self) -> PU7_R {
        PU7_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu8(&self) -> PU8_R {
        PU8_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu9(&self) -> PU9_R {
        PU9_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu10(&self) -> PU10_R {
        PU10_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu11(&self) -> PU11_R {
        PU11_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu12(&self) -> PU12_R {
        PU12_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu13(&self) -> PU13_R {
        PU13_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn pu14(&self) -> PU14_R {
        PU14_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Port H pull-up bit y (y=0..15)"]
    #[inline(always)]
