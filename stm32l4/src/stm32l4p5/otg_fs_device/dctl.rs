...
#[doc = "Field `DSBESLRJCT` reader - Deep sleep BESL reject"]
pub type DSBESLRJCT_R = crate::BitReader<bool>;
#[doc = "Field `DSBESLRJCT` writer - Deep sleep BESL reject"]
pub type DSBESLRJCT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DCTL_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 18 - Deep sleep BESL reject"]
    #[inline(always)]
