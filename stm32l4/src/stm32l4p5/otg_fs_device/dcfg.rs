...
#[doc = "Field `ERRATIM` reader - Erratic error interrupt mask"]
pub type ERRATIM_R = crate::BitReader<bool>;
#[doc = "Field `ERRATIM` writer - Erratic error interrupt mask"]
pub type ERRATIM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DCFG_SPEC, bool, O>;
impl R {
