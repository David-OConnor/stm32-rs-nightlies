...
pub type STSPHSRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT3_SPEC, bool, O>;
...
pub type BERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT3_SPEC, bool, O>;
#[doc = "Field `NAK` reader - NAK input"]
pub type NAK_R = crate::BitReader<bool>;
#[doc = "Field `NAK` writer - NAK input"]
pub type NAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DOEPINT3_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - XFRC"]
    #[inline(always)]
