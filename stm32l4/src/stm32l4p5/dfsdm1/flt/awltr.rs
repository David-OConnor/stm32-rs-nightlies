...
pub type BKAWL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, AWLTR_SPEC, u8, u8, 4, O>;
...
pub type AWLT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, AWLTR_SPEC, u32, u32, 24, O>;
impl R {
