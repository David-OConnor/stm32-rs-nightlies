...
pub type BKAWH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, AWHTR_SPEC, u8, u8, 4, O>;
...
pub type AWHT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, AWHTR_SPEC, u32, u32, 24, O>;
impl R {
