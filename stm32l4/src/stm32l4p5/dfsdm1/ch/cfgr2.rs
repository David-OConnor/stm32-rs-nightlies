...
pub type DTRBS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CFGR2_SPEC, u8, u8, 5, O>;
#[doc = "Field `OFFSET` reader - OFFSET"]
pub type OFFSET_R = crate::FieldReader<u32, u32>;
#[doc = "Field `OFFSET` writer - OFFSET"]
pub type OFFSET_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CFGR2_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 3:7 - DTRBS"]
    #[inline(always)]
