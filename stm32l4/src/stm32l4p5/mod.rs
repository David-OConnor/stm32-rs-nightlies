#![doc = "Peripheral access API for STM32L4P5 microcontrollers (generated using svd2rust v0.28.0 (27eebb4 2022-12-25))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub enum Interrupt {
    ...
    I2C4_EV = 84,
    #[doc = "85 - DCMI/PSSI global interrupt"]
    DCMI_PSSI = 85,
...
#[doc = "Cyclic redundancy check calculation unit"]
pub mod crc;
#[doc = "LCD-TFT display controller"]
pub struct LTDC {
    _marker: PhantomData<*const ()>,
}
...
impl PSSI {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const pssi::RegisterBlock = 0x5005_0400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
