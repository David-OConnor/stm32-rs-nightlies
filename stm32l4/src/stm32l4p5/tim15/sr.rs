...
#[doc = "Field `CC2IF` reader - Capture/Compare 1 interrupt flag"]
pub type CC2IF_R = crate::BitReader<bool>;
#[doc = "Field `CC2IF` writer - Capture/Compare 1 interrupt flag"]
...
impl R {
    ...
    #[doc = "Bit 9 - Capture/Compare 2 overcapture flag"]
    #[inline(always)]
    pub fn cc2of(&self) -> CC2OF_R {
        CC2OF_R::new(((self.bits >> 9) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Update interrupt flag"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cc2of(&mut self) -> CC2OF_W<9> {
        CC2OF_W::new(self)
    }
