...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum DFSDMCFG_A {
    #[doc = "0: DFSDM mode disabled"]
    Disabled = 0,
    #[doc = "1: DFSDM mode enabled"]
    Enabled = 1,
}
...
impl<'a, const O: u8> DFSDMCFG_W<'a, O> {
    #[doc = "DFSDM mode disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(DFSDMCFG_A::Disabled)
    }
    #[doc = "DFSDM mode enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
#[doc = "Field `EXTSEL` reader - EXTSEL3"]
...
#[doc = "Field `EXTSEL` writer - EXTSEL3"]
