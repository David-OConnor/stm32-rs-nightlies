...
impl DEEPPWD_R {
    ...
    pub fn variant(&self) -> DEEPPWD_A {
        match self.bits {
            false => DEEPPWD_A::NotDeepPowerDown,
            true => DEEPPWD_A::DeepPowerDown,
        }
    }
    #[doc = "Checks if the value of the field is `NotDeepPowerDown`"]
    #[inline(always)]
    pub fn is_not_deep_power_down(&self) -> bool {
        *self == DEEPPWD_A::NotDeepPowerDown
    }
    #[doc = "Checks if the value of the field is `DeepPowerDown`"]
    #[inline(always)]
    pub fn is_deep_power_down(&self) -> bool {
        *self == DEEPPWD_A::DeepPowerDown
    }
}
