...
pub type CSR12_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSR12` writer - CSR12"]
pub type CSR12_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSR12_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CSR12"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csr12(&mut self) -> CSR12_W<0> {
        CSR12_W::new(self)
    }
