...
pub type CSR52_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSR52` writer - CSR52"]
pub type CSR52_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSR52_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CSR52"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csr52(&mut self) -> CSR52_W<0> {
        CSR52_W::new(self)
    }
