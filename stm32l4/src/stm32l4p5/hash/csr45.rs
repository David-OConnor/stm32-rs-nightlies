...
pub type CSR45_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSR45` writer - CSR45"]
pub type CSR45_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSR45_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CSR45"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csr45(&mut self) -> CSR45_W<0> {
        CSR45_W::new(self)
    }
