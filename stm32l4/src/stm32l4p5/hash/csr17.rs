...
pub type CSR17_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CSR17` writer - CSR17"]
pub type CSR17_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSR17_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CSR17"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csr17(&mut self) -> CSR17_W<0> {
        CSR17_W::new(self)
    }
