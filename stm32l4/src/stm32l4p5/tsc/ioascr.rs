...
pub enum G1_IO1_A {
    #[doc = "0: Gx_IOy analog switch disabled (opened)"]
    Disabled = 0,
    #[doc = "1: Gx_IOy analog switch enabled (closed)"]
    Enabled = 1,
}
...
pub type G1_IO1_W<'a, const O: u8> = crate::BitWriter<'a, u32, IOASCR_SPEC, G1_IO1_A, O>;
impl<'a, const O: u8> G1_IO1_W<'a, O> {
    #[doc = "Gx_IOy analog switch disabled (opened)"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(G1_IO1_A::Disabled)
    }
    #[doc = "Gx_IOy analog switch enabled (closed)"]
    #[inline(always)]
