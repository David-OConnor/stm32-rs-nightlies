...
pub enum G1_IO1_A {
    #[doc = "0: Gx_IOy Schmitt trigger hysteresis disabled"]
    Disabled = 0,
    #[doc = "1: Gx_IOy Schmitt trigger hysteresis enabled"]
    Enabled = 1,
}
...
impl<'a, const O: u8> G1_IO1_W<'a, O> {
    #[doc = "Gx_IOy Schmitt trigger hysteresis disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(G1_IO1_A::Disabled)
    }
    #[doc = "Gx_IOy Schmitt trigger hysteresis enabled"]
    #[inline(always)]
