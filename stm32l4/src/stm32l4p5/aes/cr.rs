...
#[doc = "Field `GCMPH` reader - GCM or CCM phase selection"]
...
#[doc = "Field `GCMPH` writer - GCM or CCM phase selection"]
...
impl KEYSIZE_R {
    ...
    pub fn variant(&self) -> KEYSIZE_A {
        match self.bits {
            false => KEYSIZE_A::Aes128,
            true => KEYSIZE_A::Aes256,
        }
    }
...
#[doc = "Field `NPBLB` reader - Number of padding bytes in last block"]
pub type NPBLB_R = crate::FieldReader<u8, u8>;
#[doc = "Field `NPBLB` writer - Number of padding bytes in last block"]
...
impl R {
    ...
    #[doc = "Bits 13:14 - GCM or CCM phase selection"]
    #[inline(always)]
    ...
    #[doc = "Bits 20:23 - Number of padding bytes in last block"]
    #[inline(always)]
