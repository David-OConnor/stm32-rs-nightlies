...
pub type TRIS_R = crate::BitReader<TRIS_A>;
...
impl From<TRIS_A> for bool {
    #[inline(always)]
    fn from(variant: TRIS_A) -> Self {
        variant as u8 != 0
    }
}
impl TRIS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TRIS_A {
        match self.bits {
            false => TRIS_A::DrivenWhileInactive,
            true => TRIS_A::HighZ,
        }
    }
    #[doc = "Checks if the value of the field is `DrivenWhileInactive`"]
    #[inline(always)]
    pub fn is_driven_while_inactive(&self) -> bool {
        *self == TRIS_A::DrivenWhileInactive
    }
...
pub type TRIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR2_SPEC, TRIS_A, O>;
impl<'a, const O: u8> TRIS_W<'a, O> {
    #[doc = "SD output line is still driven by the SAI when a slot is inactive"]
    #[inline(always)]
    pub fn driven_while_inactive(self) -> &'a mut W {
        self.variant(TRIS_A::DrivenWhileInactive)
    }
...
pub type MUTECNT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CR2_SPEC, u8, u8, 6, O>;
