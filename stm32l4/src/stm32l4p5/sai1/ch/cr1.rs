...
pub type NOMCK_R = crate::BitReader<NOMCK_A>;
#[doc = "No divider\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum NOMCK_A {
    #[doc = "0: Master clock generator is enabled"]
    Enabled = 0,
    #[doc = "1: Master clock generator is disabled. The clock divider controlled by MCKDIV can still be used to generate the bit clock"]
    Disabled = 1,
}
impl From<NOMCK_A> for bool {
    #[inline(always)]
    fn from(variant: NOMCK_A) -> Self {
        variant as u8 != 0
    }
}
impl NOMCK_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> NOMCK_A {
        match self.bits {
            false => NOMCK_A::Enabled,
            true => NOMCK_A::Disabled,
        }
    }
    #[doc = "Checks if the value of the field is `Enabled`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == NOMCK_A::Enabled
    }
    #[doc = "Checks if the value of the field is `Disabled`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == NOMCK_A::Disabled
    }
}
#[doc = "Field `NOMCK` writer - No divider"]
pub type NOMCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, NOMCK_A, O>;
impl<'a, const O: u8> NOMCK_W<'a, O> {
    #[doc = "Master clock generator is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(NOMCK_A::Enabled)
    }
    #[doc = "Master clock generator is disabled. The clock divider controlled by MCKDIV can still be used to generate the bit clock"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(NOMCK_A::Disabled)
    }
}
...
pub type OSR_R = crate::BitReader<OSR_A>;
#[doc = "Oversampling ratio for master clock\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OSR_A {
    #[doc = "0: Master clock frequency = FFS x 256"]
    Multiplier256 = 0,
    #[doc = "1: Master clock frequency = FFS x 512"]
    Multiplier512 = 1,
}
impl From<OSR_A> for bool {
    #[inline(always)]
...
impl OSR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> OSR_A {
        match self.bits {
            false => OSR_A::Multiplier256,
            true => OSR_A::Multiplier512,
        }
    }
    #[doc = "Checks if the value of the field is `Multiplier256`"]
    #[inline(always)]
    pub fn is_multiplier256(&self) -> bool {
        *self == OSR_A::Multiplier256
    }
    #[doc = "Checks if the value of the field is `Multiplier512`"]
    #[inline(always)]
    pub fn is_multiplier512(&self) -> bool {
        *self == OSR_A::Multiplier512
    }
}
#[doc = "Field `OSR` writer - Oversampling ratio for master clock"]
pub type OSR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, OSR_A, O>;
impl<'a, const O: u8> OSR_W<'a, O> {
    #[doc = "Master clock frequency = FFS x 256"]
    #[inline(always)]
    pub fn multiplier256(self) -> &'a mut W {
        self.variant(OSR_A::Multiplier256)
    }
    #[doc = "Master clock frequency = FFS x 512"]
    #[inline(always)]
    pub fn multiplier512(self) -> &'a mut W {
        self.variant(OSR_A::Multiplier512)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nomck(&mut self) -> NOMCK_W<19> {
        NOMCK_W::new(self)
    }
    #[doc = "Bits 20:23 - Master clock divider"]
    #[inline(always)]
