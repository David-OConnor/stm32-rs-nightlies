...
pub type SIG_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RG3CR_SPEC, u8, SIG_ID_A, 5, O>;
...
pub type OIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RG3CR_SPEC, OIE_A, O>;
...
#[doc = "DMA request generator channel 3 enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum GE_A {
...
pub type GE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RG3CR_SPEC, GE_A, O>;
...
pub type GPOL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, RG3CR_SPEC, u8, GPOL_A, 2, O>;
...
pub type GNBREQ_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, RG3CR_SPEC, u8, u8, 5, O>;
impl R {
