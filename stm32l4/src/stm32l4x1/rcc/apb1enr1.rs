...
#[doc = "Field `SPI2EN` reader - SPI peripheral 2 clock enable"]
pub type SPI2EN_R = crate::BitReader<bool>;
#[doc = "Field `SPI2EN` writer - SPI peripheral 2 clock enable"]
...
#[doc = "Field `USBF` reader - USB FS clock enable"]
pub type USBF_R = crate::BitReader<bool>;
#[doc = "Field `USBF` writer - USB FS clock enable"]
pub type USBF_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB1ENR1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 14 - SPI peripheral 2 clock enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbf(&mut self) -> USBF_W<26> {
        USBF_W::new(self)
    }
    #[doc = "Bit 28 - Power interface clock enable"]
    #[inline(always)]
