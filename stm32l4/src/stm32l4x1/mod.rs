#![doc = "Peripheral access API for STM32L4X1 microcontrollers (generated using svd2rust v0.28.0 (27eebb4 2022-12-25))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl USB_SRAM {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb_sram::RegisterBlock = 0x4000_6c00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const usb_sram::RegisterBlock {
        Self::PTR
    }
}
impl Deref for USB_SRAM {
    type Target = usb_sram::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
...
impl USB_FS {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb_sram::RegisterBlock = 0x4000_6800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const usb_sram::RegisterBlock {
        Self::PTR
...
#[doc = "Universal serial bus full-speed device interface"]
pub use self::usb_sram as usb_fs;
