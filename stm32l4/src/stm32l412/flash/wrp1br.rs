...
pub type WRP1B_END_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRP1BR_SPEC, u8, u8, 8, O>;
...
pub type WRP1B_STRT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WRP1BR_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrp1b_end(&mut self) -> WRP1B_END_W<0> {
        WRP1B_END_W::new(self)
    }
    #[doc = "Bits 16:23 - Bank 1 WRP second area B end offset"]
    #[inline(always)]
    #[must_use]
    pub fn wrp1b_strt(&mut self) -> WRP1B_STRT_W<16> {
