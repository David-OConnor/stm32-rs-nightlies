...
#[doc = "Field `UCESM` reader - USART Clock Enable in Stop mode"]
pub type UCESM_R = crate::BitReader<UCESM_A>;
#[doc = "USART Clock Enable in Stop mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum UCESM_A {
    #[doc = "0: USART clock is disabled in STOP mode"]
    Disabled = 0,
    #[doc = "1: USART clock is enabled in STOP mode"]
    Enabled = 1,
}
impl From<UCESM_A> for bool {
    #[inline(always)]
    fn from(variant: UCESM_A) -> Self {
        variant as u8 != 0
    }
}
impl UCESM_R {
    ...
    pub fn variant(&self) -> UCESM_A {
        match self.bits {
            false => UCESM_A::Disabled,
            true => UCESM_A::Enabled,
        }
    }
    #[doc = "Checks if the value of the field is `Disabled`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == UCESM_A::Disabled
    }
    #[doc = "Checks if the value of the field is `Enabled`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == UCESM_A::Enabled
    }
}
#[doc = "Field `UCESM` writer - USART Clock Enable in Stop mode"]
pub type UCESM_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR3_SPEC, UCESM_A, O>;
impl<'a, const O: u8> UCESM_W<'a, O> {
    #[doc = "USART clock is disabled in STOP mode"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(UCESM_A::Disabled)
    }
    #[doc = "USART clock is enabled in STOP mode"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(UCESM_A::Enabled)
    }
}
...
pub enum TCBGTIE_A {
    #[doc = "0: Interrupt is inhibited"]
    Disabled = 0,
    #[doc = "1: An USART interrupt is generated whenever TCBGT=1 in the ISR register"]
    Enabled = 1,
}
...
impl<'a, const O: u8> TCBGTIE_W<'a, O> {
    ...
    #[doc = "An USART interrupt is generated whenever TCBGT=1 in the ISR register"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bit 23 - USART Clock Enable in Stop mode"]
    #[inline(always)]
    pub fn ucesm(&self) -> UCESM_R {
        UCESM_R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucesm(&mut self) -> UCESM_W<23> {
        UCESM_W::new(self)
    }
    #[doc = "Bit 24 - Transmission complete before guard time interrupt enable"]
    #[inline(always)]
