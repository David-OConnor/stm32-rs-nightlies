...
pub type FWEN_R = crate::BitReader<bool>;
#[doc = "Field `FWEN` writer - Firewall clock enable"]
pub type FWEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2ENR_SPEC, bool, O>;
...
pub type DFSDM1EN_R = crate::BitReader<bool>;
#[doc = "Field `DFSDM1EN` writer - DFSDM timer clock enable"]
pub type DFSDM1EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2ENR_SPEC, bool, O>;
...
pub type LTDCEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2ENR_SPEC, bool, O>;
#[doc = "Field `DSIEN` reader - DSI clock enable"]
pub type DSIEN_R = crate::BitReader<bool>;
#[doc = "Field `DSIEN` writer - DSI clock enable"]
pub type DSIEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, APB2ENR_SPEC, bool, O>;
impl R {
