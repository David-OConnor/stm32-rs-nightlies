...
#[doc = "`read()` method returns [lut772l::R](R) reader structure"]
impl crate::Readable for LUT772L_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lut772l::W](W) writer structure"]
impl crate::Writable for LUT772L_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LUT772L to value 0"]
