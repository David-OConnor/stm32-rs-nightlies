...
pub struct R(crate::R<LUT1005H_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LUT1005H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LUT1005H_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LUT1005H_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LUT1005H` writer"]
pub struct W(crate::W<LUT1005H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LUT1005H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LUT1005H_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LUT1005H_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LUT1005H_SPEC, u32, u32, 18, O>;
impl R {
