...
#[doc = "`read()` method returns [lut34h::R](R) reader structure"]
impl crate::Readable for LUT34H_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lut34h::W](W) writer structure"]
impl crate::Writable for LUT34H_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LUT34H to value 0"]
