...
pub struct R(crate::R<L2WVPCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L2WVPCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L2WVPCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L2WVPCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L2WVPCR` writer"]
pub struct W(crate::W<L2WVPCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L2WVPCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L2WVPCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L2WVPCR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WVSTPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L2WVPCR_SPEC, u16, u16, 11, O>;
...
pub type WVSPPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L2WVPCR_SPEC, u16, u16, 11, O>;
impl R {
