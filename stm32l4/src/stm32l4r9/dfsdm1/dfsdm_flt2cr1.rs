...
impl From<crate::R<DFSDM_FLT2CR1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<DFSDM_FLT2CR1_SPEC>> for W {
    #[inline(always)]
...
pub type DFEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type JSWSTART_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type JSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type JSCAN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type JDMAEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type JEXTSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT2CR1_SPEC, u8, u8, 3, O>;
...
pub type JEXTEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT2CR1_SPEC, u8, u8, 2, O>;
...
pub type RSWSTART_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type RCONT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type RSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type RDMAEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type RCH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT2CR1_SPEC, u8, u8, 3, O>;
...
pub type FAST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
...
pub type AWFSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, DFSDM_FLT2CR1_SPEC, bool, O>;
impl R {
