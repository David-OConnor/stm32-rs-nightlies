...
#[doc = "Field `PEMPTY` reader - Program empty"]
pub type PEMPTY_R = crate::BitReader<bool>;
#[doc = "Field `PEMPTY` writer - Program empty"]
pub type PEMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SR_SPEC, bool, O>;
impl R {
