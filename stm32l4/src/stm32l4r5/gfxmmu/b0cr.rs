...
#[doc = "`read()` method returns [b0cr::R](R) reader structure"]
impl crate::Readable for B0CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [b0cr::W](W) writer structure"]
impl crate::Writable for B0CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets B0CR to value 0"]
