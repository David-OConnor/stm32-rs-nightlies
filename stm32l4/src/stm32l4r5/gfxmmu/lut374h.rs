...
#[doc = "`read()` method returns [lut374h::R](R) reader structure"]
impl crate::Readable for LUT374H_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lut374h::W](W) writer structure"]
impl crate::Writable for LUT374H_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LUT374H to value 0"]
