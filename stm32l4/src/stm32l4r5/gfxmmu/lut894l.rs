...
#[doc = "`read()` method returns [lut894l::R](R) reader structure"]
impl crate::Readable for LUT894L_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lut894l::W](W) writer structure"]
impl crate::Writable for LUT894L_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LUT894L to value 0"]
