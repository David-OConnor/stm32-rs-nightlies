...
impl From<crate::R<DFSDM_FLT0FCR_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<DFSDM_FLT0FCR_SPEC>> for W {
    #[inline(always)]
...
pub type IOSR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT0FCR_SPEC, u8, u8, 8, O>;
...
pub type FOSR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT0FCR_SPEC, u16, u16, 10, O>;
#[doc = "Field `FORD` reader - Sinc filter order"]
pub type FORD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FORD` writer - Sinc filter order"]
pub type FORD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT0FCR_SPEC, u8, u8, 3, O>;
impl R {
