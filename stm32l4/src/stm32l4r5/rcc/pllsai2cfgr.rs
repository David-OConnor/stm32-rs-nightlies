...
pub type PLLSAI2M_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PLLSAI2M` writer - Division factor for PLLSAI2 input clock"]
pub type PLLSAI2M_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PLLSAI2CFGR_SPEC, u8, u8, 4, O>;
...
pub type PLLSAI2QEN_R = crate::BitReader<bool>;
#[doc = "Field `PLLSAI2QEN` writer - PLLSAI2 division factor for PLLDISCLK"]
pub type PLLSAI2QEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLLSAI2CFGR_SPEC, bool, O>;
#[doc = "Field `PLLSAI2Q` reader - SAI2PLL PLLSAI2CLK output enable"]
pub type PLLSAI2Q_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PLLSAI2Q` writer - SAI2PLL PLLSAI2CLK output enable"]
pub type PLLSAI2Q_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PLLSAI2CFGR_SPEC, u8, u8, 2, O>;
