...
pub type DMAMUX1EN_R = crate::BitReader<bool>;
#[doc = "Field `DMAMUX1EN` writer - DMAMUX clock enable"]
pub type DMAMUX1EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB1ENR_SPEC, bool, O>;
...
pub type GFXMMUEN_R = crate::BitReader<bool>;
#[doc = "Field `GFXMMUEN` writer - Graphic MMU clock enable"]
pub type GFXMMUEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB1ENR_SPEC, bool, O>;
impl R {
