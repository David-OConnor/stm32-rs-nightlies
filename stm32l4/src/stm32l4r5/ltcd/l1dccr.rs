...
pub type DCBLUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L1DCCR_SPEC, u8, u8, 8, O>;
...
pub type DCGREEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L1DCCR_SPEC, u8, u8, 8, O>;
#[doc = "Field `DCRED` reader - Default Color Red"]
pub type DCRED_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DCRED` writer - Default Color Red"]
pub type DCRED_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L1DCCR_SPEC, u8, u8, 8, O>;
...
pub type DCALPHA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, L1DCCR_SPEC, u8, u8, 8, O>;
impl R {
