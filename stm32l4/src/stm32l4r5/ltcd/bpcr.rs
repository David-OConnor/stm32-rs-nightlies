...
pub type AVBP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BPCR_SPEC, u16, u16, 11, O>;
...
pub type AHBP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BPCR_SPEC, u16, u16, 12, O>;
impl R {
