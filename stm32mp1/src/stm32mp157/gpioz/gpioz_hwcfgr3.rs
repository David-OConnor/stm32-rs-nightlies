...
pub struct R(crate::R<GPIOZ_HWCFGR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOZ_HWCFGR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOZ_HWCFGR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOZ_HWCFGR3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO hardware configuration register 3\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioz_hwcfgr3](index.html) module"]
pub struct GPIOZ_HWCFGR3_SPEC;
impl crate::RegisterSpec for GPIOZ_HWCFGR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioz_hwcfgr3::R](R) reader structure"]
impl crate::Readable for GPIOZ_HWCFGR3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOZ_HWCFGR3 to value 0"]
impl crate::Resettable for GPIOZ_HWCFGR3_SPEC {
