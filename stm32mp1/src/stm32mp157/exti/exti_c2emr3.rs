#[doc = "Register `EXTI_C2EMR3` reader"]
...
#[doc = "Register `EXTI_C2EMR3` writer"]
...
#[doc = "`read()` method returns [exti_c2emr3::R](R) reader structure"]
impl crate::Readable for EXTI_C2EMR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [exti_c2emr3::W](W) writer structure"]
impl crate::Writable for EXTI_C2EMR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EXTI_C2EMR3 to value 0"]
