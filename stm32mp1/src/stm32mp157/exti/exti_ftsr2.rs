#[doc = "Register `EXTI_FTSR2` reader"]
...
#[doc = "Register `EXTI_FTSR2` writer"]
...
#[doc = "`read()` method returns [exti_ftsr2::R](R) reader structure"]
impl crate::Readable for EXTI_FTSR2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [exti_ftsr2::W](W) writer structure"]
impl crate::Writable for EXTI_FTSR2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EXTI_FTSR2 to value 0"]
