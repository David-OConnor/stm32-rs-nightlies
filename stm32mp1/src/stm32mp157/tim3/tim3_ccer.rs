...
#[doc = "`read()` method returns [tim3_ccer::R](R) reader structure"]
impl crate::Readable for TIM3_CCER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim3_ccer::W](W) writer structure"]
impl crate::Writable for TIM3_CCER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM3_CCER to value 0"]
