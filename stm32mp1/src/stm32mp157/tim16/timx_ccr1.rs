...
#[doc = "`read()` method returns [timx_ccr1::R](R) reader structure"]
impl crate::Readable for TIMX_CCR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timx_ccr1::W](W) writer structure"]
impl crate::Writable for TIMX_CCR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIMx_CCR1 to value 0"]
