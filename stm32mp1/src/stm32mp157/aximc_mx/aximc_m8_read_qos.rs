#[doc = "Register `AXIMC_M8_READ_QOS` reader"]
...
#[doc = "Register `AXIMC_M8_READ_QOS` writer"]
...
#[doc = "`read()` method returns [aximc_m8_read_qos::R](R) reader structure"]
impl crate::Readable for AXIMC_M8_READ_QOS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [aximc_m8_read_qos::W](W) writer structure"]
impl crate::Writable for AXIMC_M8_READ_QOS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AXIMC_M8_READ_QOS to value 0x08"]
