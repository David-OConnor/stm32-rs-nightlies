...
pub struct R(crate::R<AXIMC_M6_FN_MOD_AHB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AXIMC_M6_FN_MOD_AHB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AXIMC_M6_FN_MOD_AHB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AXIMC_M6_FN_MOD_AHB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AXIMC_M6_FN_MOD_AHB` writer"]
pub struct W(crate::W<AXIMC_M6_FN_MOD_AHB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AXIMC_M6_FN_MOD_AHB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AXIMC_M6_FN_MOD_AHB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AXIMC_M6_FN_MOD_AHB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RD_INC_OVERRIDE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, AXIMC_M6_FN_MOD_AHB_SPEC, bool, O>;
...
#[doc = "AXIMC master 6 AHB conversion override functionality register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [aximc_m6_fn_mod_ahb](index.html) module"]
pub struct AXIMC_M6_FN_MOD_AHB_SPEC;
impl crate::RegisterSpec for AXIMC_M6_FN_MOD_AHB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [aximc_m6_fn_mod_ahb::R](R) reader structure"]
impl crate::Readable for AXIMC_M6_FN_MOD_AHB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [aximc_m6_fn_mod_ahb::W](W) writer structure"]
impl crate::Writable for AXIMC_M6_FN_MOD_AHB_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AXIMC_M6_FN_MOD_AHB to value 0"]
impl crate::Resettable for AXIMC_M6_FN_MOD_AHB_SPEC {
