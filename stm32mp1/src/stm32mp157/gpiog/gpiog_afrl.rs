#[doc = "Register `GPIOG_AFRL` reader"]
...
#[doc = "Register `GPIOG_AFRL` writer"]
...
#[doc = "`read()` method returns [gpiog_afrl::R](R) reader structure"]
impl crate::Readable for GPIOG_AFRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpiog_afrl::W](W) writer structure"]
impl crate::Writable for GPIOG_AFRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOG_AFRL to value 0"]
