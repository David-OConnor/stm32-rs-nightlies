#[doc = "Register `GPIOK_LCKR` reader"]
pub struct R(crate::R<GPIOK_LCKR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOK_LCKR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOK_LCKR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOK_LCKR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOK_LCKR` writer"]
pub struct W(crate::W<GPIOK_LCKR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOK_LCKR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOK_LCKR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOK_LCKR_SPEC>) -> Self {
        W(writer)
    }
}
...
must not change. When the LOCK sequence has been applied on a port bit, the value of this port bit can no longer be modified until the next MCU reset or peripheral reset. A specific write sequence is used to write to the GPIOx_LCKR register. Only word access (32-bit long) is allowed during this locking sequence. Each lock bit freezes a specific configuration register (control and alternate function registers).\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpiok_lckr](index.html) module"]
pub struct GPIOK_LCKR_SPEC;
impl crate::RegisterSpec for GPIOK_LCKR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpiok_lckr::R](R) reader structure"]
impl crate::Readable for GPIOK_LCKR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpiok_lckr::W](W) writer structure"]
impl crate::Writable for GPIOK_LCKR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOK_LCKR to value 0"]
impl crate::Resettable for GPIOK_LCKR_SPEC {
