#[doc = "Register `GPIOK_MODER` reader"]
pub struct R(crate::R<GPIOK_MODER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOK_MODER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOK_MODER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOK_MODER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOK_MODER` writer"]
pub struct W(crate::W<GPIOK_MODER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOK_MODER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOK_MODER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOK_MODER_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO port mode register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpiok_moder](index.html) module"]
pub struct GPIOK_MODER_SPEC;
impl crate::RegisterSpec for GPIOK_MODER_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpiok_moder::R](R) reader structure"]
impl crate::Readable for GPIOK_MODER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpiok_moder::W](W) writer structure"]
impl crate::Writable for GPIOK_MODER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOK_MODER to value 0xffff_ffff"]
impl crate::Resettable for GPIOK_MODER_SPEC {
