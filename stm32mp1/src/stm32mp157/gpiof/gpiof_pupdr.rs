#[doc = "Register `GPIOF_PUPDR` reader"]
...
#[doc = "Register `GPIOF_PUPDR` writer"]
...
#[doc = "`read()` method returns [gpiof_pupdr::R](R) reader structure"]
impl crate::Readable for GPIOF_PUPDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpiof_pupdr::W](W) writer structure"]
impl crate::Writable for GPIOF_PUPDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOF_PUPDR to value 0"]
