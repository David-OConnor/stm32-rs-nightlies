#[doc = "Register `GPIOA_PUPDR` reader"]
pub struct R(crate::R<GPIOA_PUPDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOA_PUPDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOA_PUPDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOA_PUPDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOA_PUPDR` writer"]
pub struct W(crate::W<GPIOA_PUPDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOA_PUPDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOA_PUPDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOA_PUPDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO port pull-up/pull-down register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioa_pupdr](index.html) module"]
pub struct GPIOA_PUPDR_SPEC;
impl crate::RegisterSpec for GPIOA_PUPDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioa_pupdr::R](R) reader structure"]
impl crate::Readable for GPIOA_PUPDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpioa_pupdr::W](W) writer structure"]
impl crate::Writable for GPIOA_PUPDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOA_PUPDR to value 0"]
impl crate::Resettable for GPIOA_PUPDR_SPEC {
