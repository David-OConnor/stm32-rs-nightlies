...
pub type EOIINTID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICV_EOIR_SPEC, u16, u16, 10, O>;
#[doc = "Field `CPUID` writer - CPUID"]
pub type CPUID_W<'a, const O: u8> = crate::BitWriter<'a, u32, GICV_EOIR_SPEC, bool, O>;
impl W {
