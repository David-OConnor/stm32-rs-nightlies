#[doc = "Register `GPIOE_OSPEEDR` reader"]
pub struct R(crate::R<GPIOE_OSPEEDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOE_OSPEEDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOE_OSPEEDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOE_OSPEEDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOE_OSPEEDR` writer"]
pub struct W(crate::W<GPIOE_OSPEEDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOE_OSPEEDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOE_OSPEEDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOE_OSPEEDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OSPEEDR0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GPIOE_OSPEEDR_SPEC, u8, u8, 2, O>;
...
#[doc = "GPIO port output speed register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioe_ospeedr](index.html) module"]
pub struct GPIOE_OSPEEDR_SPEC;
impl crate::RegisterSpec for GPIOE_OSPEEDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioe_ospeedr::R](R) reader structure"]
impl crate::Readable for GPIOE_OSPEEDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpioe_ospeedr::W](W) writer structure"]
impl crate::Writable for GPIOE_OSPEEDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOE_OSPEEDR to value 0"]
impl crate::Resettable for GPIOE_OSPEEDR_SPEC {
