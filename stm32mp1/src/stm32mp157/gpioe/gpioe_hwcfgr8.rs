#[doc = "Register `GPIOE_HWCFGR8` reader"]
pub struct R(crate::R<GPIOE_HWCFGR8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOE_HWCFGR8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOE_HWCFGR8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOE_HWCFGR8_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "For GPIOA, B, C, D, E, F, G, H, I, and GPIOJ: For GPIOK and GPIOZ:\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioe_hwcfgr8](index.html) module"]
pub struct GPIOE_HWCFGR8_SPEC;
impl crate::RegisterSpec for GPIOE_HWCFGR8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioe_hwcfgr8::R](R) reader structure"]
impl crate::Readable for GPIOE_HWCFGR8_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOE_HWCFGR8 to value 0"]
impl crate::Resettable for GPIOE_HWCFGR8_SPEC {
