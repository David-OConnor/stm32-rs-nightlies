...
pub struct R(crate::R<TIM8_CCMR1ALTERNATE8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM8_CCMR1ALTERNATE8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM8_CCMR1ALTERNATE8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM8_CCMR1ALTERNATE8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM8_CCMR1ALTERNATE8` writer"]
pub struct W(crate::W<TIM8_CCMR1ALTERNATE8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM8_CCMR1ALTERNATE8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM8_CCMR1ALTERNATE8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM8_CCMR1ALTERNATE8_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CC1S_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM8_CCMR1ALTERNATE8_SPEC, u8, u8, 2, O>;
...
pub type IC1F_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIM8_CCMR1ALTERNATE8_SPEC, u8, u8, 4, O>;
