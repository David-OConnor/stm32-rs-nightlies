#[doc = "Register `DFSDM_FLT5ICR` reader"]
...
#[doc = "Register `DFSDM_FLT5ICR` writer"]
...
#[doc = "`read()` method returns [dfsdm_flt5icr::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT5ICR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_flt5icr::W](W) writer structure"]
impl crate::Writable for DFSDM_FLT5ICR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_FLT5ICR to value 0"]
