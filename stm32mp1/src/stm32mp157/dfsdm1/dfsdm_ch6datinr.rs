...
pub struct R(crate::R<DFSDM_CH6DATINR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM_CH6DATINR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM_CH6DATINR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM_CH6DATINR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM_CH6DATINR` writer"]
pub struct W(crate::W<DFSDM_CH6DATINR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM_CH6DATINR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM_CH6DATINR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM_CH6DATINR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INDAT0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_CH6DATINR_SPEC, u16, u16, 16, O>;
