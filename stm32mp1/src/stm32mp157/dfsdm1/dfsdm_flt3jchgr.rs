...
impl From<crate::R<DFSDM_FLT3JCHGR_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<DFSDM_FLT3JCHGR_SPEC>> for W {
    #[inline(always)]
...
pub type JCHG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT3JCHGR_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - JCHG"]
    #[inline(always)]
