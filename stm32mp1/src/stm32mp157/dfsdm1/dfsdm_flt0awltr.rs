...
impl From<crate::R<DFSDM_FLT0AWLTR_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<DFSDM_FLT0AWLTR_SPEC>> for W {
    #[inline(always)]
...
pub type BKAWL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DFSDM_FLT0AWLTR_SPEC, u8, u8, 4, O>;
...
pub type AWLT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_FLT0AWLTR_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:3 - BKAWL"]
    #[inline(always)]
