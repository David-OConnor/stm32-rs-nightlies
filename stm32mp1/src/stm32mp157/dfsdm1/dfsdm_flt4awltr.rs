#[doc = "Register `DFSDM_FLT4AWLTR` reader"]
...
#[doc = "Register `DFSDM_FLT4AWLTR` writer"]
...
#[doc = "`read()` method returns [dfsdm_flt4awltr::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT4AWLTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_flt4awltr::W](W) writer structure"]
impl crate::Writable for DFSDM_FLT4AWLTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_FLT4AWLTR to value 0"]
