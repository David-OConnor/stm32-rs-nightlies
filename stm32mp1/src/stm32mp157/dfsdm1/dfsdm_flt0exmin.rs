...
#[doc = "Register `DFSDM_FLT0EXMIN` writer"]
pub struct W(crate::W<DFSDM_FLT0EXMIN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM_FLT0EXMIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM_FLT0EXMIN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM_FLT0EXMIN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EXMIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DFSDM_FLT0EXMIN_SPEC, u32, u32, 24, O>;
impl R {
...
#[doc = "`write(|w| ..)` method takes [dfsdm_flt0exmin::W](W) writer structure"]
impl crate::Writable for DFSDM_FLT0EXMIN_SPEC {
    type Writer = W;
