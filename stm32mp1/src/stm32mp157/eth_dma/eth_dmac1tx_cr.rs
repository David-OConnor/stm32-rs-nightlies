...
pub struct R(crate::R<ETH_DMAC1TX_CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_DMAC1TX_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_DMAC1TX_CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_DMAC1TX_CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ETH_DMAC1TxCR` writer"]
pub struct W(crate::W<ETH_DMAC1TX_CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_DMAC1TX_CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_DMAC1TX_CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_DMAC1TX_CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_DMAC1TX_CR_SPEC, bool, O>;
#[doc = "Field `TCW` reader - TCW"]
pub type TCW_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TCW` writer - TCW"]
pub type TCW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_DMAC1TX_CR_SPEC, u8, u8, 3, O>;
#[doc = "Field `OSF` reader - OSF"]
pub type OSF_R = crate::BitReader<bool>;
#[doc = "Field `OSF` writer - OSF"]
pub type OSF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_DMAC1TX_CR_SPEC, bool, O>;
#[doc = "Field `TSE` reader - TSE"]
pub type TSE_R = crate::BitReader<bool>;
#[doc = "Field `TSE` writer - TSE"]
pub type TSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_DMAC1TX_CR_SPEC, bool, O>;
#[doc = "Field `TXPBL` reader - TXPBL"]
pub type TXPBL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TXPBL` writer - TXPBL"]
pub type TXPBL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_DMAC1TX_CR_SPEC, u8, u8, 6, O>;
#[doc = "Field `TQOS` reader - TQOS"]
pub type TQOS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TQOS` writer - TQOS"]
pub type TQOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_DMAC1TX_CR_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bit 0 - ST"]
    #[inline(always)]
    pub fn st(&self) -> ST_R {
...
#[doc = "Channel 1 transmit control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_dmac1tx_cr](index.html) module"]
pub struct ETH_DMAC1TX_CR_SPEC;
impl crate::RegisterSpec for ETH_DMAC1TX_CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_dmac1tx_cr::R](R) reader structure"]
impl crate::Readable for ETH_DMAC1TX_CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_dmac1tx_cr::W](W) writer structure"]
impl crate::Writable for ETH_DMAC1TX_CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ETH_DMAC1TxCR to value 0"]
impl crate::Resettable for ETH_DMAC1TX_CR_SPEC {
