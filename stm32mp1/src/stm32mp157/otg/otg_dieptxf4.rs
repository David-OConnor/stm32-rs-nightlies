#[doc = "Register `OTG_DIEPTXF4` reader"]
...
#[doc = "Register `OTG_DIEPTXF4` writer"]
...
#[doc = "`read()` method returns [otg_dieptxf4::R](R) reader structure"]
impl crate::Readable for OTG_DIEPTXF4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_dieptxf4::W](W) writer structure"]
impl crate::Writable for OTG_DIEPTXF4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_DIEPTXF4 to value 0x0200_0400"]
