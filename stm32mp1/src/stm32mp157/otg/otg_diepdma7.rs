#[doc = "Register `OTG_DIEPDMA7` reader"]
...
#[doc = "Register `OTG_DIEPDMA7` writer"]
...
#[doc = "`read()` method returns [otg_diepdma7::R](R) reader structure"]
impl crate::Readable for OTG_DIEPDMA7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_diepdma7::W](W) writer structure"]
impl crate::Writable for OTG_DIEPDMA7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_DIEPDMA7 to value 0"]
