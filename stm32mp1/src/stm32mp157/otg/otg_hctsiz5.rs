#[doc = "Register `OTG_HCTSIZ5` reader"]
...
#[doc = "Register `OTG_HCTSIZ5` writer"]
...
#[doc = "`read()` method returns [otg_hctsiz5::R](R) reader structure"]
impl crate::Readable for OTG_HCTSIZ5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_hctsiz5::W](W) writer structure"]
impl crate::Writable for OTG_HCTSIZ5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_HCTSIZ5 to value 0"]
