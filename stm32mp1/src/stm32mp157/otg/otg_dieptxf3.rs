...
pub struct R(crate::R<OTG_DIEPTXF3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_DIEPTXF3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_DIEPTXF3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_DIEPTXF3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_DIEPTXF3` writer"]
pub struct W(crate::W<OTG_DIEPTXF3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_DIEPTXF3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_DIEPTXF3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_DIEPTXF3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INEPTXSA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_DIEPTXF3_SPEC, u16, u16, 16, O>;
