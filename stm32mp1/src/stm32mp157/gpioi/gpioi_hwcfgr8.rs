...
pub struct R(crate::R<GPIOI_HWCFGR8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOI_HWCFGR8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOI_HWCFGR8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOI_HWCFGR8_SPEC>) -> Self {
        R(reader)
    }
}
