#[doc = "Register `DMAMUX_C1CR` reader"]
...
#[doc = "Register `DMAMUX_C1CR` writer"]
...
#[doc = "`read()` method returns [dmamux_c1cr::R](R) reader structure"]
impl crate::Readable for DMAMUX_C1CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmamux_c1cr::W](W) writer structure"]
impl crate::Writable for DMAMUX_C1CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMAMUX_C1CR to value 0"]
