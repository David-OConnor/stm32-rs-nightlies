...
pub struct R(crate::R<BSEC_OTP_WRLOCK0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BSEC_OTP_WRLOCK0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BSEC_OTP_WRLOCK0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BSEC_OTP_WRLOCK0_SPEC>) -> Self {
        R(reader)
    }
}
