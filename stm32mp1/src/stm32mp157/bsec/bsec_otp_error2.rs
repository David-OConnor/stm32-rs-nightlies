...
pub struct R(crate::R<BSEC_OTP_ERROR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BSEC_OTP_ERROR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BSEC_OTP_ERROR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BSEC_OTP_ERROR2_SPEC>) -> Self {
        R(reader)
    }
}
