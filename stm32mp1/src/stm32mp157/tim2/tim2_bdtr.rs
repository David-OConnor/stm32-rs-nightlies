...
pub struct R(crate::R<TIM2_BDTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM2_BDTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM2_BDTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM2_BDTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM2_BDTR` writer"]
pub struct W(crate::W<TIM2_BDTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM2_BDTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM2_BDTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM2_BDTR_SPEC>) -> Self {
        W(writer)
    }
}
