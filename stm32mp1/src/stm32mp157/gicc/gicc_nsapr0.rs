...
pub type NSAPR0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `NSAPR0` writer - NSAPR0"]
pub type NSAPR0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICC_NSAPR0_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nsapr0(&mut self) -> NSAPR0_W<0> {
        NSAPR0_W::new(self)
    }
