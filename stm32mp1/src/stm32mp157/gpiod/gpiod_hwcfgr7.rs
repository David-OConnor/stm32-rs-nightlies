#[doc = "Register `GPIOD_HWCFGR7` reader"]
pub struct R(crate::R<GPIOD_HWCFGR7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOD_HWCFGR7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOD_HWCFGR7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOD_HWCFGR7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO hardware configuration register 7\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpiod_hwcfgr7](index.html) module"]
pub struct GPIOD_HWCFGR7_SPEC;
impl crate::RegisterSpec for GPIOD_HWCFGR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpiod_hwcfgr7::R](R) reader structure"]
impl crate::Readable for GPIOD_HWCFGR7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOD_HWCFGR7 to value 0xffff_ffff"]
impl crate::Resettable for GPIOD_HWCFGR7_SPEC {
