#[doc = "Register `GPIOD_AFRL` reader"]
pub struct R(crate::R<GPIOD_AFRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOD_AFRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOD_AFRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOD_AFRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOD_AFRL` writer"]
pub struct W(crate::W<GPIOD_AFRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOD_AFRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOD_AFRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOD_AFRL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO alternate function low register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpiod_afrl](index.html) module"]
pub struct GPIOD_AFRL_SPEC;
impl crate::RegisterSpec for GPIOD_AFRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpiod_afrl::R](R) reader structure"]
impl crate::Readable for GPIOD_AFRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpiod_afrl::W](W) writer structure"]
impl crate::Writable for GPIOD_AFRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOD_AFRL to value 0"]
impl crate::Resettable for GPIOD_AFRL_SPEC {
