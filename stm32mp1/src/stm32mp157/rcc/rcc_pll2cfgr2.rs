...
pub type DIVP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL2CFGR2_SPEC, u8, u8, 7, O>;
#[doc = "Field `DIVQ` reader - DIVQ"]
pub type DIVQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIVQ` writer - DIVQ"]
pub type DIVQ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL2CFGR2_SPEC, u8, u8, 7, O>;
#[doc = "Field `DIVR` reader - DIVR"]
pub type DIVR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIVR` writer - DIVR"]
pub type DIVR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL2CFGR2_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6 - DIVP"]
    #[inline(always)]
