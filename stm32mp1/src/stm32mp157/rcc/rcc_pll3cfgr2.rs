...
pub struct R(crate::R<RCC_PLL3CFGR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_PLL3CFGR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_PLL3CFGR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_PLL3CFGR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_PLL3CFGR2` writer"]
pub struct W(crate::W<RCC_PLL3CFGR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_PLL3CFGR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_PLL3CFGR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_PLL3CFGR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIVP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3CFGR2_SPEC, u8, u8, 7, O>;
#[doc = "Field `DIVQ` reader - DIVQ"]
pub type DIVQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIVQ` writer - DIVQ"]
pub type DIVQ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3CFGR2_SPEC, u8, u8, 7, O>;
#[doc = "Field `DIVR` reader - DIVR"]
pub type DIVR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DIVR` writer - DIVR"]
pub type DIVR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RCC_PLL3CFGR2_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6 - DIVP"]
    #[inline(always)]
