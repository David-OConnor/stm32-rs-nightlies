...
#[doc = "`read()` method returns [rcc_mc_ahb5lpenclrr::R](R) reader structure"]
impl crate::Readable for RCC_MC_AHB5LPENCLRR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mc_ahb5lpenclrr::W](W) writer structure"]
impl crate::Writable for RCC_MC_AHB5LPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MC_AHB5LPENCLRR to value 0x0171"]
