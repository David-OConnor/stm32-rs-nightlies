...
#[doc = "`read()` method returns [rcc_mc_ahb2ensetr::R](R) reader structure"]
impl crate::Readable for RCC_MC_AHB2ENSETR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mc_ahb2ensetr::W](W) writer structure"]
impl crate::Writable for RCC_MC_AHB2ENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MC_AHB2ENSETR to value 0"]
