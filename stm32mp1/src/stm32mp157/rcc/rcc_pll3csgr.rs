...
pub struct R(crate::R<RCC_PLL3CSGR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_PLL3CSGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_PLL3CSGR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_PLL3CSGR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_PLL3CSGR` writer"]
pub struct W(crate::W<RCC_PLL3CSGR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_PLL3CSGR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_PLL3CSGR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_PLL3CSGR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INC_STEP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RCC_PLL3CSGR_SPEC, u16, u16, 15, O>;
impl R {
