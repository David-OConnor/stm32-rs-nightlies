#[doc = "Register `RCC_PLL1FRACR` reader"]
...
#[doc = "Register `RCC_PLL1FRACR` writer"]
...
pub type FRACLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_PLL1FRACR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 3:15 - FRACV"]
    #[inline(always)]
...
#[doc = "`read()` method returns [rcc_pll1fracr::R](R) reader structure"]
impl crate::Readable for RCC_PLL1FRACR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_pll1fracr::W](W) writer structure"]
impl crate::Writable for RCC_PLL1FRACR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_PLL1FRACR to value 0"]
