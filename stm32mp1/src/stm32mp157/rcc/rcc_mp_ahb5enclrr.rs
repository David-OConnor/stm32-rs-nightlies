#[doc = "Register `RCC_MP_AHB5ENCLRR` reader"]
...
#[doc = "Register `RCC_MP_AHB5ENCLRR` writer"]
...
#[doc = "`read()` method returns [rcc_mp_ahb5enclrr::R](R) reader structure"]
impl crate::Readable for RCC_MP_AHB5ENCLRR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mp_ahb5enclrr::W](W) writer structure"]
impl crate::Writable for RCC_MP_AHB5ENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MP_AHB5ENCLRR to value 0x0001_0000"]
