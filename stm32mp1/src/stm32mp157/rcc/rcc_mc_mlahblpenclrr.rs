...
pub struct R(crate::R<RCC_MC_MLAHBLPENCLRR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_MC_MLAHBLPENCLRR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_MC_MLAHBLPENCLRR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_MC_MLAHBLPENCLRR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_MC_MLAHBLPENCLRR` writer"]
pub struct W(crate::W<RCC_MC_MLAHBLPENCLRR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_MC_MLAHBLPENCLRR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_MC_MLAHBLPENCLRR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_MC_MLAHBLPENCLRR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SRAM1LPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MC_MLAHBLPENCLRR_SPEC, bool, O>;
