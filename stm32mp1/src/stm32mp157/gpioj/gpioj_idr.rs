...
pub struct R(crate::R<GPIOJ_IDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOJ_IDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOJ_IDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOJ_IDR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO port input data register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioj_idr](index.html) module"]
pub struct GPIOJ_IDR_SPEC;
impl crate::RegisterSpec for GPIOJ_IDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioj_idr::R](R) reader structure"]
impl crate::Readable for GPIOJ_IDR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOJ_IDR to value 0"]
impl crate::Resettable for GPIOJ_IDR_SPEC {
