...
pub struct R(crate::R<DDRCTRL_PCFGQOS1_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDRCTRL_PCFGQOS1_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDRCTRL_PCFGQOS1_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDRCTRL_PCFGQOS1_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DDRCTRL_PCFGQOS1_1` writer"]
pub struct W(crate::W<DDRCTRL_PCFGQOS1_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DDRCTRL_PCFGQOS1_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DDRCTRL_PCFGQOS1_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DDRCTRL_PCFGQOS1_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RQOS_MAP_TIMEOUTB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DDRCTRL_PCFGQOS1_1_SPEC, u16, u16, 11, O>;
...
#[doc = "DDRCTRL port 1 read Q0S configuration register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ddrctrl_pcfgqos1_1](index.html) module"]
pub struct DDRCTRL_PCFGQOS1_1_SPEC;
impl crate::RegisterSpec for DDRCTRL_PCFGQOS1_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ddrctrl_pcfgqos1_1::R](R) reader structure"]
impl crate::Readable for DDRCTRL_PCFGQOS1_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ddrctrl_pcfgqos1_1::W](W) writer structure"]
impl crate::Writable for DDRCTRL_PCFGQOS1_1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DDRCTRL_PCFGQOS1_1 to value 0"]
impl crate::Resettable for DDRCTRL_PCFGQOS1_1_SPEC {
