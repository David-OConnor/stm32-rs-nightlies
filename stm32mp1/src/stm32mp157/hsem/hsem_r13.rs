...
pub struct R(crate::R<HSEM_R13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSEM_R13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSEM_R13_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSEM_R13_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HSEM_R13` writer"]
pub struct W(crate::W<HSEM_R13_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSEM_R13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HSEM_R13_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSEM_R13_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PROCID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HSEM_R13_SPEC, u8, u8, 8, O>;
#[doc = "Field `COREID` reader - COREID"]
pub type COREID_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COREID` writer - COREID"]
pub type COREID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HSEM_R13_SPEC, u8, u8, 4, O>;
#[doc = "Field `LOCK` reader - LOCK"]
pub type LOCK_R = crate::BitReader<bool>;
#[doc = "Field `LOCK` writer - LOCK"]
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSEM_R13_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:7 - PROCID"]
    #[inline(always)]
