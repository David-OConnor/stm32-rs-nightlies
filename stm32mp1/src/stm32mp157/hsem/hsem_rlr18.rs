...
pub struct R(crate::R<HSEM_RLR18_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSEM_RLR18_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSEM_RLR18_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSEM_RLR18_SPEC>) -> Self {
        R(reader)
    }
}
