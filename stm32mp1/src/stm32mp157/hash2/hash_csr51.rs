...
pub type CS51_R = crate::FieldReader<u32, u32>;
#[doc = "Field `CS51` writer - CS51"]
pub type CS51_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HASH_CSR51_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - CS51"]
    #[inline(always)]
