#[doc = "Register `DMA_S3M0AR` reader"]
...
#[doc = "Register `DMA_S3M0AR` writer"]
...
#[doc = "`read()` method returns [dma_s3m0ar::R](R) reader structure"]
impl crate::Readable for DMA_S3M0AR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_s3m0ar::W](W) writer structure"]
impl crate::Writable for DMA_S3M0AR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMA_S3M0AR to value 0"]
