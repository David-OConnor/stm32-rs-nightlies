#[doc = "Register `DMA_S1CR` reader"]
pub struct R(crate::R<DMA_S1CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_S1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_S1CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_S1CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMA_S1CR` writer"]
pub struct W(crate::W<DMA_S1CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_S1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_S1CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_S1CR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "This register is used to configure the concerned stream.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_s1cr](index.html) module"]
pub struct DMA_S1CR_SPEC;
impl crate::RegisterSpec for DMA_S1CR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dma_s1cr::R](R) reader structure"]
impl crate::Readable for DMA_S1CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_s1cr::W](W) writer structure"]
impl crate::Writable for DMA_S1CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMA_S1CR to value 0"]
impl crate::Resettable for DMA_S1CR_SPEC {
