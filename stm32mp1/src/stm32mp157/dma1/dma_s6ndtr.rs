#[doc = "Register `DMA_S6NDTR` reader"]
...
#[doc = "Register `DMA_S6NDTR` writer"]
...
#[doc = "`read()` method returns [dma_s6ndtr::R](R) reader structure"]
impl crate::Readable for DMA_S6NDTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_s6ndtr::W](W) writer structure"]
impl crate::Writable for DMA_S6NDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMA_S6NDTR to value 0"]
