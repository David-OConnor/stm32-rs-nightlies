...
pub struct R(crate::R<STGENR_PIDR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<STGENR_PIDR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<STGENR_PIDR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<STGENR_PIDR1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "STGENR peripheral ID1 register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [stgenr_pidr1](index.html) module"]
pub struct STGENR_PIDR1_SPEC;
impl crate::RegisterSpec for STGENR_PIDR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [stgenr_pidr1::R](R) reader structure"]
impl crate::Readable for STGENR_PIDR1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets STGENR_PIDR1 to value 0xb1"]
impl crate::Resettable for STGENR_PIDR1_SPEC {
