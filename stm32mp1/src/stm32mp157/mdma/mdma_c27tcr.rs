#[doc = "Register `MDMA_C27TCR` reader"]
...
#[doc = "Register `MDMA_C27TCR` writer"]
...
#[doc = "`read()` method returns [mdma_c27tcr::R](R) reader structure"]
impl crate::Readable for MDMA_C27TCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c27tcr::W](W) writer structure"]
impl crate::Writable for MDMA_C27TCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C27TCR to value 0"]
