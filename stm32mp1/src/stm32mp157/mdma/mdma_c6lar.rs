...
pub struct R(crate::R<MDMA_C6LAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDMA_C6LAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDMA_C6LAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDMA_C6LAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MDMA_C6LAR` writer"]
pub struct W(crate::W<MDMA_C6LAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDMA_C6LAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDMA_C6LAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDMA_C6LAR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LAR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C6LAR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - LAR"]
    #[inline(always)]
