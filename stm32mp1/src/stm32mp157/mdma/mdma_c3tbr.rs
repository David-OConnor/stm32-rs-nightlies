...
pub struct R(crate::R<MDMA_C3TBR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDMA_C3TBR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDMA_C3TBR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDMA_C3TBR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MDMA_C3TBR` writer"]
pub struct W(crate::W<MDMA_C3TBR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDMA_C3TBR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDMA_C3TBR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDMA_C3TBR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C3TBR_SPEC, u8, u8, 6, O>;
#[doc = "Field `SBUS` reader - SBUS"]
pub type SBUS_R = crate::BitReader<bool>;
#[doc = "Field `SBUS` writer - SBUS"]
pub type SBUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C3TBR_SPEC, bool, O>;
#[doc = "Field `DBUS` reader - DBUS"]
pub type DBUS_R = crate::BitReader<bool>;
#[doc = "Field `DBUS` writer - DBUS"]
pub type DBUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C3TBR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:5 - TSEL"]
    #[inline(always)]
...
+ 0x18).\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mdma_c3tbr](index.html) module"]
pub struct MDMA_C3TBR_SPEC;
impl crate::RegisterSpec for MDMA_C3TBR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mdma_c3tbr::R](R) reader structure"]
impl crate::Readable for MDMA_C3TBR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c3tbr::W](W) writer structure"]
impl crate::Writable for MDMA_C3TBR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C3TBR to value 0"]
impl crate::Resettable for MDMA_C3TBR_SPEC {
