...
pub type SUV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C17BRUR_SPEC, u16, u16, 16, O>;
#[doc = "Field `DUV` reader - DUV"]
pub type DUV_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DUV` writer - DUV"]
pub type DUV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C17BRUR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - SUV"]
    #[inline(always)]
