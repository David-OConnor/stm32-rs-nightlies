#[doc = "Register `MDMA_C13TBR` reader"]
...
#[doc = "Register `MDMA_C13TBR` writer"]
...
#[doc = "`read()` method returns [mdma_c13tbr::R](R) reader structure"]
impl crate::Readable for MDMA_C13TBR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c13tbr::W](W) writer structure"]
impl crate::Writable for MDMA_C13TBR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C13TBR to value 0"]
