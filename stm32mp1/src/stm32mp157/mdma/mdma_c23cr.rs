#[doc = "Register `MDMA_C23CR` reader"]
...
#[doc = "Register `MDMA_C23CR` writer"]
...
#[doc = "`read()` method returns [mdma_c23cr::R](R) reader structure"]
impl crate::Readable for MDMA_C23CR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c23cr::W](W) writer structure"]
impl crate::Writable for MDMA_C23CR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C23CR to value 0"]
