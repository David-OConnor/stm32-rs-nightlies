...
pub type BNDT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C16BNDTR_SPEC, u32, u32, 17, O>;
#[doc = "Field `BRSUM` reader - BRSUM"]
pub type BRSUM_R = crate::BitReader<bool>;
#[doc = "Field `BRSUM` writer - BRSUM"]
pub type BRSUM_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C16BNDTR_SPEC, bool, O>;
#[doc = "Field `BRDUM` reader - BRDUM"]
pub type BRDUM_R = crate::BitReader<bool>;
#[doc = "Field `BRDUM` writer - BRDUM"]
pub type BRDUM_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C16BNDTR_SPEC, bool, O>;
#[doc = "Field `BRC` reader - BRC"]
pub type BRC_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BRC` writer - BRC"]
pub type BRC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C16BNDTR_SPEC, u16, u16, 12, O>;
impl R {
    #[doc = "Bits 0:16 - BNDT"]
    #[inline(always)]
