...
pub type TSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C19TBR_SPEC, u8, u8, 6, O>;
#[doc = "Field `SBUS` reader - SBUS"]
pub type SBUS_R = crate::BitReader<bool>;
#[doc = "Field `SBUS` writer - SBUS"]
pub type SBUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C19TBR_SPEC, bool, O>;
#[doc = "Field `DBUS` reader - DBUS"]
pub type DBUS_R = crate::BitReader<bool>;
#[doc = "Field `DBUS` writer - DBUS"]
pub type DBUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C19TBR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:5 - TSEL"]
    #[inline(always)]
