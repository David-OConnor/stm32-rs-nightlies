#[doc = "Register `MDMA_C12BNDTR` reader"]
...
#[doc = "Register `MDMA_C12BNDTR` writer"]
...
#[doc = "`read()` method returns [mdma_c12bndtr::R](R) reader structure"]
impl crate::Readable for MDMA_C12BNDTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c12bndtr::W](W) writer structure"]
impl crate::Writable for MDMA_C12BNDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C12BNDTR to value 0"]
