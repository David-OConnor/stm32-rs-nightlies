#[doc = "Register `MDMA_C11MDR` reader"]
...
#[doc = "Register `MDMA_C11MDR` writer"]
...
#[doc = "`read()` method returns [mdma_c11mdr::R](R) reader structure"]
impl crate::Readable for MDMA_C11MDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c11mdr::W](W) writer structure"]
impl crate::Writable for MDMA_C11MDR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C11MDR to value 0"]
