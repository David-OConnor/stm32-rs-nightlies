#[doc = "Register `MDMA_C10ESR` reader"]
pub struct R(crate::R<MDMA_C10ESR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDMA_C10ESR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDMA_C10ESR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDMA_C10ESR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "MDMA channel 10 error status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mdma_c10esr](index.html) module"]
pub struct MDMA_C10ESR_SPEC;
impl crate::RegisterSpec for MDMA_C10ESR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mdma_c10esr::R](R) reader structure"]
impl crate::Readable for MDMA_C10ESR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MDMA_C10ESR to value 0"]
impl crate::Resettable for MDMA_C10ESR_SPEC {
