...
pub struct R(crate::R<MDMA_C8MAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDMA_C8MAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDMA_C8MAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDMA_C8MAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MDMA_C8MAR` writer"]
pub struct W(crate::W<MDMA_C8MAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDMA_C8MAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDMA_C8MAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDMA_C8MAR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MAR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDMA_C8MAR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - MAR"]
    #[inline(always)]
...
+ 0x20).\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mdma_c8mar](index.html) module"]
