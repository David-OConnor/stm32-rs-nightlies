...
pub struct R(crate::R<MDMA_C1ISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDMA_C1ISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDMA_C1ISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDMA_C1ISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "MDMA channel 1 interrupt/status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mdma_c1isr](index.html) module"]
