...
pub type ISPENDR1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ISPENDR1` writer - ISPENDR1"]
pub type ISPENDR1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_ISPENDR1_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ispendr1(&mut self) -> ISPENDR1_W<0> {
        ISPENDR1_W::new(self)
    }
