#[doc = "Register `GICD_ICACTIVER8` reader"]
...
#[doc = "Register `GICD_ICACTIVER8` writer"]
...
#[doc = "`read()` method returns [gicd_icactiver8::R](R) reader structure"]
impl crate::Readable for GICD_ICACTIVER8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gicd_icactiver8::W](W) writer structure"]
impl crate::Writable for GICD_ICACTIVER8_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GICD_ICACTIVER8 to value 0"]
