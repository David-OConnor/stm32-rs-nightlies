...
pub type ICACTIVER3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ICACTIVER3` writer - ICACTIVER3"]
pub type ICACTIVER3_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_ICACTIVER3_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icactiver3(&mut self) -> ICACTIVER3_W<0> {
        ICACTIVER3_W::new(self)
    }
