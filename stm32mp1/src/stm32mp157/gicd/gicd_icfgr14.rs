#[doc = "Register `GICD_ICFGR14` reader"]
...
#[doc = "Register `GICD_ICFGR14` writer"]
...
#[doc = "`read()` method returns [gicd_icfgr14::R](R) reader structure"]
impl crate::Readable for GICD_ICFGR14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gicd_icfgr14::W](W) writer structure"]
impl crate::Writable for GICD_ICFGR14_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GICD_ICFGR14 to value 0x5555_5555"]
