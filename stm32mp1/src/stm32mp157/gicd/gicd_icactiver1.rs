...
pub type ICACTIVER1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `ICACTIVER1` writer - ICACTIVER1"]
pub type ICACTIVER1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_ICACTIVER1_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icactiver1(&mut self) -> ICACTIVER1_W<0> {
