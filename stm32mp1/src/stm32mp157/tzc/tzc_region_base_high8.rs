#[doc = "Register `TZC_REGION_BASE_HIGH8` reader"]
...
#[doc = "`read()` method returns [tzc_region_base_high8::R](R) reader structure"]
impl crate::Readable for TZC_REGION_BASE_HIGH8_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TZC_REGION_BASE_HIGH8 to value 0"]
