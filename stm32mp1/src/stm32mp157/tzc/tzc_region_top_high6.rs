#[doc = "Register `TZC_REGION_TOP_HIGH6` reader"]
...
#[doc = "`read()` method returns [tzc_region_top_high6::R](R) reader structure"]
impl crate::Readable for TZC_REGION_TOP_HIGH6_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TZC_REGION_TOP_HIGH6 to value 0"]
