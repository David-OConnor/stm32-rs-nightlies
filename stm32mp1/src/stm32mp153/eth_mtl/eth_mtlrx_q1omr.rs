...
pub struct R(crate::R<ETH_MTLRX_Q1OMR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MTLRX_Q1OMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MTLRX_Q1OMR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MTLRX_Q1OMR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ETH_MTLRxQ1OMR` writer"]
pub struct W(crate::W<ETH_MTLRX_Q1OMR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_MTLRX_Q1OMR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_MTLRX_Q1OMR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_MTLRX_Q1OMR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RTC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, u8, u8, 2, O>;
#[doc = "Field `FUP` reader - FUP"]
pub type FUP_R = crate::BitReader<bool>;
#[doc = "Field `FUP` writer - FUP"]
pub type FUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, bool, O>;
#[doc = "Field `FEP` reader - FEP"]
pub type FEP_R = crate::BitReader<bool>;
#[doc = "Field `FEP` writer - FEP"]
pub type FEP_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, bool, O>;
#[doc = "Field `RSF` reader - RSF"]
pub type RSF_R = crate::BitReader<bool>;
#[doc = "Field `RSF` writer - RSF"]
pub type RSF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, bool, O>;
#[doc = "Field `DIS_TCP_EF` reader - DIS_TCP_EF"]
pub type DIS_TCP_EF_R = crate::BitReader<bool>;
#[doc = "Field `DIS_TCP_EF` writer - DIS_TCP_EF"]
pub type DIS_TCP_EF_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, bool, O>;
#[doc = "Field `EHFC` reader - EHFC"]
pub type EHFC_R = crate::BitReader<bool>;
#[doc = "Field `EHFC` writer - EHFC"]
pub type EHFC_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, bool, O>;
#[doc = "Field `RFA` reader - RFA"]
pub type RFA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RFA` writer - RFA"]
pub type RFA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, u8, u8, 3, O>;
#[doc = "Field `RFD` reader - RFD"]
pub type RFD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RFD` writer - RFD"]
pub type RFD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_MTLRX_Q1OMR_SPEC, u8, u8, 3, O>;
...
pub struct ETH_MTLRX_Q1OMR_SPEC;
impl crate::RegisterSpec for ETH_MTLRX_Q1OMR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eth_mtlrx_q1omr::R](R) reader structure"]
impl crate::Readable for ETH_MTLRX_Q1OMR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_mtlrx_q1omr::W](W) writer structure"]
impl crate::Writable for ETH_MTLRX_Q1OMR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ETH_MTLRxQ1OMR to value 0x0070_0000"]
impl crate::Resettable for ETH_MTLRX_Q1OMR_SPEC {
