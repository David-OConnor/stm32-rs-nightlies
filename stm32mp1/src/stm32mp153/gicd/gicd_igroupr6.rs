...
pub type IGROUPR6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `IGROUPR6` writer - IGROUPR6"]
pub type IGROUPR6_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IGROUPR6_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn igroupr6(&mut self) -> IGROUPR6_W<0> {
        IGROUPR6_W::new(self)
    }
