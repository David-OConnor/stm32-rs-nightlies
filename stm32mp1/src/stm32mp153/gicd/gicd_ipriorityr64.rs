#[doc = "Register `GICD_IPRIORITYR64` reader"]
...
#[doc = "Register `GICD_IPRIORITYR64` writer"]
...
#[doc = "`read()` method returns [gicd_ipriorityr64::R](R) reader structure"]
impl crate::Readable for GICD_IPRIORITYR64_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gicd_ipriorityr64::W](W) writer structure"]
impl crate::Writable for GICD_IPRIORITYR64_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR64 to value 0"]
