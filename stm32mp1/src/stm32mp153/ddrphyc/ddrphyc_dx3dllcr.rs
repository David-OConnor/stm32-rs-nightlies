...
pub type SFBDLY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DDRPHYC_DX3DLLCR_SPEC, u8, u8, 3, O>;
...
pub type SSTART_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DDRPHYC_DX3DLLCR_SPEC, u8, u8, 2, O>;
