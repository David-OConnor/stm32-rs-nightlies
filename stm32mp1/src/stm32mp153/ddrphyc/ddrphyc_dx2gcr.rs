#[doc = "Register `DDRPHYC_DX2GCR` reader"]
pub struct R(crate::R<DDRPHYC_DX2GCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDRPHYC_DX2GCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDRPHYC_DX2GCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDRPHYC_DX2GCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DDRPHYC_DX2GCR` writer"]
pub struct W(crate::W<DDRPHYC_DX2GCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DDRPHYC_DX2GCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DDRPHYC_DX2GCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DDRPHYC_DX2GCR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "DDRPHYC byte lane 2 GC register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ddrphyc_dx2gcr](index.html) module"]
pub struct DDRPHYC_DX2GCR_SPEC;
impl crate::RegisterSpec for DDRPHYC_DX2GCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ddrphyc_dx2gcr::R](R) reader structure"]
impl crate::Readable for DDRPHYC_DX2GCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ddrphyc_dx2gcr::W](W) writer structure"]
impl crate::Writable for DDRPHYC_DX2GCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DDRPHYC_DX2GCR to value 0xee81"]
impl crate::Resettable for DDRPHYC_DX2GCR_SPEC {
