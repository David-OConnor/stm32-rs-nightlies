...
pub struct R(crate::R<DDRPHYC_DX1GSR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDRPHYC_DX1GSR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDRPHYC_DX1GSR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDRPHYC_DX1GSR1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DDRPHYC byte lane 1 GS register 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ddrphyc_dx1gsr1](index.html) module"]
pub struct DDRPHYC_DX1GSR1_SPEC;
impl crate::RegisterSpec for DDRPHYC_DX1GSR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ddrphyc_dx1gsr1::R](R) reader structure"]
impl crate::Readable for DDRPHYC_DX1GSR1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DDRPHYC_DX1GSR1 to value 0"]
impl crate::Resettable for DDRPHYC_DX1GSR1_SPEC {
