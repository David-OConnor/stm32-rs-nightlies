...
pub type PAGECLOSE_TIMER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PAGECLOSE_TIMER` writer - PAGECLOSE_TIMER"]
pub type PAGECLOSE_TIMER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DDRCTRL_SCHED1_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pageclose_timer(&mut self) -> PAGECLOSE_TIMER_W<0> {
