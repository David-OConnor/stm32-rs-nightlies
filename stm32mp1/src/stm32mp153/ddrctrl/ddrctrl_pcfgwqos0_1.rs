#[doc = "Register `DDRCTRL_PCFGWQOS0_1` reader"]
pub struct R(crate::R<DDRCTRL_PCFGWQOS0_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDRCTRL_PCFGWQOS0_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDRCTRL_PCFGWQOS0_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDRCTRL_PCFGWQOS0_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DDRCTRL_PCFGWQOS0_1` writer"]
pub struct W(crate::W<DDRCTRL_PCFGWQOS0_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DDRCTRL_PCFGWQOS0_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DDRCTRL_PCFGWQOS0_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DDRCTRL_PCFGWQOS0_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WQOS_MAP_LEVEL1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DDRCTRL_PCFGWQOS0_1_SPEC, u8, u8, 4, O>;
...
pub type WQOS_MAP_REGION0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DDRCTRL_PCFGWQOS0_1_SPEC, u8, u8, 2, O>;
...
#[doc = "DDRCTRL port 1 write Q0S configuration register 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ddrctrl_pcfgwqos0_1](index.html) module"]
pub struct DDRCTRL_PCFGWQOS0_1_SPEC;
impl crate::RegisterSpec for DDRCTRL_PCFGWQOS0_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ddrctrl_pcfgwqos0_1::R](R) reader structure"]
impl crate::Readable for DDRCTRL_PCFGWQOS0_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ddrctrl_pcfgwqos0_1::W](W) writer structure"]
impl crate::Writable for DDRCTRL_PCFGWQOS0_1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DDRCTRL_PCFGWQOS0_1 to value 0x0e00"]
impl crate::Resettable for DDRCTRL_PCFGWQOS0_1_SPEC {
