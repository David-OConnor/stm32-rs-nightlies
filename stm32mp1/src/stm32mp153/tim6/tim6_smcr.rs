...
pub struct R(crate::R<TIM6_SMCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM6_SMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM6_SMCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM6_SMCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM6_SMCR` writer"]
pub struct W(crate::W<TIM6_SMCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM6_SMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM6_SMCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM6_SMCR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "TIM6 slave mode control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim6_smcr](index.html) module"]
pub struct TIM6_SMCR_SPEC;
impl crate::RegisterSpec for TIM6_SMCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim6_smcr::R](R) reader structure"]
impl crate::Readable for TIM6_SMCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim6_smcr::W](W) writer structure"]
impl crate::Writable for TIM6_SMCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM6_SMCR to value 0"]
impl crate::Resettable for TIM6_SMCR_SPEC {
