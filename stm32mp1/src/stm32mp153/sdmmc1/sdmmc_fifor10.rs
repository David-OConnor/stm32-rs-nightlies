...
pub struct R(crate::R<SDMMC_FIFOR10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SDMMC_FIFOR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SDMMC_FIFOR10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SDMMC_FIFOR10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SDMMC_FIFOR10` writer"]
pub struct W(crate::W<SDMMC_FIFOR10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SDMMC_FIFOR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SDMMC_FIFOR10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SDMMC_FIFOR10_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FIFODATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SDMMC_FIFOR10_SPEC, u32, u32, 32, O>;
impl R {
