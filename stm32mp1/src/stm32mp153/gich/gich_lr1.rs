...
#[doc = "`read()` method returns [gich_lr1::R](R) reader structure"]
impl crate::Readable for GICH_LR1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gich_lr1::W](W) writer structure"]
impl crate::Writable for GICH_LR1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GICH_LR1 to value 0"]
