#[doc = "Register `GPIOH_AFRH` reader"]
pub struct R(crate::R<GPIOH_AFRH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOH_AFRH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOH_AFRH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOH_AFRH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOH_AFRH` writer"]
pub struct W(crate::W<GPIOH_AFRH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOH_AFRH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOH_AFRH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOH_AFRH_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO alternate function high register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioh_afrh](index.html) module"]
pub struct GPIOH_AFRH_SPEC;
impl crate::RegisterSpec for GPIOH_AFRH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioh_afrh::R](R) reader structure"]
impl crate::Readable for GPIOH_AFRH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpioh_afrh::W](W) writer structure"]
impl crate::Writable for GPIOH_AFRH_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOH_AFRH to value 0"]
impl crate::Resettable for GPIOH_AFRH_SPEC {
