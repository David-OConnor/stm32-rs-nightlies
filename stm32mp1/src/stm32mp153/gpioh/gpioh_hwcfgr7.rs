#[doc = "Register `GPIOH_HWCFGR7` reader"]
pub struct R(crate::R<GPIOH_HWCFGR7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOH_HWCFGR7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOH_HWCFGR7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOH_HWCFGR7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "GPIO hardware configuration register 7\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioh_hwcfgr7](index.html) module"]
pub struct GPIOH_HWCFGR7_SPEC;
impl crate::RegisterSpec for GPIOH_HWCFGR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioh_hwcfgr7::R](R) reader structure"]
impl crate::Readable for GPIOH_HWCFGR7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOH_HWCFGR7 to value 0xffff_ffff"]
impl crate::Resettable for GPIOH_HWCFGR7_SPEC {
