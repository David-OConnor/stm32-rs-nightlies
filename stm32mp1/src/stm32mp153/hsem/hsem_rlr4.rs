#[doc = "Register `HSEM_RLR4` reader"]
pub struct R(crate::R<HSEM_RLR4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSEM_RLR4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSEM_RLR4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSEM_RLR4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Accesses the same physical bits as HSEM_Rx. The HSEM_RLRx shall be used to perform a 1-step Read lock. Only Read accesses with authorized AHB bus master IDs are granted. Read accesses with unauthorized AHB bus master IDs are discarded.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hsem_rlr4](index.html) module"]
pub struct HSEM_RLR4_SPEC;
impl crate::RegisterSpec for HSEM_RLR4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hsem_rlr4::R](R) reader structure"]
impl crate::Readable for HSEM_RLR4_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HSEM_RLR4 to value 0"]
impl crate::Resettable for HSEM_RLR4_SPEC {
