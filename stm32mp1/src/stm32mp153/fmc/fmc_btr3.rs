...
#[doc = "`read()` method returns [fmc_btr3::R](R) reader structure"]
impl crate::Readable for FMC_BTR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fmc_btr3::W](W) writer structure"]
impl crate::Writable for FMC_BTR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FMC_BTR3 to value 0x0fff_ffff"]
