#[doc = "Register `GPIOZ_ODR` reader"]
pub struct R(crate::R<GPIOZ_ODR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOZ_ODR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOZ_ODR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOZ_ODR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIOZ_ODR` writer"]
pub struct W(crate::W<GPIOZ_ODR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIOZ_ODR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIOZ_ODR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIOZ_ODR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "GPIO port output data register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioz_odr](index.html) module"]
pub struct GPIOZ_ODR_SPEC;
impl crate::RegisterSpec for GPIOZ_ODR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioz_odr::R](R) reader structure"]
impl crate::Readable for GPIOZ_ODR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpioz_odr::W](W) writer structure"]
impl crate::Writable for GPIOZ_ODR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOZ_ODR to value 0"]
impl crate::Resettable for GPIOZ_ODR_SPEC {
