...
pub type F0GI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_RXF0S_SPEC, u8, u8, 6, O>;
#[doc = "Field `F0PI` reader - F0PI"]
pub type F0PI_R = crate::FieldReader<u8, u8>;
#[doc = "Field `F0PI` writer - F0PI"]
pub type F0PI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FDCAN_RXF0S_SPEC, u8, u8, 6, O>;
