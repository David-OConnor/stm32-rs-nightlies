...
pub type DMAREQ_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_C3CR_SPEC, u8, u8, 7, O>;
#[doc = "Field `SOIE` reader - SOIE"]
pub type SOIE_R = crate::BitReader<bool>;
#[doc = "Field `SOIE` writer - SOIE"]
pub type SOIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_C3CR_SPEC, bool, O>;
#[doc = "Field `EGE` reader - EGE"]
pub type EGE_R = crate::BitReader<bool>;
#[doc = "Field `EGE` writer - EGE"]
pub type EGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_C3CR_SPEC, bool, O>;
#[doc = "Field `SE` reader - SE"]
pub type SE_R = crate::BitReader<bool>;
#[doc = "Field `SE` writer - SE"]
pub type SE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_C3CR_SPEC, bool, O>;
#[doc = "Field `SPOL` reader - SPOL"]
pub type SPOL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SPOL` writer - SPOL"]
pub type SPOL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_C3CR_SPEC, u8, u8, 2, O>;
#[doc = "Field `NBREQ` reader - NBREQ"]
pub type NBREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `NBREQ` writer - NBREQ"]
pub type NBREQ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_C3CR_SPEC, u8, u8, 5, O>;
#[doc = "Field `SYNC_ID` reader - SYNC_ID"]
pub type SYNC_ID_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SYNC_ID` writer - SYNC_ID"]
pub type SYNC_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_C3CR_SPEC, u8, u8, 3, O>;
impl R {
