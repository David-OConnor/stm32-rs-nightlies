...
pub struct R(crate::R<DMAMUX_RG2CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMAMUX_RG2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMAMUX_RG2CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMAMUX_RG2CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMAMUX_RG2CR` writer"]
pub struct W(crate::W<DMAMUX_RG2CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMAMUX_RG2CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMAMUX_RG2CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMAMUX_RG2CR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SIG_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_RG2CR_SPEC, u8, u8, 3, O>;
#[doc = "Field `OIE` reader - OIE"]
pub type OIE_R = crate::BitReader<bool>;
#[doc = "Field `OIE` writer - OIE"]
pub type OIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_RG2CR_SPEC, bool, O>;
#[doc = "Field `GE` reader - GE"]
pub type GE_R = crate::BitReader<bool>;
#[doc = "Field `GE` writer - GE"]
pub type GE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_RG2CR_SPEC, bool, O>;
#[doc = "Field `GPOL` reader - GPOL"]
pub type GPOL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPOL` writer - GPOL"]
pub type GPOL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_RG2CR_SPEC, u8, u8, 2, O>;
#[doc = "Field `GNBREQ` reader - GNBREQ"]
pub type GNBREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GNBREQ` writer - GNBREQ"]
pub type GNBREQ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_RG2CR_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:2 - SIG_ID"]
    #[inline(always)]
