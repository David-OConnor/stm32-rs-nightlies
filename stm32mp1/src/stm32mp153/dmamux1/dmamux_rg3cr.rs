...
pub type SIG_ID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_RG3CR_SPEC, u8, u8, 3, O>;
#[doc = "Field `OIE` reader - OIE"]
pub type OIE_R = crate::BitReader<bool>;
#[doc = "Field `OIE` writer - OIE"]
pub type OIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_RG3CR_SPEC, bool, O>;
#[doc = "Field `GE` reader - GE"]
pub type GE_R = crate::BitReader<bool>;
#[doc = "Field `GE` writer - GE"]
pub type GE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMAMUX_RG3CR_SPEC, bool, O>;
#[doc = "Field `GPOL` reader - GPOL"]
pub type GPOL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPOL` writer - GPOL"]
pub type GPOL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_RG3CR_SPEC, u8, u8, 2, O>;
#[doc = "Field `GNBREQ` reader - GNBREQ"]
pub type GNBREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GNBREQ` writer - GNBREQ"]
pub type GNBREQ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMAMUX_RG3CR_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:2 - SIG_ID"]
    #[inline(always)]
