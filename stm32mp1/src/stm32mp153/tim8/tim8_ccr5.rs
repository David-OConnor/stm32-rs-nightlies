...
#[doc = "`read()` method returns [tim8_ccr5::R](R) reader structure"]
impl crate::Readable for TIM8_CCR5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim8_ccr5::W](W) writer structure"]
impl crate::Writable for TIM8_CCR5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM8_CCR5 to value 0"]
