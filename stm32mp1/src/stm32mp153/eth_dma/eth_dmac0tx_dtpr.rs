#[doc = "Register `ETH_DMAC0TxDTPR` reader"]
...
#[doc = "Register `ETH_DMAC0TxDTPR` writer"]
...
#[doc = "`read()` method returns [eth_dmac0tx_dtpr::R](R) reader structure"]
impl crate::Readable for ETH_DMAC0TX_DTPR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_dmac0tx_dtpr::W](W) writer structure"]
impl crate::Writable for ETH_DMAC0TX_DTPR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ETH_DMAC0TxDTPR to value 0"]
