#[doc = "Register `ETH_DMAC0TxRLR` reader"]
...
#[doc = "Register `ETH_DMAC0TxRLR` writer"]
...
#[doc = "`read()` method returns [eth_dmac0tx_rlr::R](R) reader structure"]
impl crate::Readable for ETH_DMAC0TX_RLR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_dmac0tx_rlr::W](W) writer structure"]
impl crate::Writable for ETH_DMAC0TX_RLR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ETH_DMAC0TxRLR to value 0"]
