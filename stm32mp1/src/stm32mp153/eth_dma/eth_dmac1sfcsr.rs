...
pub type ESC_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_DMAC1SFCSR_SPEC, bool, O>;
#[doc = "Field `ASC` reader - ASC"]
pub type ASC_R = crate::BitReader<bool>;
#[doc = "Field `ASC` writer - ASC"]
pub type ASC_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETH_DMAC1SFCSR_SPEC, bool, O>;
#[doc = "Field `RSN` reader - RSN"]
pub type RSN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RSN` writer - RSN"]
pub type RSN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETH_DMAC1SFCSR_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bit 0 - ESC"]
    #[inline(always)]
