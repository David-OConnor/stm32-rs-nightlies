#[doc = "Register `ETZPC_DECPROT_LOCK1` reader"]
...
#[doc = "Register `ETZPC_DECPROT_LOCK1` writer"]
...
#[doc = "`read()` method returns [etzpc_decprot_lock1::R](R) reader structure"]
impl crate::Readable for ETZPC_DECPROT_LOCK1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [etzpc_decprot_lock1::W](W) writer structure"]
impl crate::Writable for ETZPC_DECPROT_LOCK1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ETZPC_DECPROT_LOCK1 to value 0"]
