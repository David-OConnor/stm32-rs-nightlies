#[doc = "Register `DFSDM_CH7DLYR` reader"]
...
#[doc = "Register `DFSDM_CH7DLYR` writer"]
...
#[doc = "`read()` method returns [dfsdm_ch7dlyr::R](R) reader structure"]
impl crate::Readable for DFSDM_CH7DLYR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_ch7dlyr::W](W) writer structure"]
impl crate::Writable for DFSDM_CH7DLYR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_CH7DLYR to value 0"]
