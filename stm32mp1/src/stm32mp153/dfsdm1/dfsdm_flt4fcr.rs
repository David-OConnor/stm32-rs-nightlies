#[doc = "Register `DFSDM_FLT4FCR` reader"]
...
#[doc = "Register `DFSDM_FLT4FCR` writer"]
...
#[doc = "`read()` method returns [dfsdm_flt4fcr::R](R) reader structure"]
impl crate::Readable for DFSDM_FLT4FCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm_flt4fcr::W](W) writer structure"]
impl crate::Writable for DFSDM_FLT4FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DFSDM_FLT4FCR to value 0"]
