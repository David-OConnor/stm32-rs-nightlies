...
pub struct R(crate::R<MDIOS_DINR29_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDIOS_DINR29_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDIOS_DINR29_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDIOS_DINR29_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "MDIOS input data register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mdios_dinr29](index.html) module"]
