...
#[doc = "`read()` method returns [dma_s7fcr::R](R) reader structure"]
impl crate::Readable for DMA_S7FCR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_s7fcr::W](W) writer structure"]
impl crate::Writable for DMA_S7FCR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DMA_S7FCR to value 0x21"]
