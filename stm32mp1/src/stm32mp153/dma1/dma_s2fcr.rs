...
pub type FTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_S2FCR_SPEC, u8, u8, 2, O>;
#[doc = "Field `DMDIS` reader - DMDIS"]
pub type DMDIS_R = crate::BitReader<bool>;
#[doc = "Field `DMDIS` writer - DMDIS"]
pub type DMDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_S2FCR_SPEC, bool, O>;
...
pub type FEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_S2FCR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - FTH"]
    #[inline(always)]
