...
pub type UIF_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM14_SR_SPEC, bool, O>;
#[doc = "Field `CC1IF` reader - CC1IF"]
pub type CC1IF_R = crate::BitReader<bool>;
#[doc = "Field `CC1IF` writer - CC1IF"]
pub type CC1IF_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM14_SR_SPEC, bool, O>;
#[doc = "Field `CC1OF` reader - CC1OF"]
pub type CC1OF_R = crate::BitReader<bool>;
#[doc = "Field `CC1OF` writer - CC1OF"]
pub type CC1OF_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM14_SR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - UIF"]
    #[inline(always)]
