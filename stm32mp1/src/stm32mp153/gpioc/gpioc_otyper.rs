#[doc = "Register `GPIOC_OTYPER` reader"]
...
#[doc = "Register `GPIOC_OTYPER` writer"]
...
#[doc = "`read()` method returns [gpioc_otyper::R](R) reader structure"]
impl crate::Readable for GPIOC_OTYPER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpioc_otyper::W](W) writer structure"]
impl crate::Writable for GPIOC_OTYPER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOC_OTYPER to value 0"]
