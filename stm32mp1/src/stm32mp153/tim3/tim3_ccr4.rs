...
#[doc = "`read()` method returns [tim3_ccr4::R](R) reader structure"]
impl crate::Readable for TIM3_CCR4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim3_ccr4::W](W) writer structure"]
impl crate::Writable for TIM3_CCR4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM3_CCR4 to value 0"]
