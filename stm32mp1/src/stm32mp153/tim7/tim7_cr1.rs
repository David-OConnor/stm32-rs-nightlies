...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM7_CR1_SPEC, bool, O>;
#[doc = "Field `CMS` reader - CMS"]
pub type CMS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CMS` writer - CMS"]
pub type CMS_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TIM7_CR1_SPEC, u8, u8, 2, O>;
...
pub type CKD_W<'a, const O: u8> = crate::FieldWriter<'a, u16, TIM7_CR1_SPEC, u8, u8, 2, O>;
