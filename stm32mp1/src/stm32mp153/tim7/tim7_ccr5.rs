...
pub struct R(crate::R<TIM7_CCR5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM7_CCR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM7_CCR5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM7_CCR5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM7_CCR5` writer"]
pub struct W(crate::W<TIM7_CCR5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM7_CCR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM7_CCR5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM7_CCR5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CCR5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIM7_CCR5_SPEC, u16, u16, 16, O>;
#[doc = "Field `GC5C1` reader - GC5C1"]
pub type GC5C1_R = crate::BitReader<bool>;
#[doc = "Field `GC5C1` writer - GC5C1"]
pub type GC5C1_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM7_CCR5_SPEC, bool, O>;
#[doc = "Field `GC5C2` reader - GC5C2"]
pub type GC5C2_R = crate::BitReader<bool>;
#[doc = "Field `GC5C2` writer - GC5C2"]
pub type GC5C2_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM7_CCR5_SPEC, bool, O>;
#[doc = "Field `GC5C3` reader - GC5C3"]
pub type GC5C3_R = crate::BitReader<bool>;
#[doc = "Field `GC5C3` writer - GC5C3"]
pub type GC5C3_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIM7_CCR5_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:15 - CCR5"]
    #[inline(always)]
...
#[doc = "TIM7 capture/compare register 5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim7_ccr5](index.html) module"]
pub struct TIM7_CCR5_SPEC;
impl crate::RegisterSpec for TIM7_CCR5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim7_ccr5::R](R) reader structure"]
impl crate::Readable for TIM7_CCR5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim7_ccr5::W](W) writer structure"]
impl crate::Writable for TIM7_CCR5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM7_CCR5 to value 0"]
impl crate::Resettable for TIM7_CCR5_SPEC {
