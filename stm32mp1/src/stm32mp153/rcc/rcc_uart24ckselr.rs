...
pub type UART24SRC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `UART24SRC` writer - UART24SRC"]
pub type UART24SRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RCC_UART24CKSELR_SPEC, u8, u8, 3, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart24src(&mut self) -> UART24SRC_W<0> {
        UART24SRC_W::new(self)
    }
