#[doc = "Register `RCC_MP_AHB6LPENCLRR` reader"]
pub struct R(crate::R<RCC_MP_AHB6LPENCLRR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_MP_AHB6LPENCLRR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_MP_AHB6LPENCLRR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_MP_AHB6LPENCLRR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_MP_AHB6LPENCLRR` writer"]
pub struct W(crate::W<RCC_MP_AHB6LPENCLRR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_MP_AHB6LPENCLRR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_MP_AHB6LPENCLRR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_MP_AHB6LPENCLRR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MDMALPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
#[doc = "Field `GPULPEN` reader - GPULPEN"]
pub type GPULPEN_R = crate::BitReader<bool>;
#[doc = "Field `GPULPEN` writer - GPULPEN"]
pub type GPULPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
...
pub type ETHCKLPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
...
pub type ETHSTPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
#[doc = "Field `FMCLPEN` reader - FMCLPEN"]
pub type FMCLPEN_R = crate::BitReader<bool>;
#[doc = "Field `FMCLPEN` writer - FMCLPEN"]
pub type FMCLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
#[doc = "Field `QSPILPEN` reader - QSPILPEN"]
pub type QSPILPEN_R = crate::BitReader<bool>;
#[doc = "Field `QSPILPEN` writer - QSPILPEN"]
pub type QSPILPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
...
pub type CRC1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
#[doc = "Field `USBHLPEN` reader - USBHLPEN"]
pub type USBHLPEN_R = crate::BitReader<bool>;
#[doc = "Field `USBHLPEN` writer - USBHLPEN"]
pub type USBHLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB6LPENCLRR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - MDMALPEN"]
    #[inline(always)]
...
#[doc = "This register is used by the MCU in order to clear the PERxLPEN bits\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb6lpenclrr](index.html) module"]
pub struct RCC_MP_AHB6LPENCLRR_SPEC;
impl crate::RegisterSpec for RCC_MP_AHB6LPENCLRR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rcc_mp_ahb6lpenclrr::R](R) reader structure"]
impl crate::Readable for RCC_MP_AHB6LPENCLRR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mp_ahb6lpenclrr::W](W) writer structure"]
impl crate::Writable for RCC_MP_AHB6LPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MP_AHB6LPENCLRR to value 0x0113_57a1"]
impl crate::Resettable for RCC_MP_AHB6LPENCLRR_SPEC {
