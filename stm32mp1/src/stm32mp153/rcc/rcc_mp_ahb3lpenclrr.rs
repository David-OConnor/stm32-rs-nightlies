...
pub type DCMILPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB3LPENCLRR_SPEC, bool, O>;
...
pub type CRYP2LPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MP_AHB3LPENCLRR_SPEC, bool, O>;
...
pub type RNG2LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB3LPENCLRR_SPEC, bool, O>;
#[doc = "Field `CRC2LPEN` reader - CRC2LPEN"]
pub type CRC2LPEN_R = crate::BitReader<bool>;
#[doc = "Field `CRC2LPEN` writer - CRC2LPEN"]
pub type CRC2LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB3LPENCLRR_SPEC, bool, O>;
#[doc = "Field `HSEMLPEN` reader - HSEMLPEN"]
pub type HSEMLPEN_R = crate::BitReader<bool>;
#[doc = "Field `HSEMLPEN` writer - HSEMLPEN"]
pub type HSEMLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB3LPENCLRR_SPEC, bool, O>;
#[doc = "Field `IPCCLPEN` reader - IPCCLPEN"]
pub type IPCCLPEN_R = crate::BitReader<bool>;
#[doc = "Field `IPCCLPEN` writer - IPCCLPEN"]
pub type IPCCLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_AHB3LPENCLRR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - DCMILPEN"]
    #[inline(always)]
