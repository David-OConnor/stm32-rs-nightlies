#[doc = "Register `RCC_MC_AHB4LPENSETR` reader"]
pub struct R(crate::R<RCC_MC_AHB4LPENSETR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_MC_AHB4LPENSETR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_MC_AHB4LPENSETR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_MC_AHB4LPENSETR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_MC_AHB4LPENSETR` writer"]
pub struct W(crate::W<RCC_MC_AHB4LPENSETR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_MC_AHB4LPENSETR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_MC_AHB4LPENSETR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_MC_AHB4LPENSETR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GPIOALPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MC_AHB4LPENSETR_SPEC, bool, O>;
...
#[doc = "This register is used by the MCU in order to set the PERxLPEN bit.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mc_ahb4lpensetr](index.html) module"]
pub struct RCC_MC_AHB4LPENSETR_SPEC;
impl crate::RegisterSpec for RCC_MC_AHB4LPENSETR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rcc_mc_ahb4lpensetr::R](R) reader structure"]
impl crate::Readable for RCC_MC_AHB4LPENSETR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mc_ahb4lpensetr::W](W) writer structure"]
impl crate::Writable for RCC_MC_AHB4LPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MC_AHB4LPENSETR to value 0x07ff"]
impl crate::Resettable for RCC_MC_AHB4LPENSETR_SPEC {
