#[doc = "Register `RCC_MC_APB2LPENSETR` reader"]
pub struct R(crate::R<RCC_MC_APB2LPENSETR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_MC_APB2LPENSETR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_MC_APB2LPENSETR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_MC_APB2LPENSETR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_MC_APB2LPENSETR` writer"]
pub struct W(crate::W<RCC_MC_APB2LPENSETR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_MC_APB2LPENSETR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_MC_APB2LPENSETR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_MC_APB2LPENSETR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TIM1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
#[doc = "Field `TIM8LPEN` reader - TIM8LPEN"]
pub type TIM8LPEN_R = crate::BitReader<bool>;
#[doc = "Field `TIM8LPEN` writer - TIM8LPEN"]
pub type TIM8LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
...
pub type TIM15LPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
...
pub type SPI1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
#[doc = "Field `SPI4LPEN` reader - SPI4LPEN"]
pub type SPI4LPEN_R = crate::BitReader<bool>;
#[doc = "Field `SPI4LPEN` writer - SPI4LPEN"]
pub type SPI4LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
#[doc = "Field `SPI5LPEN` reader - SPI5LPEN"]
pub type SPI5LPEN_R = crate::BitReader<bool>;
#[doc = "Field `SPI5LPEN` writer - SPI5LPEN"]
pub type SPI5LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
...
pub type SAI1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
#[doc = "Field `SAI2LPEN` reader - SAI2LPEN"]
pub type SAI2LPEN_R = crate::BitReader<bool>;
#[doc = "Field `SAI2LPEN` writer - SAI2LPEN"]
pub type SAI2LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
#[doc = "Field `SAI3LPEN` reader - SAI3LPEN"]
pub type SAI3LPEN_R = crate::BitReader<bool>;
#[doc = "Field `SAI3LPEN` writer - SAI3LPEN"]
pub type SAI3LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB2LPENSETR_SPEC, bool, O>;
...
#[doc = "This register is used by the MCU in order to set the PERxLPEN bit.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mc_apb2lpensetr](index.html) module"]
pub struct RCC_MC_APB2LPENSETR_SPEC;
impl crate::RegisterSpec for RCC_MC_APB2LPENSETR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rcc_mc_apb2lpensetr::R](R) reader structure"]
impl crate::Readable for RCC_MC_APB2LPENSETR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mc_apb2lpensetr::W](W) writer structure"]
impl crate::Writable for RCC_MC_APB2LPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MC_APB2LPENSETR to value 0x0137_271f"]
impl crate::Resettable for RCC_MC_APB2LPENSETR_SPEC {
