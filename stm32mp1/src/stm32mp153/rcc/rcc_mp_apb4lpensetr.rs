...
pub type LTDCLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_APB4LPENSETR_SPEC, bool, O>;
#[doc = "Field `DSILPEN` reader - DSILPEN"]
pub type DSILPEN_R = crate::BitReader<bool>;
#[doc = "Field `DSILPEN` writer - DSILPEN"]
pub type DSILPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MP_APB4LPENSETR_SPEC, bool, O>;
...
pub type DDRPERFMLPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MP_APB4LPENSETR_SPEC, bool, O>;
