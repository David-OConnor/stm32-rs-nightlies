#[doc = "Register `RCC_MP_APB3LPENSETR` reader"]
...
#[doc = "Register `RCC_MP_APB3LPENSETR` writer"]
...
#[doc = "`read()` method returns [rcc_mp_apb3lpensetr::R](R) reader structure"]
impl crate::Readable for RCC_MP_APB3LPENSETR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mp_apb3lpensetr::W](W) writer structure"]
impl crate::Writable for RCC_MP_APB3LPENSETR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MP_APB3LPENSETR to value 0x0003_290f"]
