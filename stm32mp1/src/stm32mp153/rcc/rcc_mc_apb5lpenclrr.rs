#[doc = "Register `RCC_MC_APB5LPENCLRR` reader"]
pub struct R(crate::R<RCC_MC_APB5LPENCLRR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RCC_MC_APB5LPENCLRR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RCC_MC_APB5LPENCLRR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RCC_MC_APB5LPENCLRR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RCC_MC_APB5LPENCLRR` writer"]
pub struct W(crate::W<RCC_MC_APB5LPENCLRR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RCC_MC_APB5LPENCLRR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RCC_MC_APB5LPENCLRR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RCC_MC_APB5LPENCLRR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SPI6LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
#[doc = "Field `I2C4LPEN` reader - I2C4LPEN"]
pub type I2C4LPEN_R = crate::BitReader<bool>;
#[doc = "Field `I2C4LPEN` writer - I2C4LPEN"]
pub type I2C4LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
#[doc = "Field `I2C6LPEN` reader - I2C6LPEN"]
pub type I2C6LPEN_R = crate::BitReader<bool>;
#[doc = "Field `I2C6LPEN` writer - I2C6LPEN"]
pub type I2C6LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
...
pub type USART1LPEN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
...
pub type TZC1LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
#[doc = "Field `TZC2LPEN` reader - TZC2LPEN"]
pub type TZC2LPEN_R = crate::BitReader<bool>;
#[doc = "Field `TZC2LPEN` writer - TZC2LPEN"]
pub type TZC2LPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
#[doc = "Field `TZPCLPEN` reader - TZPCLPEN"]
pub type TZPCLPEN_R = crate::BitReader<bool>;
#[doc = "Field `TZPCLPEN` writer - TZPCLPEN"]
pub type TZPCLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
#[doc = "Field `BSECLPEN` reader - BSECLPEN"]
pub type BSECLPEN_R = crate::BitReader<bool>;
#[doc = "Field `BSECLPEN` writer - BSECLPEN"]
pub type BSECLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RCC_MC_APB5LPENCLRR_SPEC, bool, O>;
...
#[doc = "This register is used by the MCU in order to clear the PERxLPEN bit\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mc_apb5lpenclrr](index.html) module"]
pub struct RCC_MC_APB5LPENCLRR_SPEC;
impl crate::RegisterSpec for RCC_MC_APB5LPENCLRR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rcc_mc_apb5lpenclrr::R](R) reader structure"]
impl crate::Readable for RCC_MC_APB5LPENCLRR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mc_apb5lpenclrr::W](W) writer structure"]
impl crate::Writable for RCC_MC_APB5LPENCLRR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MC_APB5LPENCLRR to value 0x0011_391d"]
impl crate::Resettable for RCC_MC_APB5LPENCLRR_SPEC {
