#[doc = "Register `RCC_MP_CIER` reader"]
...
#[doc = "Register `RCC_MP_CIER` writer"]
...
#[doc = "`read()` method returns [rcc_mp_cier::R](R) reader structure"]
impl crate::Readable for RCC_MP_CIER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rcc_mp_cier::W](W) writer structure"]
impl crate::Writable for RCC_MP_CIER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RCC_MP_CIER to value 0"]
