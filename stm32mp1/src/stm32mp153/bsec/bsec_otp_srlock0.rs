#[doc = "Register `BSEC_OTP_SRLOCK0` reader"]
...
#[doc = "Register `BSEC_OTP_SRLOCK0` writer"]
...
#[doc = "`read()` method returns [bsec_otp_srlock0::R](R) reader structure"]
impl crate::Readable for BSEC_OTP_SRLOCK0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [bsec_otp_srlock0::W](W) writer structure"]
impl crate::Writable for BSEC_OTP_SRLOCK0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BSEC_OTP_SRLOCK0 to value 0"]
