#[doc = "Register `BSEC_OTP_DATA93` reader"]
...
#[doc = "Register `BSEC_OTP_DATA93` writer"]
...
#[doc = "`read()` method returns [bsec_otp_data93::R](R) reader structure"]
impl crate::Readable for BSEC_OTP_DATA93_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [bsec_otp_data93::W](W) writer structure"]
impl crate::Writable for BSEC_OTP_DATA93_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BSEC_OTP_DATA93 to value 0"]
