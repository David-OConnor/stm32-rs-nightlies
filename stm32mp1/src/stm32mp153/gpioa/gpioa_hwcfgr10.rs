#[doc = "Register `GPIOA_HWCFGR10` reader"]
pub struct R(crate::R<GPIOA_HWCFGR10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIOA_HWCFGR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIOA_HWCFGR10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIOA_HWCFGR10_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "For GPIOA, B, C, D, E, F, G, H, I, J and GPIOK: For GPIOZ:\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gpioa_hwcfgr10](index.html) module"]
pub struct GPIOA_HWCFGR10_SPEC;
impl crate::RegisterSpec for GPIOA_HWCFGR10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gpioa_hwcfgr10::R](R) reader structure"]
impl crate::Readable for GPIOA_HWCFGR10_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOA_HWCFGR10 to value 0x0001_1240"]
impl crate::Resettable for GPIOA_HWCFGR10_SPEC {
