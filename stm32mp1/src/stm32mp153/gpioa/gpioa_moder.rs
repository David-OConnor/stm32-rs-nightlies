#[doc = "Register `GPIOA_MODER` reader"]
...
#[doc = "Register `GPIOA_MODER` writer"]
...
#[doc = "`read()` method returns [gpioa_moder::R](R) reader structure"]
impl crate::Readable for GPIOA_MODER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gpioa_moder::W](W) writer structure"]
impl crate::Writable for GPIOA_MODER_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GPIOA_MODER to value 0xffff_ffff"]
