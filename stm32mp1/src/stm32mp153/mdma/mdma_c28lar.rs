#[doc = "Register `MDMA_C28LAR` reader"]
...
#[doc = "Register `MDMA_C28LAR` writer"]
...
#[doc = "`read()` method returns [mdma_c28lar::R](R) reader structure"]
impl crate::Readable for MDMA_C28LAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c28lar::W](W) writer structure"]
impl crate::Writable for MDMA_C28LAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C28LAR to value 0"]
