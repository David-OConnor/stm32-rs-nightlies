#[doc = "Register `MDMA_C27MAR` reader"]
...
#[doc = "Register `MDMA_C27MAR` writer"]
...
#[doc = "`read()` method returns [mdma_c27mar::R](R) reader structure"]
impl crate::Readable for MDMA_C27MAR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c27mar::W](W) writer structure"]
impl crate::Writable for MDMA_C27MAR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C27MAR to value 0"]
