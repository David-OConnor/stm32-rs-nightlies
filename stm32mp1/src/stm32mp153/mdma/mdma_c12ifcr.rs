...
pub struct W(crate::W<MDMA_C12IFCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDMA_C12IFCR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<MDMA_C12IFCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDMA_C12IFCR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CTEIF` writer - CTEIF"]
pub type CTEIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C12IFCR_SPEC, bool, O>;
#[doc = "Field `CCTCIF` writer - CCTCIF"]
pub type CCTCIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C12IFCR_SPEC, bool, O>;
#[doc = "Field `CBRTIF` writer - CBRTIF"]
pub type CBRTIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C12IFCR_SPEC, bool, O>;
#[doc = "Field `CBTIF` writer - CBTIF"]
pub type CBTIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C12IFCR_SPEC, bool, O>;
#[doc = "Field `CLTCIF` writer - CLTCIF"]
pub type CLTCIF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MDMA_C12IFCR_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - CTEIF"]
    #[inline(always)]
    #[must_use]
