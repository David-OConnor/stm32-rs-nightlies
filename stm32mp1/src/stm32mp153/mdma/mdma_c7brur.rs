#[doc = "Register `MDMA_C7BRUR` reader"]
...
#[doc = "Register `MDMA_C7BRUR` writer"]
...
#[doc = "`read()` method returns [mdma_c7brur::R](R) reader structure"]
impl crate::Readable for MDMA_C7BRUR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mdma_c7brur::W](W) writer structure"]
impl crate::Writable for MDMA_C7BRUR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MDMA_C7BRUR to value 0"]
