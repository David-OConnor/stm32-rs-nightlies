#[doc = "Register `OTG_HCCHAR10` reader"]
pub struct R(crate::R<OTG_HCCHAR10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HCCHAR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HCCHAR10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HCCHAR10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_HCCHAR10` writer"]
pub struct W(crate::W<OTG_HCCHAR10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_HCCHAR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_HCCHAR10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_HCCHAR10_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OTG host channel 10 characteristics register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_hcchar10](index.html) module"]
pub struct OTG_HCCHAR10_SPEC;
impl crate::RegisterSpec for OTG_HCCHAR10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otg_hcchar10::R](R) reader structure"]
impl crate::Readable for OTG_HCCHAR10_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_hcchar10::W](W) writer structure"]
impl crate::Writable for OTG_HCCHAR10_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_HCCHAR10 to value 0"]
impl crate::Resettable for OTG_HCCHAR10_SPEC {
