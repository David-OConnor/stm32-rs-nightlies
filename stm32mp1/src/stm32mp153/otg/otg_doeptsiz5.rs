#[doc = "Register `OTG_DOEPTSIZ5` reader"]
pub struct R(crate::R<OTG_DOEPTSIZ5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_DOEPTSIZ5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_DOEPTSIZ5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_DOEPTSIZ5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_DOEPTSIZ5` writer"]
pub struct W(crate::W<OTG_DOEPTSIZ5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_DOEPTSIZ5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_DOEPTSIZ5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_DOEPTSIZ5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFRSIZ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_DOEPTSIZ5_SPEC, u32, u32, 19, O>;
...
pub type PKTCNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_DOEPTSIZ5_SPEC, u16, u16, 10, O>;
...
pub type RXDPID_STUPCNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OTG_DOEPTSIZ5_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "The application must modify this register before enabling the endpoint. Once the endpoint is enabled using endpoint enable bit of the OTG_DOEPCTLx registers (EPENA bit in OTG_DOEPCTLx), the core modifies this register. The application can only read this register once the core has cleared the endpoint enable bit.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_doeptsiz5](index.html) module"]
pub struct OTG_DOEPTSIZ5_SPEC;
impl crate::RegisterSpec for OTG_DOEPTSIZ5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otg_doeptsiz5::R](R) reader structure"]
impl crate::Readable for OTG_DOEPTSIZ5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_doeptsiz5::W](W) writer structure"]
impl crate::Writable for OTG_DOEPTSIZ5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_DOEPTSIZ5 to value 0"]
impl crate::Resettable for OTG_DOEPTSIZ5_SPEC {
