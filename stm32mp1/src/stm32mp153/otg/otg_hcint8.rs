...
pub type DESCLSTROLL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HCINT8_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - XFRC"]
    #[inline(always)]
