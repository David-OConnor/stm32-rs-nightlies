#[doc = "Register `OTG_HCINT10` reader"]
pub struct R(crate::R<OTG_HCINT10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HCINT10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HCINT10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HCINT10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_HCINT10` writer"]
pub struct W(crate::W<OTG_HCINT10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_HCINT10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_HCINT10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_HCINT10_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DESCLSTROLL_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTG_HCINT10_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - XFRC"]
    #[inline(always)]
