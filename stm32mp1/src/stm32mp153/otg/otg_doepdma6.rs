#[doc = "Register `OTG_DOEPDMA6` reader"]
...
#[doc = "Register `OTG_DOEPDMA6` writer"]
...
#[doc = "`read()` method returns [otg_doepdma6::R](R) reader structure"]
impl crate::Readable for OTG_DOEPDMA6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_doepdma6::W](W) writer structure"]
impl crate::Writable for OTG_DOEPDMA6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_DOEPDMA6 to value 0"]
