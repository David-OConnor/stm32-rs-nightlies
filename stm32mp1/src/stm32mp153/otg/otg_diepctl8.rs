#[doc = "Register `OTG_DIEPCTL8` reader"]
...
#[doc = "Register `OTG_DIEPCTL8` writer"]
...
#[doc = "`read()` method returns [otg_diepctl8::R](R) reader structure"]
impl crate::Readable for OTG_DIEPCTL8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_diepctl8::W](W) writer structure"]
impl crate::Writable for OTG_DIEPCTL8_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_DIEPCTL8 to value 0"]
