#[doc = "Register `OTG_HCINT15` reader"]
...
#[doc = "Register `OTG_HCINT15` writer"]
...
#[doc = "`read()` method returns [otg_hcint15::R](R) reader structure"]
impl crate::Readable for OTG_HCINT15_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_hcint15::W](W) writer structure"]
impl crate::Writable for OTG_HCINT15_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OTG_HCINT15 to value 0"]
