#[doc = "Register `TZC_REGION_TOP_LOW4` reader"]
...
#[doc = "Register `TZC_REGION_TOP_LOW4` writer"]
...
#[doc = "`read()` method returns [tzc_region_top_low4::R](R) reader structure"]
impl crate::Readable for TZC_REGION_TOP_LOW4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tzc_region_top_low4::W](W) writer structure"]
impl crate::Writable for TZC_REGION_TOP_LOW4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TZC_REGION_TOP_LOW4 to value 0x0fff"]
