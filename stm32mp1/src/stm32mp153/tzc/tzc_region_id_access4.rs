...
pub struct R(crate::R<TZC_REGION_ID_ACCESS4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TZC_REGION_ID_ACCESS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TZC_REGION_ID_ACCESS4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TZC_REGION_ID_ACCESS4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TZC_REGION_ID_ACCESS4` writer"]
pub struct W(crate::W<TZC_REGION_ID_ACCESS4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TZC_REGION_ID_ACCESS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TZC_REGION_ID_ACCESS4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TZC_REGION_ID_ACCESS4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NSAID_RD_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TZC_REGION_ID_ACCESS4_SPEC, u16, u16, 16, O>;
...
#[doc = "Region non-secure access based on NSAID.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tzc_region_id_access4](index.html) module"]
pub struct TZC_REGION_ID_ACCESS4_SPEC;
impl crate::RegisterSpec for TZC_REGION_ID_ACCESS4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tzc_region_id_access4::R](R) reader structure"]
impl crate::Readable for TZC_REGION_ID_ACCESS4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tzc_region_id_access4::W](W) writer structure"]
impl crate::Writable for TZC_REGION_ID_ACCESS4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TZC_REGION_ID_ACCESS4 to value 0"]
impl crate::Resettable for TZC_REGION_ID_ACCESS4_SPEC {
