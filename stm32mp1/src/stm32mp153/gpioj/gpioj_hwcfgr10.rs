#[doc = "Register `GPIOJ_HWCFGR10` reader"]
...
#[doc = "`read()` method returns [gpioj_hwcfgr10::R](R) reader structure"]
impl crate::Readable for GPIOJ_HWCFGR10_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets GPIOJ_HWCFGR10 to value 0x0001_1240"]
