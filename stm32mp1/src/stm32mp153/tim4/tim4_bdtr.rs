#[doc = "Register `TIM4_BDTR` reader"]
pub struct R(crate::R<TIM4_BDTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIM4_BDTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIM4_BDTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIM4_BDTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIM4_BDTR` writer"]
pub struct W(crate::W<TIM4_BDTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIM4_BDTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIM4_BDTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIM4_BDTR_SPEC>) -> Self {
        W(writer)
    }
}
...
can be write-locked depending on the LOCK configuration, it can be necessary to configure all of them during the first write access to the TIMx_BDTR register.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tim4_bdtr](index.html) module"]
pub struct TIM4_BDTR_SPEC;
impl crate::RegisterSpec for TIM4_BDTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tim4_bdtr::R](R) reader structure"]
impl crate::Readable for TIM4_BDTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim4_bdtr::W](W) writer structure"]
impl crate::Writable for TIM4_BDTR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM4_BDTR to value 0"]
impl crate::Resettable for TIM4_BDTR_SPEC {
