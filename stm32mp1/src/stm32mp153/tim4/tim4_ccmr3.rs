#[doc = "Register `TIM4_CCMR3` reader"]
...
#[doc = "Register `TIM4_CCMR3` writer"]
...
#[doc = "`read()` method returns [tim4_ccmr3::R](R) reader structure"]
impl crate::Readable for TIM4_CCMR3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tim4_ccmr3::W](W) writer structure"]
impl crate::Writable for TIM4_CCMR3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TIM4_CCMR3 to value 0"]
