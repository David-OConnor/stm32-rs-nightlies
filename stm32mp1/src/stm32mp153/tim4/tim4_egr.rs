...
pub type COMG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM4_EGR_SPEC, bool, O>;
#[doc = "Field `TG` writer - TG"]
pub type TG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM4_EGR_SPEC, bool, O>;
#[doc = "Field `BG` writer - BG"]
pub type BG_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM4_EGR_SPEC, bool, O>;
#[doc = "Field `B2G` writer - B2G"]
pub type B2G_W<'a, const O: u8> = crate::BitWriter<'a, u16, TIM4_EGR_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - UG"]
    #[inline(always)]
    #[must_use]
