...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsi14rdyie(&mut self) -> HSI14RDYIE_W<13> {
        HSI14RDYIE_W::new(self)
    }
    #[doc = "Bit 14 - HSI48 ready interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hsi48rdyie(&mut self) -> HSI48RDYIE_W<14> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hsi14rdyc(&mut self) -> HSI14RDYC_W<21> {
        HSI14RDYC_W::new(self)
    }
    #[doc = "Bit 22 - HSI48 Ready Interrupt Clear"]
    #[inline(always)]
    #[must_use]
    pub fn hsi48rdyc(&mut self) -> HSI48RDYC_W<22> {
