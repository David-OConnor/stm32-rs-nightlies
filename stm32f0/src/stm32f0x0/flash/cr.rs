...
pub type FORCE_OPTLOAD_R = crate::BitReader<FORCE_OPTLOAD_A>;
...
pub type FORCE_OPTLOAD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, FORCE_OPTLOAD_A, O>;
impl<'a, const O: u8> FORCE_OPTLOAD_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn force_optload(&mut self) -> FORCE_OPTLOAD_W<13> {
        FORCE_OPTLOAD_W::new(self)
    }
