...
#[doc = "Field `TIM3_counter_stopped_when_core_is_halted` reader - TIM6 counter stopped when core is halted"]
pub type TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R = crate::BitReader<bool>;
#[doc = "Field `TIM3_counter_stopped_when_core_is_halted` writer - TIM6 counter stopped when core is halted"]
pub type TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_W<'a, const O: u8> =
...
impl R {
    ...
    pub fn tim3_counter_stopped_when_core_is_halted(
        ...
        TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_R::new(((self.bits >> 4) & 1) != 0)
    }
...
impl W {
    ...
    pub fn tim3_counter_stopped_when_core_is_halted(
        &mut self,
    ) -> TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_W<4> {
        TIM3_COUNTER_STOPPED_WHEN_CORE_IS_HALTED_W::new(self)
    }
    #[doc = "Bit 5 - TIM7 counter stopped when core is halted"]
    #[inline(always)]
    #[must_use]
